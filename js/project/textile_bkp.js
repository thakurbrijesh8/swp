...
//        addClass('textile', 'active');
    ...
    loadTextileData: function () {
        ...
        textileDataTable = $('#textile_datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'incentive_id', 'class': 'v-a-m text-center', 'render': newAppStatusRenderer},
    ...
    newTextileForm: function (isEdit, parseData) {
        ...
        if (isEdit) {
            ...
            if (formData.women_entrepreneur != '') {
                ...
                $('#women_entrepreneur_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.women_entrepreneur);
                $('#women_entrepreneur_name_container_for_textile').show();
                $('#women_entrepreneur_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.women_entrepreneur);
            }

            if (formData.sc_st_entrepreneur != '') {
                $('#sc_st_entrepreneur_container_for_textile').hide();
                $('#sc_st_entrepreneur_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.sc_st_entrepreneur);
                $('#sc_st_entrepreneur_name_container_for_textile').show();
                $('#sc_st_entrepreneur_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.sc_st_entrepreneur);
            }
            if (formData.physically_entrepreneur != '') {
                $('#physically_entrepreneur_container_for_textile').hide();
                $('#physically_entrepreneur_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.physically_entrepreneur);
                $('#physically_entrepreneur_name_container_for_textile').show();
                $('#physically_entrepreneur_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.physically_entrepreneur);
            }
            if (formData.transgender_entrepreneur != '') {
                $('#transgender_entrepreneur_container_for_textile').hide();
                $('#transgender_entrepreneur_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.transgender_entrepreneur);
                $('#transgender_entrepreneur_name_container_for_textile').show();
                $('#transgender_entrepreneur_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.transgender_entrepreneur);
            }
            if (formData.other_entrepreneur != '') {
                $('#other_entrepreneur_container_for_textile').hide();
                $('#other_entrepreneur_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.other_entrepreneur);
                $('#other_entrepreneur_name_container_for_textile').show();
                $('#other_entrepreneur_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.other_entrepreneur);
            }

            if (formData.financial_assistance_upload != '') {
                $('#financial_assistance_upload_container_for_textile').hide();
                $('#financial_assistance_upload_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.financial_assistance_upload);
                $('#financial_assistance_upload_name_container_for_textile').show();
                $('#financial_assistance_upload_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.financial_assistance_upload);
            }

            if (formData.govt_dues_upload != '') {
                $('#govt_dues_upload_container_for_textile').hide();
                $('#govt_dues_upload_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.govt_dues_upload);
                $('#govt_dues_upload_name_container_for_textile').show();
                $('#govt_dues_upload_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.govt_dues_upload);
            }
    ...
    partFDetailsForm: function (incentivePartFData) {
        ...
        if (incentivePartFData.project_profile_uploader != '' && incentivePartFData.project_profile_uploader != undefined) {
            ...
            $('#project_profile_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartFData.project_profile_uploader);
            $('#project_profile_uploader_name_container_for_textile').show();
            $('#project_profile_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartFData.project_profile_uploader);
        }
        ...
        if (incentivePartFData.details_uploader != '' && incentivePartFData.details_uploader != undefined) {
            ...
            $('#details_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartFData.details_uploader);
            $('#details_uploader_name_container_for_textile').show();
            $('#details_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartFData.details_uploader);
        }
        ...
        if (incentivePartFData.investment_uploader != '' && incentivePartFData.investment_uploader != undefined) {
            ...
            $('#investment_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartFData.investment_uploader);
            $('#investment_uploader_name_container_for_textile').show();
            $('#investment_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartFData.investment_uploader);
        }
        datePicker();
    ...
    partGDetailsForm: function (incentivePartGData) {
        ...
        if (incentivePartGData.project_profile_uploader != '' && incentivePartGData.project_profile_uploader != undefined) {
            $('#project_profile_uploader_container_for_textile').hide();
            $('#project_profile_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartGData.project_profile_uploader);
            $('#project_profile_uploader_name_container_for_textile').show();
            $('#project_profile_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartGData.project_profile_uploader);
        }

        if (incentivePartGData.details_uploader != '' && incentivePartGData.details_uploader != undefined) {
            $('#details_uploader_container_for_textile').hide();
            $('#details_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartGData.details_uploader);
            $('#details_uploader_name_container_for_textile').show();
            $('#details_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartGData.details_uploader);
        }

        if (incentivePartGData.investment_uploader != '' && incentivePartGData.investment_uploader != undefined) {
            $('#investment_uploader_container_for_textile').hide();
            $('#investment_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartGData.investment_uploader);
            $('#investment_uploader_name_container_for_textile').show();
            $('#investment_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartGData.investment_uploader);
        }
    ...
    partHDetailsForm: function (incentivePartHData) {
        ...
        if (incentivePartHData.enterprise_accqu == VALUE_ONE) {
            if (incentivePartHData.arrangement_uploader != '' && incentivePartHData.arrangement_uploader != undefined) {
                ...
                $('#arrangement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartHData.arrangement_uploader);
                $('#arrangement_uploader_name_container_for_textile').show();
                $('#arrangement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartHData.arrangement_uploader);
            }
            if (incentivePartHData.mou_uploader != '' && incentivePartHData.mou_uploader != undefined) {
                $('#mou_uploader_container_for_textile').hide();
                $('#mou_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartHData.mou_uploader);
                $('#mou_uploader_name_container_for_textile').show();
                $('#mou_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartHData.mou_uploader);
            }
        }
        if (incentivePartHData.project_profile_uploader != '' && incentivePartHData.project_profile_uploader != undefined) {
            $('#project_profile_uploader_container_for_textile').hide();
            $('#project_profile_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartHData.project_profile_uploader);
            $('#project_profile_uploader_name_container_for_textile').show();
            $('#project_profile_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartHData.project_profile_uploader);
        }

        if (incentivePartHData.details_uploader != '' && incentivePartHData.details_uploader != undefined) {
            $('#details_uploader_container_for_textile').hide();
            $('#details_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartHData.details_uploader);
            $('#details_uploader_name_container_for_textile').show();
            $('#details_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartHData.details_uploader);
        }

        if (incentivePartHData.investment_uploader != '' && incentivePartHData.investment_uploader != undefined) {
            $('#investment_uploader_container_for_textile').hide();
            $('#investment_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartHData.investment_uploader);
            $('#investment_uploader_name_container_for_textile').show();
            $('#investment_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartHData.investment_uploader);
        }
        ...
        if (incentivePartHData.annual_production_uploader != '' && incentivePartHData.annual_production_uploader != undefined) {
            ...
            $('#annual_production_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartHData.annual_production_uploader);
            $('#annual_production_uploader_name_container_for_textile').show();
            $('#annual_production_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartHData.annual_production_uploader);
        }
        ...
        if (incentivePartHData.power_consumption_uploader != '' && incentivePartHData.power_consumption_uploader != undefined) {
            ...
            $('#power_consumption_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartHData.power_consumption_uploader);
            $('#power_consumption_uploader_name_container_for_textile').show();
            $('#power_consumption_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartHData.power_consumption_uploader);
        }
        ...
        if (incentivePartHData.impact_uploader != '' && incentivePartHData.impact_uploader != undefined) {
            ...
            $('#impact_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + incentivePartHData.impact_uploader);
            $('#impact_uploader_name_container_for_textile').show();
            $('#impact_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + incentivePartHData.impact_uploader);
        }
    ...
    textileDeclarationForm: function (declarationData) {
        ...
        if (declarationData.sign_seal != '' && declarationData.sign_seal != undefined) {
            ...
            $('#sign_seal_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + declarationData.sign_seal);
    ...
    textilehecklistForm: function (checklistData) {
        ...
        if (checklistData.is_capital_investment == isChecked) {
            ...
            if (checklistData.entrepreneur_memorandum_uploader != '' && checklistData.entrepreneur_memorandum_uploader != undefined) {
                ...
                $('#entrepreneur_memorandum_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.entrepreneur_memorandum_uploader);
                $('#entrepreneur_memorandum_uploader_name_container_for_textile').show();
                $('#entrepreneur_memorandum_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.entrepreneur_memorandum_uploader);
            }
            if (checklistData.partnership_deed_uploader != '' && checklistData.partnership_deed_uploader != undefined) {
                ...
                $('#partnership_deed_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.partnership_deed_uploader);
                $('#partnership_deed_uploader_name_container_for_textile').show();
                $('#partnership_deed_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.partnership_deed_uploader);
            }
            if (checklistData.lease_agreement_uploader != '' && checklistData.lease_agreement_uploader != undefined) {
                ...
                $('#lease_agreement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.lease_agreement_uploader);
                $('#lease_agreement_uploader_name_container_for_textile').show();
                $('#lease_agreement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.lease_agreement_uploader);
            }
            if (checklistData.loan_sanction_uploader != '' && checklistData.loan_sanction_uploader != undefined) {
                ...
                $('#loan_sanction_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.loan_sanction_uploader);
                $('#loan_sanction_uploader_name_container_for_textile').show();
                $('#loan_sanction_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.loan_sanction_uploader);
            }
            if (checklistData.power_release_order_uploader != '' && checklistData.power_release_order_uploader != undefined) {
                ...
                $('#power_release_order_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.power_release_order_uploader);
                $('#power_release_order_uploader_name_container_for_textile').show();
                $('#power_release_order_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.power_release_order_uploader);
            }
            if (checklistData.invoice_copy_uploader != '' && checklistData.invoice_copy_uploader != undefined) {
                ...
                $('#invoice_copy_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.invoice_copy_uploader);
                $('#invoice_copy_uploader_name_container_for_textile').show();
                $('#invoice_copy_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.invoice_copy_uploader);
            }
            if (checklistData.ca_prescribed_uploader != '' && checklistData.ca_prescribed_uploader != undefined) {
                ...
                $('#ca_prescribed_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.ca_prescribed_uploader);
                $('#ca_prescribed_uploader_name_container_for_textile').show();
                $('#ca_prescribed_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.ca_prescribed_uploader);
            }
            if (checklistData.certificate_commencement_uploader != '' && checklistData.certificate_commencement_uploader != undefined) {
                ...
                $('#certificate_commencement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.certificate_commencement_uploader);
                $('#certificate_commencement_uploader_name_container_for_textile').show();
                $('#certificate_commencement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.certificate_commencement_uploader);
            }
            if (checklistData.engineer_certificate_uploader != '' && checklistData.engineer_certificate_uploader != undefined) {
                ...
                $('#engineer_certificate_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.engineer_certificate_uploader);
                $('#engineer_certificate_uploader_name_container_for_textile').show();
                $('#engineer_certificate_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.engineer_certificate_uploader);
            }
            if (checklistData.expenses_certificate_uploader != '' && checklistData.expenses_certificate_uploader != undefined) {
                ...
                $('#expenses_certificate_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.expenses_certificate_uploader);
                $('#expenses_certificate_uploader_name_container_for_textile').show();
                $('#expenses_certificate_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.expenses_certificate_uploader);
            }
            if (checklistData.stamped_receipt_uploader != '' && checklistData.stamped_receipt_uploader != undefined) {
                ...
                $('#stamped_receipt_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.stamped_receipt_uploader);
                $('#stamped_receipt_uploader_name_container_for_textile').show();
                $('#stamped_receipt_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.stamped_receipt_uploader);
            }
            if (checklistData.sale_invoice_uploader != '' && checklistData.sale_invoice_uploader != undefined) {
                ...
                $('#sale_invoice_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.sale_invoice_uploader);
                $('#sale_invoice_uploader_name_container_for_textile').show();
                $('#sale_invoice_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.sale_invoice_uploader);
            }
            if (checklistData.additional_document_uploader != '' && checklistData.additional_document_uploader != undefined) {
                ...
                $('#additional_document_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.additional_document_uploader);
                $('#additional_document_uploader_name_container_for_textile').show();
                $('#additional_document_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.additional_document_uploader);
            }
            if (checklistData.factorylicence_copy_uploader != '' && checklistData.factorylicence_copy_uploader != undefined) {
                ...
                $('#factorylicence_copy_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.factorylicence_copy_uploader);
                $('#factorylicence_copy_uploader_name_container_for_textile').show();
                $('#factorylicence_copy_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.factorylicence_copy_uploader);
            }
            if (checklistData.pcc_copy_uploader != '' && checklistData.pcc_copy_uploader != undefined) {
                $('#pcc_copy_uploader_container_for_textile').hide();
                $('#pcc_copy_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.pcc_copy_uploader);
                $('#pcc_copy_uploader_name_container_for_textile').show();
                $('#pcc_copy_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.pcc_copy_uploader);
            }
            if (checklistData.expansion_date_uploader != '' && checklistData.expansion_date_uploader != undefined) {
                ...
                $('#expansion_date_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.expansion_date_uploader);
                $('#expansion_date_uploader_name_container_for_textile').show();
                $('#expansion_date_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.expansion_date_uploader);
            }
            if (checklistData.production_turnover_uploader != '' && checklistData.production_turnover_uploader != undefined) {
                ...
                $('#production_turnover_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.production_turnover_uploader);
                $('#production_turnover_uploader_name_container_for_textile').show();
                $('#production_turnover_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.production_turnover_uploader);
            }
            if (checklistData.fix_assets_value_uploader != '' && checklistData.fix_assets_value_uploader != undefined) {
                ...
                $('#fix_assets_value_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.fix_assets_value_uploader);
                $('#fix_assets_value_uploader_name_container_for_textile').show();
                $('#fix_assets_value_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.fix_assets_value_uploader);
            }
            if (checklistData.production_capacity_uploader != '' && checklistData.production_capacity_uploader != undefined) {
                ...
                $('#production_capacity_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.production_capacity_uploader);
                $('#production_capacity_uploader_name_container_for_textile').show();
                $('#production_capacity_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.production_capacity_uploader);
            }
            if (checklistData.patent_registration_uploader != '' && checklistData.patent_registration_uploader != undefined) {
                ...
                $('#patent_registration_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.patent_registration_uploader);
                $('#patent_registration_uploader_name_container_for_textile').show();
                $('#patent_registration_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.patent_registration_uploader);
            }
            if (checklistData.energy_water_uploader != '' && checklistData.energy_water_uploader != undefined) {
                ...
                $('#energy_water_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.energy_water_uploader);
                $('#energy_water_uploader_name_container_for_textile').show();
                $('#energy_water_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.energy_water_uploader);
            }
            if (checklistData.quality_certificate_uploader != '' && checklistData.quality_certificate_uploader != undefined) {
                ...
                $('#quality_certificate_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.quality_certificate_uploader);
                $('#quality_certificate_uploader_name_container_for_textile').show();
                $('#quality_certificate_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.quality_certificate_uploader);
            }
            if (checklistData.resident_certificate_uploader != '' && checklistData.resident_certificate_uploader != undefined) {
                ...
                $('#resident_certificate_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.resident_certificate_uploader);
                $('#resident_certificate_uploader_name_container_for_textile').show();
                $('#resident_certificate_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.resident_certificate_uploader);
            }
        }
        if (checklistData.is_intrest_subsidy == isChecked) {
            ...
            if (checklistData.bank_total_interest_uploader != '' && checklistData.bank_total_interest_uploader != undefined) {
                ...
                $('#bank_total_interest_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.bank_total_interest_uploader);
                $('#bank_total_interest_uploader_name_container_for_textile').show();
                $('#bank_total_interest_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.bank_total_interest_uploader);
            }
            if (checklistData.bank_statement_uploader != '' && checklistData.bank_statement_uploader != undefined) {
                ...
                $('#bank_statement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.bank_statement_uploader);
                $('#bank_statement_uploader_name_container_for_textile').show();
                $('#bank_statement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.bank_statement_uploader);
            }
            if (checklistData.annexure3_declaration_uploader != '' && checklistData.annexure3_declaration_uploader != undefined) {
                ...
                $('#annexure3_declaration_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.annexure3_declaration_uploader);
                $('#annexure3_declaration_uploader_name_container_for_textile').show();
                $('#annexure3_declaration_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.annexure3_declaration_uploader);
            }
            if (checklistData.interest_subsidy_cal_uploader != '' && checklistData.interest_subsidy_cal_uploader != undefined) {
                ...
                $('#interest_subsidy_cal_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.interest_subsidy_cal_uploader);
                $('#interest_subsidy_cal_uploader_name_container_for_textile').show();
                $('#interest_subsidy_cal_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.interest_subsidy_cal_uploader);
            }
            if (checklistData.year_annual_prod_uploader != '' && checklistData.year_annual_prod_uploader != undefined) {
                ...
                $('#year_annual_prod_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.year_annual_prod_uploader);
                $('#year_annual_prod_uploader_name_container_for_textile').show();
                $('#year_annual_prod_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.year_annual_prod_uploader);
            }
            if (checklistData.year_bank_statement_uploader != '' && checklistData.year_bank_statement_uploader != undefined) {
                ...
                $('#year_bank_statement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + checklistData.year_bank_statement_uploader);
                $('#year_bank_statement_uploader_name_container_for_textile').show();
                $('#year_bank_statement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + checklistData.year_bank_statement_uploader);
            }
        }
    ...
    viewPartFForm: function (parseData) {
        ...
        if (formData.project_profile_uploader != '') {
            $('#project_profile_uploader_container_for_textile').hide();
            $('#project_profile_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.project_profile_uploader);
            $('#project_profile_uploader_name_container_for_textile').show();
            $('#project_profile_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.project_profile_uploader);
        }

        if (formData.details_uploader != '') {
            $('#details_uploader_container_for_textile').hide();
            $('#details_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.details_uploader);
            $('#details_uploader_name_container_for_textile').show();
            $('#details_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.details_uploader);
        }

        if (formData.investment_uploader != '') {
            $('#investment_uploader_container_for_textile').hide();
            $('#investment_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.investment_uploader);
            $('#investment_uploader_name_container_for_textile').show();
            $('#investment_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.investment_uploader);
        }
    },
    ...
    viewPartHForm: function (parseData) {
        ...
        if (formData.enterprise_accqu == VALUE_ONE) {
            if (formData.arrangement_uploader != '' && formData.arrangement_uploader != undefined) {
                $('#arrangement_uploader_container_for_textile').hide();
                $('#arrangement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.arrangement_uploader);
                $('#arrangement_uploader_name_container_for_textile').show();
                $('#arrangement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.arrangement_uploader);
            }
            if (formData.mou_uploader != '' && formData.mou_uploader != undefined) {
                $('#mou_uploader_container_for_textile').hide();
                $('#mou_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.mou_uploader);
                $('#mou_uploader_name_container_for_textile').show();
                $('#mou_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.mou_uploader);
            }
        }
        if (formData.project_profile_uploader != '' && formData.project_profile_uploader != undefined) {
            $('#project_profile_uploader_container_for_textile').hide();
        ...
        if (formData.annual_production_uploader != '' && formData.annual_production_uploader != undefined) {
            $('#annual_production_uploader_container_for_textile').hide();
            $('#annual_production_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.annual_production_uploader);
            $('#annual_production_uploader_name_container_for_textile').show();
            $('#annual_production_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.annual_production_uploader);
        }

        if (formData.power_consumption_uploader != '' && formData.power_consumption_uploader != undefined) {
            $('#power_consumption_uploader_container_for_textile').hide();
            $('#power_consumption_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.power_consumption_uploader);
            $('#power_consumption_uploader_name_container_for_textile').show();
            $('#power_consumption_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.power_consumption_uploader);
        }

        if (formData.impact_uploader != '' && formData.impact_uploader != undefined) {
            $('#impact_uploader_container_for_textile').hide();
            $('#impact_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.impact_uploader);
            $('#impact_uploader_name_container_for_textile').show();
            $('#impact_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.impact_uploader);
        }
    },
    viewDeclarationForm: function (parseData) {
        ...
        if (formData.sign_seal != '') {
            $('#sign_seal_container_for_textile').hide();
            $('#sign_seal_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.sign_seal);
            $('#sign_seal_name_container_for_textile').show();
        }
    },
    viewChecklistForm: function (parseData) {
        ...
        if (formData.is_capital_investment == isChecked) {
            ...
            if (formData.entrepreneur_memorandum_uploader != '') {
                $('#entrepreneur_memorandum_uploader_container_for_textile').hide();
                $('#entrepreneur_memorandum_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.entrepreneur_memorandum_uploader);
                $('#entrepreneur_memorandum_uploader_name_container_for_textile').show();
                $('#entrepreneur_memorandum_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.entrepreneur_memorandum_uploader);
            }
            if (formData.partnership_deed_uploader != '') {
                $('#partnership_deed_uploader_container_for_textile').hide();
                $('#partnership_deed_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.partnership_deed_uploader);
                $('#partnership_deed_uploader_name_container_for_textile').show();
                $('#partnership_deed_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.partnership_deed_uploader);
            }
            if (formData.lease_agreement_uploader != '') {
                $('#lease_agreement_uploader_container_for_textile').hide();
                $('#lease_agreement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.lease_agreement_uploader);
                $('#lease_agreement_uploader_name_container_for_textile').show();
                $('#lease_agreement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.lease_agreement_uploader);
            }
            if (formData.loan_sanction_uploader != '') {
                $('#loan_sanction_uploader_container_for_textile').hide();
                $('#loan_sanction_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.loan_sanction_uploader);
                $('#loan_sanction_uploader_name_container_for_textile').show();
                $('#loan_sanction_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.loan_sanction_uploader);
            }
            if (formData.power_release_order_uploader != '') {
                $('#power_release_order_uploader_container_for_textile').hide();
                $('#power_release_order_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.power_release_order_uploader);
                $('#power_release_order_uploader_name_container_for_textile').show();
                $('#power_release_order_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.power_release_order_uploader);
            }
            if (formData.invoice_copy_uploader != '') {
                $('#invoice_copy_uploader_container_for_textile').hide();
                $('#invoice_copy_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.invoice_copy_uploader);
                $('#invoice_copy_uploader_name_container_for_textile').show();
                $('#invoice_copy_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.invoice_copy_uploader);
            }
            if (formData.ca_prescribed_uploader != '') {
                $('#ca_prescribed_uploader_container_for_textile').hide();
                $('#ca_prescribed_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.ca_prescribed_uploader);
                $('#ca_prescribed_uploader_name_container_for_textile').show();
                $('#ca_prescribed_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.ca_prescribed_uploader);
            }
            if (formData.certificate_commencement_uploader != '') {
                $('#certificate_commencement_uploader_container_for_textile').hide();
                $('#certificate_commencement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.certificate_commencement_uploader);
                $('#certificate_commencement_uploader_name_container_for_textile').show();
                $('#certificate_commencement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.certificate_commencement_uploader);
            }
            if (formData.engineer_certificate_uploader != '') {
                $('#engineer_certificate_uploader_container_for_textile').hide();
                $('#engineer_certificate_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.engineer_certificate_uploader);
                $('#engineer_certificate_uploader_name_container_for_textile').show();
                $('#engineer_certificate_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.engineer_certificate_uploader);
            }
            if (formData.expenses_certificate_uploader != '') {
                $('#expenses_certificate_uploader_container_for_textile').hide();
                $('#expenses_certificate_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.expenses_certificate_uploader);
                $('#expenses_certificate_uploader_name_container_for_textile').show();
                $('#expenses_certificate_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.expenses_certificate_uploader);
            }
            if (formData.stamped_receipt_uploader != '') {
                $('#stamped_receipt_uploader_container_for_textile').hide();
                $('#stamped_receipt_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.stamped_receipt_uploader);
                $('#stamped_receipt_uploader_name_container_for_textile').show();
                $('#stamped_receipt_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.stamped_receipt_uploader);
            }
            if (formData.sale_invoice_uploader != '') {
                $('#sale_invoice_uploader_container_for_textile').hide();
                $('#sale_invoice_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.sale_invoice_uploader);
                $('#sale_invoice_uploader_name_container_for_textile').show();
                $('#sale_invoice_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.sale_invoice_uploader);
            }
            if (formData.additional_document_uploader != '') {
                $('#additional_document_uploader_container_for_textile').hide();
                $('#additional_document_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.additional_document_uploader);
                $('#additional_document_uploader_name_container_for_textile').show();
                $('#additional_document_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.additional_document_uploader);
            }
            if (formData.factorylicence_copy_uploader != '') {
                $('#factorylicence_copy_uploader_container_for_textile').hide();
                $('#factorylicence_copy_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.factorylicence_copy_uploader);
                $('#factorylicence_copy_uploader_name_container_for_textile').show();
                $('#factorylicence_copy_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.factorylicence_copy_uploader);
            }
            if (formData.pcc_copy_uploader != '') {
                $('#pcc_copy_uploader_container_for_textile').hide();
                $('#pcc_copy_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.pcc_copy_uploader);
                $('#pcc_copy_uploader_name_container_for_textile').show();
                $('#pcc_copy_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.pcc_copy_uploader);
            }
            if (formData.expansion_date_uploader != '') {
                $('#expansion_date_uploader_container_for_textile').hide();
                $('#expansion_date_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.expansion_date_uploader);
                $('#expansion_date_uploader_name_container_for_textile').show();
                $('#expansion_date_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.expansion_date_uploader);
            }
            if (formData.production_turnover_uploader != '') {
                $('#production_turnover_uploader_container_for_textile').hide();
                $('#production_turnover_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.production_turnover_uploader);
                $('#production_turnover_uploader_name_container_for_textile').show();
                $('#production_turnover_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.production_turnover_uploader);
            }
            if (formData.fix_assets_value_uploader != '') {
                $('#fix_assets_value_uploader_container_for_textile').hide();
                $('#fix_assets_value_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.fix_assets_value_uploader);
                $('#fix_assets_value_uploader_name_container_for_textile').show();
                $('#fix_assets_value_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.fix_assets_value_uploader);
            }
            if (formData.production_capacity_uploader != '') {
                $('#production_capacity_uploader_container_for_textile').hide();
                $('#production_capacity_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.production_capacity_uploader);
                $('#production_capacity_uploader_name_container_for_textile').show();
                $('#production_capacity_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.production_capacity_uploader);
            }
            if (formData.patent_registration_uploader != '') {
                $('#patent_registration_uploader_container_for_textile').hide();
                $('#patent_registration_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.patent_registration_uploader);
                $('#patent_registration_uploader_name_container_for_textile').show();
                $('#patent_registration_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.patent_registration_uploader);
            }
            if (formData.energy_water_uploader != '') {
                $('#energy_water_uploader_container_for_textile').hide();
                $('#energy_water_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.energy_water_uploader);
                $('#energy_water_uploader_name_container_for_textile').show();
                $('#energy_water_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.energy_water_uploader);
            }
            if (formData.quality_certificate_uploader != '') {
                $('#quality_certificate_uploader_container_for_textile').hide();
                $('#quality_certificate_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.quality_certificate_uploader);
                $('#quality_certificate_uploader_name_container_for_textile').show();
                $('#quality_certificate_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.quality_certificate_uploader);
            }
            if (formData.resident_certificate_uploader != '') {
                $('#resident_certificate_uploader_container_for_textile').hide();
                $('#resident_certificate_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.resident_certificate_uploader);
                $('#resident_certificate_uploader_name_container_for_textile').show();
                $('#resident_certificate_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.resident_certificate_uploader);
            }
        }
        if (formData.is_intrest_subsidy == isChecked) {
            ...
            if (formData.bank_total_interest_uploader != '') {
                $('#bank_total_interest_uploader_container_for_textile').hide();
                $('#bank_total_interest_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.bank_total_interest_uploader);
                $('#bank_total_interest_uploader_name_container_for_textile').show();
                $('#bank_total_interest_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.bank_total_interest_uploader);
            }
            if (formData.bank_statement_uploader != '') {
                $('#bank_statement_uploader_container_for_textile').hide();
                $('#bank_statement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.bank_statement_uploader);
                $('#bank_statement_uploader_name_container_for_textile').show();
                $('#bank_statement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.bank_statement_uploader);
            }
            if (formData.annexure3_declaration_uploader != '') {
                $('#annexure3_declaration_uploader_container_for_textile').hide();
                $('#annexure3_declaration_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.annexure3_declaration_uploader);
                $('#annexure3_declaration_uploader_name_container_for_textile').show();
                $('#annexure3_declaration_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.annexure3_declaration_uploader);
            }
            if (formData.interest_subsidy_cal_uploader != '') {
                $('#interest_subsidy_cal_uploader_container_for_textile').hide();
                $('#interest_subsidy_cal_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.interest_subsidy_cal_uploader);
                $('#interest_subsidy_cal_uploader_name_container_for_textile').show();
                $('#interest_subsidy_cal_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.interest_subsidy_cal_uploader);
            }
            if (formData.year_annual_prod_uploader != '') {
                $('#year_annual_prod_uploader_container_for_textile').hide();
                $('#year_annual_prod_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.year_annual_prod_uploader);
                $('#year_annual_prod_uploader_name_container_for_textile').show();
                $('#year_annual_prod_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.year_annual_prod_uploader);
            }
            if (formData.year_bank_statement_uploader != '') {
                $('#year_bank_statement_uploader_container_for_textile').hide();
                $('#year_bank_statement_uploader_name_image_for_textile').attr('src', baseUrl + 'documents/textile/' + formData.year_bank_statement_uploader);
                $('#year_bank_statement_uploader_name_container_for_textile').show();
                $('#year_bank_statement_uploader_name_image_for_textile_download').attr("href", baseUrl + 'documents/textile/' + formData.year_bank_statement_uploader);
            }
        }
    },
    ...
    submitTextile: function (moduleType) {
        ...
        textileData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitSchemeDetails: function (moduleType) {
        ...
        schemeData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitPartFDetails: function (moduleType) {
        ...
        partFData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitPartGDetails: function (moduleType) {
        ...
        partGData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitPartHDetails: function (moduleType) {
        ...
        partHData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitTextileDeclaration: function (moduleType) {
        ...
        if ($('#sign_seal_container_for_textile').is(':visible')) {
            ...
            if (supportDocumentMessage != '') {
                $('#sign_seal_for_textile').focus();
                validationMessageShow('textile-sign_seal_for_textile', supportDocumentMessage);
                return false;
            }
        }
        ...
        declarationData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitTextileChecklist: function (moduleType) {
        ...
        checklistData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    downloadUploadChallan: function (textileId) {
        ...
        btnObj.attr('onclick', '');
        $.ajax({
            url: 'textile/get_textile_data_by_incentive_id',
            type: 'post',
            data: $.extend({}, {'incentive_id': textileId}, getTokenData()),
            error: function (textStatus, errorThrown) {
                generateNewCSRFToken();
    ...
    showChallan: function (textileData) {
        ...
        if (textileData.status != VALUE_FIVE) {
            textileData.show_fees_paid = true;
        }
        ...
        if (textileData.fees_paid_challan != '') {
            ...
            $('#fees_paid_challan_remove_btn_for_textile_upload_challan').attr('onclick', 'Textile.listview.removeFeesPaidChallan("' + textileData.incentive_id + '")');
        }
    },
    ...
    uploadFeesPaidChallan: function () {
        ...
        validationMessageHide();
        var textileId = $('#incentive_id_for_textile_upload_challan').val();
        if (!textileId) {
            showError(invalidAccessValidationMessage);
            return false;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                Swal.close();
                $('#status_' + textileId).html(appStatusArray[VALUE_FOUR]);
                showSuccess(parseData.message);
            }
        });
    },
    generateCertificate: function (textileId) {
        ...
        $('#incentive_id_for_certificate').val(textileId);

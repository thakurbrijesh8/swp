    ...
    loadFactoryLicenseRenewalData: function (sDistrict, sStatus) {
        ...
        var tempRegNoRenderer = function (data, type, full, meta) {
            return regNoRenderer(VALUE_FOURTYONE, data)
                    + getFRContainer(VALUE_FOURTYONE, data, full.rating, full.fr_datetime);
        };
        var that = this;
...
//        }
    ...
    showChallan: function (factoryLicenseRenewalData) {
        showPopup();
        if (factoryLicenseRenewalData.status != VALUE_FIVE && factoryLicenseRenewalData.status != VALUE_SIX && factoryLicenseRenewalData.status != VALUE_SEVEN && factoryLicenseRenewalData.status != VALUE_ELEVEN) {

...
//        addClass('msme', 'active');
    ...
    newMSMEForm: function (isEdit, parseData) {
        ...
        if (isEdit) {
            ...
            if (formData.women_entrepreneur != '') {
                ...
                $('#women_entrepreneur_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.women_entrepreneur);
                $('#women_entrepreneur_name_container_for_msme').show();
                $('#women_entrepreneur_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.women_entrepreneur);
            }

            if (formData.sc_st_entrepreneur != '') {
                $('#sc_st_entrepreneur_container_for_msme').hide();
                $('#sc_st_entrepreneur_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.sc_st_entrepreneur);
                $('#sc_st_entrepreneur_name_container_for_msme').show();
                $('#sc_st_entrepreneur_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.sc_st_entrepreneur);
            }
            if (formData.physically_entrepreneur != '') {
                $('#physically_entrepreneur_container_for_msme').hide();
                $('#physically_entrepreneur_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.physically_entrepreneur);
                $('#physically_entrepreneur_name_container_for_msme').show();
                $('#physically_entrepreneur_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.physically_entrepreneur);
            }
            if (formData.transgender_entrepreneur != '') {
                $('#transgender_entrepreneur_container_for_msme').hide();
                $('#transgender_entrepreneur_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.transgender_entrepreneur);
                $('#transgender_entrepreneur_name_container_for_msme').show();
                $('#transgender_entrepreneur_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.transgender_entrepreneur);
            }
            if (formData.other_entrepreneur != '') {
                $('#other_entrepreneur_container_for_msme').hide();
                $('#other_entrepreneur_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.other_entrepreneur);
                $('#other_entrepreneur_name_container_for_msme').show();
                $('#other_entrepreneur_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.other_entrepreneur);
            }

            if (formData.financial_assistance_upload != '') {
                $('#financial_assistance_upload_container_for_msme').hide();
                $('#financial_assistance_upload_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.financial_assistance_upload);
                $('#financial_assistance_upload_name_container_for_msme').show();
                $('#financial_assistance_upload_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.financial_assistance_upload);
            }

            if (formData.govt_dues_upload != '') {
                $('#govt_dues_upload_container_for_msme').hide();
                $('#govt_dues_upload_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.govt_dues_upload);
                $('#govt_dues_upload_name_container_for_msme').show();
                $('#govt_dues_upload_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.govt_dues_upload);
            }
    ...
    partDDetailsForm: function (incentivePartDData) {
        ...
        if (incentivePartDData.audit_report != '' && incentivePartDData.audit_report != undefined) {
            $('#audit_report_container_for_msme').hide();
            $('#audit_report_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + incentivePartDData.audit_report);
            $('#audit_report_name_container_for_msme').show();
            $('#audit_report_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + incentivePartDData.audit_report);
        }
        datePicker();
    ...
    msmeDeclarationForm: function (declarationData) {
        ...
        if (declarationData.sign_seal != '' && declarationData.sign_seal != undefined) {
            ...
            $('#sign_seal_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + declarationData.sign_seal);
    ...
    msmehecklistForm: function (checklistData) {
        ...
        if (checklistData.is_capital_investment == isChecked) {
            ...
            if (checklistData.entrepreneur_memorandum_uploader != '' && checklistData.entrepreneur_memorandum_uploader != undefined) {
                ...
                $('#entrepreneur_memorandum_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.entrepreneur_memorandum_uploader);
                $('#entrepreneur_memorandum_uploader_name_container_for_msme').show();
                $('#entrepreneur_memorandum_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.entrepreneur_memorandum_uploader);
            }
            if (checklistData.partnership_deed_uploader != '' && checklistData.partnership_deed_uploader != undefined) {
                ...
                $('#partnership_deed_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.partnership_deed_uploader);
                $('#partnership_deed_uploader_name_container_for_msme').show();
                $('#partnership_deed_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.partnership_deed_uploader);
            }
            if (checklistData.lease_agreement_uploader != '' && checklistData.lease_agreement_uploader != undefined) {
                ...
                $('#lease_agreement_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.lease_agreement_uploader);
                $('#lease_agreement_uploader_name_container_for_msme').show();
                $('#lease_agreement_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.lease_agreement_uploader);
            }
            if (checklistData.loan_sanction_uploader != '' && checklistData.loan_sanction_uploader != undefined) {
                ...
                $('#loan_sanction_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.loan_sanction_uploader);
                $('#loan_sanction_uploader_name_container_for_msme').show();
                $('#loan_sanction_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.loan_sanction_uploader);
            }
            if (checklistData.power_release_order_uploader != '' && checklistData.power_release_order_uploader != undefined) {
                ...
                $('#power_release_order_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.power_release_order_uploader);
                $('#power_release_order_uploader_name_container_for_msme').show();
                $('#power_release_order_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.power_release_order_uploader);
            }
            if (checklistData.invoice_copy_uploader != '' && checklistData.invoice_copy_uploader != undefined) {
                ...
                $('#invoice_copy_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.invoice_copy_uploader);
                $('#invoice_copy_uploader_name_container_for_msme').show();
                $('#invoice_copy_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.invoice_copy_uploader);
            }
            if (checklistData.ca_prescribed_uploader != '' && checklistData.ca_prescribed_uploader != undefined) {
                ...
                $('#ca_prescribed_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.ca_prescribed_uploader);
                $('#ca_prescribed_uploader_name_container_for_msme').show();
                $('#ca_prescribed_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.ca_prescribed_uploader);
            }
            if (checklistData.certificate_commencement_uploader != '' && checklistData.certificate_commencement_uploader != undefined) {
                ...
                $('#certificate_commencement_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.certificate_commencement_uploader);
                $('#certificate_commencement_uploader_name_container_for_msme').show();
                $('#certificate_commencement_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.certificate_commencement_uploader);
            }
            if (checklistData.engineer_certificate_uploader != '' && checklistData.engineer_certificate_uploader != undefined) {
                ...
                $('#engineer_certificate_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.engineer_certificate_uploader);
                $('#engineer_certificate_uploader_name_container_for_msme').show();
                $('#engineer_certificate_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.engineer_certificate_uploader);
            }
            if (checklistData.expenses_certificate_uploader != '' && checklistData.expenses_certificate_uploader != undefined) {
                ...
                $('#expenses_certificate_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.expenses_certificate_uploader);
                $('#expenses_certificate_uploader_name_container_for_msme').show();
                $('#expenses_certificate_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.expenses_certificate_uploader);
            }
            if (checklistData.stamped_receipt_uploader != '' && checklistData.stamped_receipt_uploader != undefined) {
                ...
                $('#stamped_receipt_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.stamped_receipt_uploader);
                $('#stamped_receipt_uploader_name_container_for_msme').show();
                $('#stamped_receipt_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.stamped_receipt_uploader);
            }
            if (checklistData.sale_invoice_uploader != '' && checklistData.sale_invoice_uploader != undefined) {
                ...
                $('#sale_invoice_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.sale_invoice_uploader);
                $('#sale_invoice_uploader_name_container_for_msme').show();
                $('#sale_invoice_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.sale_invoice_uploader);
            }
            if (checklistData.additional_document_uploader != '' && checklistData.additional_document_uploader != undefined) {
                ...
                $('#additional_document_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.additional_document_uploader);
                $('#additional_document_uploader_name_container_for_msme').show();
                $('#additional_document_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.additional_document_uploader);
            }
            if (checklistData.factorylicence_copy_uploader != '' && checklistData.factorylicence_copy_uploader != undefined) {
                ...
                $('#factorylicence_copy_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.factorylicence_copy_uploader);
                $('#factorylicence_copy_uploader_name_container_for_msme').show();
                $('#factorylicence_copy_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.factorylicence_copy_uploader);
            }
            if (checklistData.pcc_copy_uploader != '' && checklistData.pcc_copy_uploader != undefined) {
                $('#pcc_copy_uploader_container_for_msme').hide();
                $('#pcc_copy_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.pcc_copy_uploader);
                $('#pcc_copy_uploader_name_container_for_msme').show();
                $('#pcc_copy_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.pcc_copy_uploader);
            }
            if (checklistData.expansion_date_uploader != '' && checklistData.expansion_date_uploader != undefined) {
                ...
                $('#expansion_date_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.expansion_date_uploader);
                $('#expansion_date_uploader_name_container_for_msme').show();
                $('#expansion_date_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.expansion_date_uploader);
            }
            if (checklistData.production_turnover_uploader != '' && checklistData.production_turnover_uploader != undefined) {
                ...
                $('#production_turnover_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.production_turnover_uploader);
                $('#production_turnover_uploader_name_container_for_msme').show();
                $('#production_turnover_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.production_turnover_uploader);
            }
            if (checklistData.fix_assets_value_uploader != '' && checklistData.fix_assets_value_uploader != undefined) {
                ...
                $('#fix_assets_value_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.fix_assets_value_uploader);
                $('#fix_assets_value_uploader_name_container_for_msme').show();
                $('#fix_assets_value_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.fix_assets_value_uploader);
            }
            if (checklistData.production_capacity_uploader != '' && checklistData.production_capacity_uploader != undefined) {
                ...
                $('#production_capacity_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.production_capacity_uploader);
                $('#production_capacity_uploader_name_container_for_msme').show();
                $('#production_capacity_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.production_capacity_uploader);
            }
            if (checklistData.patent_registration_uploader != '' && checklistData.patent_registration_uploader != undefined) {
                ...
                $('#patent_registration_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.patent_registration_uploader);
                $('#patent_registration_uploader_name_container_for_msme').show();
                $('#patent_registration_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.patent_registration_uploader);
            }
            if (checklistData.energy_water_uploader != '' && checklistData.energy_water_uploader != undefined) {
                ...
                $('#energy_water_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.energy_water_uploader);
                $('#energy_water_uploader_name_container_for_msme').show();
                $('#energy_water_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.energy_water_uploader);
            }
            if (checklistData.quality_certificate_uploader != '' && checklistData.quality_certificate_uploader != undefined) {
                ...
                $('#quality_certificate_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.quality_certificate_uploader);
                $('#quality_certificate_uploader_name_container_for_msme').show();
                $('#quality_certificate_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.quality_certificate_uploader);
            }
            if (checklistData.resident_certificate_uploader != '' && checklistData.resident_certificate_uploader != undefined) {
                ...
                $('#resident_certificate_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.resident_certificate_uploader);
                $('#resident_certificate_uploader_name_container_for_msme').show();
                $('#resident_certificate_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.resident_certificate_uploader);
            }
        }
        if (checklistData.is_intrest_subsidy == isChecked) {
            ...
            if (checklistData.bank_total_interest_uploader != '' && checklistData.bank_total_interest_uploader != undefined) {
                ...
                $('#bank_total_interest_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.bank_total_interest_uploader);
                $('#bank_total_interest_uploader_name_container_for_msme').show();
                $('#bank_total_interest_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.bank_total_interest_uploader);
            }
            if (checklistData.bank_statement_uploader != '' && checklistData.bank_statement_uploader != undefined) {
                ...
                $('#bank_statement_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.bank_statement_uploader);
                $('#bank_statement_uploader_name_container_for_msme').show();
                $('#bank_statement_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.bank_statement_uploader);
            }
            if (checklistData.annexure3_declaration_uploader != '' && checklistData.annexure3_declaration_uploader != undefined) {
                ...
                $('#annexure3_declaration_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.annexure3_declaration_uploader);
                $('#annexure3_declaration_uploader_name_container_for_msme').show();
                $('#annexure3_declaration_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.annexure3_declaration_uploader);
            }
            if (checklistData.interest_subsidy_cal_uploader != '' && checklistData.interest_subsidy_cal_uploader != undefined) {
                ...
                $('#interest_subsidy_cal_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.interest_subsidy_cal_uploader);
                $('#interest_subsidy_cal_uploader_name_container_for_msme').show();
                $('#interest_subsidy_cal_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.interest_subsidy_cal_uploader);
            }
            if (checklistData.year_annual_prod_uploader != '' && checklistData.year_annual_prod_uploader != undefined) {
                ...
                $('#year_annual_prod_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.year_annual_prod_uploader);
                $('#year_annual_prod_uploader_name_container_for_msme').show();
                $('#year_annual_prod_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.year_annual_prod_uploader);
            }
            if (checklistData.year_bank_statement_uploader != '' && checklistData.year_bank_statement_uploader != undefined) {
                ...
                $('#year_bank_statement_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + checklistData.year_bank_statement_uploader);
                $('#year_bank_statement_uploader_name_container_for_msme').show();
                $('#year_bank_statement_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + checklistData.year_bank_statement_uploader);
            }
        }
    ...
    viewPartDForm: function (parseData) {
        ...
        if (formData.audit_report != '') {
            $('#audit_report_container_for_msme').hide();
            $('#audit_report_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.audit_report);
            $('#audit_report_name_container_for_msme').show();
            $('#audit_report_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.audit_report);
        }
    },
    ...
    viewDeclarationForm: function (parseData) {
        ...
        if (formData.sign_seal != '') {
            $('#sign_seal_container_for_msme').hide();
            $('#sign_seal_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.sign_seal);
            $('#sign_seal_name_container_for_msme').show();
        }
    },
    viewChecklistForm: function (parseData) {
        ...
        if (formData.is_capital_investment == isChecked) {
            ...
            if (formData.entrepreneur_memorandum_uploader != '') {
                $('#entrepreneur_memorandum_uploader_container_for_msme').hide();
                $('#entrepreneur_memorandum_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.entrepreneur_memorandum_uploader);
                $('#entrepreneur_memorandum_uploader_name_container_for_msme').show();
                $('#entrepreneur_memorandum_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.entrepreneur_memorandum_uploader);
            }
            if (formData.partnership_deed_uploader != '') {
                $('#partnership_deed_uploader_container_for_msme').hide();
                $('#partnership_deed_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.partnership_deed_uploader);
                $('#partnership_deed_uploader_name_container_for_msme').show();
                $('#partnership_deed_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.partnership_deed_uploader);
            }
            if (formData.lease_agreement_uploader != '') {
                $('#lease_agreement_uploader_container_for_msme').hide();
                $('#lease_agreement_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.lease_agreement_uploader);
                $('#lease_agreement_uploader_name_container_for_msme').show();
                $('#lease_agreement_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.lease_agreement_uploader);
            }
            if (formData.loan_sanction_uploader != '') {
                $('#loan_sanction_uploader_container_for_msme').hide();
                $('#loan_sanction_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.loan_sanction_uploader);
                $('#loan_sanction_uploader_name_container_for_msme').show();
                $('#loan_sanction_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.loan_sanction_uploader);
            }
            if (formData.power_release_order_uploader != '') {
                $('#power_release_order_uploader_container_for_msme').hide();
                $('#power_release_order_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.power_release_order_uploader);
                $('#power_release_order_uploader_name_container_for_msme').show();
                $('#power_release_order_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.power_release_order_uploader);
            }
            if (formData.invoice_copy_uploader != '') {
                $('#invoice_copy_uploader_container_for_msme').hide();
                $('#invoice_copy_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.invoice_copy_uploader);
                $('#invoice_copy_uploader_name_container_for_msme').show();
                $('#invoice_copy_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.invoice_copy_uploader);
            }
            if (formData.ca_prescribed_uploader != '') {
                $('#ca_prescribed_uploader_container_for_msme').hide();
                $('#ca_prescribed_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.ca_prescribed_uploader);
                $('#ca_prescribed_uploader_name_container_for_msme').show();
                $('#ca_prescribed_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.ca_prescribed_uploader);
            }
            if (formData.certificate_commencement_uploader != '') {
                $('#certificate_commencement_uploader_container_for_msme').hide();
                $('#certificate_commencement_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.certificate_commencement_uploader);
                $('#certificate_commencement_uploader_name_container_for_msme').show();
                $('#certificate_commencement_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.certificate_commencement_uploader);
            }
            if (formData.engineer_certificate_uploader != '') {
                $('#engineer_certificate_uploader_container_for_msme').hide();
                $('#engineer_certificate_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.engineer_certificate_uploader);
                $('#engineer_certificate_uploader_name_container_for_msme').show();
                $('#engineer_certificate_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.engineer_certificate_uploader);
            }
            if (formData.expenses_certificate_uploader != '') {
                $('#expenses_certificate_uploader_container_for_msme').hide();
                $('#expenses_certificate_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.expenses_certificate_uploader);
                $('#expenses_certificate_uploader_name_container_for_msme').show();
                $('#expenses_certificate_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.expenses_certificate_uploader);
            }
            if (formData.stamped_receipt_uploader != '') {
                $('#stamped_receipt_uploader_container_for_msme').hide();
                $('#stamped_receipt_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.stamped_receipt_uploader);
                $('#stamped_receipt_uploader_name_container_for_msme').show();
                $('#stamped_receipt_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.stamped_receipt_uploader);
            }
            if (formData.sale_invoice_uploader != '') {
                $('#sale_invoice_uploader_container_for_msme').hide();
                $('#sale_invoice_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.sale_invoice_uploader);
                $('#sale_invoice_uploader_name_container_for_msme').show();
                $('#sale_invoice_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.sale_invoice_uploader);
            }
            if (formData.additional_document_uploader != '') {
                $('#additional_document_uploader_container_for_msme').hide();
                $('#additional_document_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.additional_document_uploader);
                $('#additional_document_uploader_name_container_for_msme').show();
                $('#additional_document_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.additional_document_uploader);
            }
            if (formData.factorylicence_copy_uploader != '') {
                $('#factorylicence_copy_uploader_container_for_msme').hide();
                $('#factorylicence_copy_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.factorylicence_copy_uploader);
                $('#factorylicence_copy_uploader_name_container_for_msme').show();
                $('#factorylicence_copy_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.factorylicence_copy_uploader);
            }
            if (formData.pcc_copy_uploader != '') {
                $('#pcc_copy_uploader_container_for_msme').hide();
                $('#pcc_copy_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.pcc_copy_uploader);
                $('#pcc_copy_uploader_name_container_for_msme').show();
                $('#pcc_copy_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.pcc_copy_uploader);
            }
            if (formData.expansion_date_uploader != '') {
                $('#expansion_date_uploader_container_for_msme').hide();
                $('#expansion_date_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.expansion_date_uploader);
                $('#expansion_date_uploader_name_container_for_msme').show();
                $('#expansion_date_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.expansion_date_uploader);
            }
            if (formData.production_turnover_uploader != '') {
                $('#production_turnover_uploader_container_for_msme').hide();
                $('#production_turnover_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.production_turnover_uploader);
                $('#production_turnover_uploader_name_container_for_msme').show();
                $('#production_turnover_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.production_turnover_uploader);
            }
            if (formData.fix_assets_value_uploader != '') {
                $('#fix_assets_value_uploader_container_for_msme').hide();
                $('#fix_assets_value_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.fix_assets_value_uploader);
                $('#fix_assets_value_uploader_name_container_for_msme').show();
                $('#fix_assets_value_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.fix_assets_value_uploader);
            }
            if (formData.production_capacity_uploader != '') {
                $('#production_capacity_uploader_container_for_msme').hide();
                $('#production_capacity_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.production_capacity_uploader);
                $('#production_capacity_uploader_name_container_for_msme').show();
                $('#production_capacity_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.production_capacity_uploader);
            }
            if (formData.patent_registration_uploader != '') {
                $('#patent_registration_uploader_container_for_msme').hide();
                $('#patent_registration_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.patent_registration_uploader);
                $('#patent_registration_uploader_name_container_for_msme').show();
                $('#patent_registration_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.patent_registration_uploader);
            }
            if (formData.energy_water_uploader != '') {
                $('#energy_water_uploader_container_for_msme').hide();
                $('#energy_water_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.energy_water_uploader);
                $('#energy_water_uploader_name_container_for_msme').show();
                $('#energy_water_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.energy_water_uploader);
            }
            if (formData.quality_certificate_uploader != '') {
                $('#quality_certificate_uploader_container_for_msme').hide();
                $('#quality_certificate_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.quality_certificate_uploader);
                $('#quality_certificate_uploader_name_container_for_msme').show();
                $('#quality_certificate_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.quality_certificate_uploader);
            }
            if (formData.resident_certificate_uploader != '') {
                $('#resident_certificate_uploader_container_for_msme').hide();
                $('#resident_certificate_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.resident_certificate_uploader);
                $('#resident_certificate_uploader_name_container_for_msme').show();
                $('#resident_certificate_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.resident_certificate_uploader);
            }
        }
        if (formData.is_intrest_subsidy == isChecked) {
            ...
            if (formData.bank_total_interest_uploader != '') {
                $('#bank_total_interest_uploader_container_for_msme').hide();
                $('#bank_total_interest_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.bank_total_interest_uploader);
                $('#bank_total_interest_uploader_name_container_for_msme').show();
                $('#bank_total_interest_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.bank_total_interest_uploader);
            }
            if (formData.bank_statement_uploader != '') {
                $('#bank_statement_uploader_container_for_msme').hide();
                $('#bank_statement_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.bank_statement_uploader);
                $('#bank_statement_uploader_name_container_for_msme').show();
                $('#bank_statement_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.bank_statement_uploader);
            }
            if (formData.annexure3_declaration_uploader != '') {
                $('#annexure3_declaration_uploader_container_for_msme').hide();
                $('#annexure3_declaration_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.annexure3_declaration_uploader);
                $('#annexure3_declaration_uploader_name_container_for_msme').show();
                $('#annexure3_declaration_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.annexure3_declaration_uploader);
            }
            if (formData.interest_subsidy_cal_uploader != '') {
                $('#interest_subsidy_cal_uploader_container_for_msme').hide();
                $('#interest_subsidy_cal_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.interest_subsidy_cal_uploader);
                $('#interest_subsidy_cal_uploader_name_container_for_msme').show();
                $('#interest_subsidy_cal_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.interest_subsidy_cal_uploader);
            }
            if (formData.year_annual_prod_uploader != '') {
                $('#year_annual_prod_uploader_container_for_msme').hide();
                $('#year_annual_prod_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.year_annual_prod_uploader);
                $('#year_annual_prod_uploader_name_container_for_msme').show();
                $('#year_annual_prod_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.year_annual_prod_uploader);
            }
            if (formData.year_bank_statement_uploader != '') {
                $('#year_bank_statement_uploader_container_for_msme').hide();
                $('#year_bank_statement_uploader_name_image_for_msme').attr('src', baseUrl + 'documents/msme/' + formData.year_bank_statement_uploader);
                $('#year_bank_statement_uploader_name_container_for_msme').show();
                $('#year_bank_statement_uploader_name_image_for_msme_download').attr("href", baseUrl + 'documents/msme/' + formData.year_bank_statement_uploader);
            }
        }
    },
    ...
    submitMSME: function (moduleType) {
        ...
        msmeData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitPartADetails: function (moduleType) {
        ...
        partAData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitPartBDetails: function (moduleType) {
        ...
        partBData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitPartCDetails: function (moduleType) {
        ...
        partCData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitPartDDetails: function (moduleType) {
        ...
        partDData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitPartEDetails: function (moduleType) {
        ...
        partEData.append("csrf_token_eodbsws", getTokenData()['csrf_token_eodbsws']);
    ...
    submitMsmeDeclaration: function (moduleType) {
        ...
        if ($('#sign_seal_container_for_msme').is(':visible')) {
            ...
            if (supportDocumentMessage != '') {
                $('#sign_seal_for_msme').focus();
                validationMessageShow('msme-sign_seal_for_msme', supportDocumentMessage);
                return false;
            }
        }
        ...
        if (checklistData.is_capital_investment == isChecked) {
            ...
            if ($('#stamped_receipt_uploader_container_for_msme').is(':visible')) {
                ...
                if (stampedReceiptMessage != '') {
                    $('#stamped_receipt_uploader_for_msme').focus();
                    validationMessageShow('msme-stamped_receipt_uploader_for_msme', stampedReceiptMessage);
                    return false;
                }
            }
    ...
    downloadUploadChallan: function (msmeId) {
        ...
        btnObj.attr('onclick', '');
        $.ajax({
            url: 'msme/get_msme_data_by_incentive_id',
            type: 'post',
            data: $.extend({}, {'incentive_id': msmeId}, getTokenData()),
            error: function (textStatus, errorThrown) {
                generateNewCSRFToken();
    ...
    showChallan: function (msmeData) {
        ...
        if (msmeData.fees_paid_challan != '') {
            ...
            $('#fees_paid_challan_remove_btn_for_msme_upload_challan').attr('onclick', 'MSME.listview.removeFeesPaidChallan("' + msmeData.incentive_id + '")');
        }
    },
    ...
    uploadFeesPaidChallan: function () {
        ...
        validationMessageHide();
        var msmeId = $('#incentive_id_for_msme_upload_challan').val();
        if (!msmeId) {
            showError(invalidAccessValidationMessage);
            return false;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                Swal.close();
                $('#status_' + msmeId).html(appStatusArray[VALUE_FOUR]);
                showSuccess(parseData.message);
            }
        });
    },
    generateCertificate: function (msmeId) {
        ...
        $('#incentive_id_for_certificate').val(msmeId);

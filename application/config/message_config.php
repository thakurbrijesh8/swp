...
define('ACCOUNT_NOT_ACTIVE_MESSAGE', 'Your Account is Not Active !');
define('ACCOUNT_DEACTIVATED_MESSAGE', 'Your Account is Deactivated !');
define('MOBILE_NUMBER_MESSAGE', 'Enter Mobile Number !');
define('MOBILE_NOT_EXIST_MESSAGE', 'Mobile Number Does Not Exist !');
...
define('OTP_MESSAGE', 'Enter Your OTP !');
define('INCORRECT_OTP_MESSAGE', 'Incorrect OTP !');
define('VERIFICATION_SUCCESS_MESSAGE', '<div class="text-center">Mobile Number Verified Successfully !</div></br><br>Mobile Number and Pin Successfully sent to yout Registered Mobile Number and Email Adderess !</br><br> <div class="text-center">Click here to Login !</div>');
define('OTP_SEND_MESSAGE', 'Your OTP Was Send Successfully !');
define('OTP_RESEND_MESSAGE', 'OTP Resend successfully !');
...
define('CHALLAN_UPLOADED_MESSAGE', 'Challan Uploaded Successfully !');
define('PASSBOOK_UPLOADED_MESSAGE', 'Passbook Uploaded Successfully !');
define('NAME_MESSAGE', 'Enter Applicant Name !');
define('ADDRESS_MESSAGE', 'Enter Applicant Address !');
define('EXISTS_MOBILE_NUMBER_MESSAGE', 'Mobile Number Already Exists !');
define('EXISTS_EMAIL_MESSAGE', 'Email Address Already Exists !');
...
define('APP_SUBMITTED_QR_MESSAGE', 'Application Submitted & Query Responded Successfully  !');
define('LICENSE_NO_NOT_AVAILABLE', 'Invalid License Number !');
define('INVALID_CERTIFICATE_MESSAGE', 'Invalid Certificate !');
define('ENTER_BARCODE_NUMBER_MESSAGE', 'Enter Barcode / Certificate Number !');
define('ENTER_PROPER_NUMBER_MESSAGE', 'Enter Proper 9 Digit Number !');
...
define('VILLAGE_MESSAGE', 'Enter Village Name !');
...
define('FEES_MESSAGE', 'Select Category of Hotel according generate Fees !');
...
//Enterprise Module
define('ENTERPRISE_NAME_MESSAGE', 'Enter Enterprise Name !');
define('CITY_TOWN_MESSAGE', 'Enter City / Town !');
define('MAIN_PRODUCT_MESSAGE', 'Enter Main Product !');
define('ROW_MATERIAL_MESSAGE', 'Enter Row Material !');
...
define('QUERY_RESPONDED_MESSAGE', 'Query Responded Successfully !');
...
define('AGENCY_NAME_MESSAGE', 'Enter Name & Address of Certifying Agency !');
...
define('REQUEST_LETTER_PREMISES_MESSAGE', 'Select appropriate option to upload request letter of premises  !');
define('LAND_REVENUE_MESSAGE', 'Select appropriate option to upload No Due Certificate from Mamlatdar/Patel Talati regarding land revenue.    !');
define('ORIGINAL_EXTRACT_MESSAGE', 'Select appropriate option to upload Original 7 X 12 extract  !');
define('ELECTRICITY_BILL_MESSAGE', 'Select appropriate option to upload No Due Certificate from Electricity Department/last bill paid copy.  !');
define('BANK_LOAN_MESSAGE', 'Select appropriate option to upload No Dues Certificate from Banks/Financial Institution/Bank regarding loan.   !');
define('PANCHAYAT_TAX_MESSAGE', 'Select appropriate option to upload Panchayat tax receipt/No Dues Certificate from group Gram Panchayat/Municipality   regarding panchayat tax. !');
define('CHALLAN_OF_LEASE_MESSAGE', 'Select appropriate option to upload Challan of lease rent from Lessee   !');
define('OCCUPANCY_MESSAGE', 'Select appropriate option to upload Occupancy Certificate, if there is factory building. !');
define('CENTRAL_EXCISE_MESSAGE', 'Select appropriate option to upload No Due Certificate from P.C.C., VAT, C.I.F. & B. and Central Excise.  !');
define('AUTHORIZATION_SIGN_MESSAGE', 'Select appropriate option to upload Valid authorization to sign on behalf of Lessee  !');
...
define('AREA_OF_AGENCY_MESSAGE', 'Enter Area where the Travel being operated/to be operated !');
...
define('LICENSE_NO_MESSAGE', 'Enter Permission / License No !');
...
define('OWNER_NAME_MESSAGE', 'Enter Owner Name !');
define('OWNER_ADDRESS_MESSAGE', 'Enter Owner Address !');
...
// Inspection
define('fULL_ADDRESS_MESSAGE', 'Enter Full address of Owner !');
define('plinth_column_MESSAGE', 'Enter details of the plinth / column !');
define('PLOT_no_MESSAGE', 'Enter Plot Number!');
define('ZONE_MSG', 'Enter Zone!');
define('ROAD_MESSAGE', 'Enter Road!');
define('STREET_MESSAGE', 'Enter Street!');
define('INDUSTRIAL_AREA_MESSAGE', 'Enter Industrial area..!');
define('COMMUNICATION_MESSAGE', 'Enter Permission/Licsencse No vide dated issued by PDA');
define('Licensed_NAME_MESSAGE', 'Enter License Name!');
define('REGISTRATION_Number_MESSAGE', 'Enter Registration Number!');
define('SIGNATURE_ARCHI_MESSAGE', 'Upload Document Please!');
define('OWNER_DisTRICT_MESSAGE', 'Select appropriate option!');
...
//define('UPLOAD_DOCUMENT_MESSAGE', 'Upload Valid Document !');
//define('APP_DRAFT_MESSAGE', 'Application Save as Draft Successfully  !');
define('MAIL_SENT_SUCCESS_MESSAGE', 'Mail Sent Successfully  !');
...
define('FEE_PAID_AMOUNT_MESSAGE', 'Enter Amount  of Fee paid Rs. !');
define('RECEIPT_NUMBER_MESSAGE', 'Enter Treasury receipt Number !');
define('RECEIPT_DATE_MESSAGE', 'Enter Treasury receipt Date !');
...
define('EXPIRY_DATE_MESSAGE', 'Enter Expiry Date !');
define('LICENCE_STATUS_MESSAGE', 'Enter Wheather Licence of the Contractor was suspended or revoked !');

//Query Grievance
define('COMPANY_NAME_MESSAGE', 'Enter Company Name !');
...
define('INDUSTRY_CLASSIFICATION_MESSAGE', 'Select Industry Classification !');
define('APPLICATION_NUMBER_MESSAGE', 'Enter Application Number !');
define('QUERY_DETAIL_MESSAGE', 'Enter Query Detail !');
define('QUERY_REFERENCE_NUMBER_MESSAGE', 'Enter Query Reference Number !');
define('QUERY_OTHER_DEPARTMENT_MESSAGE', 'Enter Other Department Name !');

// Survey Module / Industry Profile
define('COMPANY_ADDRESS_MESSAGE', 'Enter Address Of Unit !');
define('ENTREPRENEUR_NAME_MESSAGE', 'Enter Name of Entrepreneur !');
define('ESTATE_NAME_MESSAGE', 'Enter Name of Industrial Estate !');
define('UDYOG_AADHAR_MEMORANDUM_MESSAGE', 'Enter Udyog Aadhar Number / Industrial Memorandum !');
define('ENTER_PAN_MESSAGE', 'Enter PAN Number !');
define('INVALID_PAN_MESSAGE', 'Invalid PAN Number !');
define('OFFICIAL_ADDRESS_MESSAGE', 'Enter Official / Communication Address !');
//define('AMOUNT_MESSAGE', 'Enter Amount !');
//define('TURNOVER_MESSAGE', 'Enter Turnover of Establishment !');
define('EMPLOYMENT_MESSAGE', 'Enter Employment in Nos. !');
define('NO_OF_EMP_MESSAGE', 'Enter No. of Employee !');
//define('RAW_MATERIAL_MESSAGE', 'Enter Raw material !');
define('MAJOR_PRODUCT_MESSAGE', 'Enter Major Product / Finished Goods !');
define('INDUSTRIAL_PRODUCT_MESSAGE', 'Enter Details of the Industrial Process !');
define('PAST_YEAR_TURNOVER_MESSAGE', 'Enter Annual Turn Over of Past Year in Rs. !');
define('YEAR_MESSAGE', 'Enter Year !');
define('GSTIN_NUMBER_MESSAGE', 'Enter GSTIN Number !');
define('FIRE_SAFTEY_MEASURES_MESSAGE', 'Enter Fire Safety Measures. !');
define('FIRST_AID_APPLIANCES_MESSAGE', 'Enter First-Aid Appliances. !');
define('SAFTEY_MEASURES_MESSAGE', 'Enter Industrial Safety Measures !');
define('POLLUTION_CONTROL_MESSAGE', 'Enter Pollution Control Measures !');
define('TAX_DUE_PPY_MESSAGE', 'Enter Tax Dues Paid Per Year !');
define('OTHER_ORG_MESSAGE', 'Enter Other Type of Organization !');
define('DETAILS_MESSAGE', 'Enter Details !');
define('QUARTERS_NUMBER_MESSAGE', 'Enter Number of Quarters !');
define('LIMIT_MAX_TEN_MESSAGE', 'Limit Exceed. Enter Max 10 Row !');
define('ONE_ROW_MESSAGE', 'Enter at Least One Row of Installed Production Capacity (Product Wise Per Annum) !');
//define('VILLAGE_NAME_MESSAGE', 'Enter Village Name !');
define('SELECT_INDUSTRY_TYPE_MESSAGE', 'Select Type of Industry !');
define('SELECT_STATE_MESSAGE', 'Select Native State/UT !');
define('SELECT_ONE_OPTION_MESSAGE', 'Select One Option !');

// Company Profile Module
define('UPDATE_COMPANY_PROFILE_MESSAGE', '<i class="fa fa-thumbs-o-up"></i>Company Profile Updated Successfully !');
...
// VC
define('CAPACITY_MESSAGE', 'Enter Capacity !');
define('MAKE_MESSAGE', 'Enter Make !');
define('MODEL_NO_MESSAGE', 'Enter Model Number !');
...
define('ENTER_AREA_MESSAGE', 'Enter Area !');
...
define('SOCIETY_NAME_MESSAGE', 'Enter Name of Proposed Society !');
define('SOCIETY_ADDRESS_MESSAGE', 'Enter Address to be Registered !');

///Nil Certificate
define('PROPERTY_DETAIL_MESSAGE', 'Enter Property Detail !');

define('CFR_MESSAGE', 'Enter Comments / Feedback !');
define('CFR_SUBMITTED_MESSAGE', 'Your Comments / Feedback on Regulation is Submitted Successfully !');

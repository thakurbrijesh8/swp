<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="Tourismevent.listview.newTourismeventForm(false, {});">Apply for New Tourism Event for Performance License</button>
        </h3>
    </div>

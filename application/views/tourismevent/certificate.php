...
<!--<div style="font-size: 14px; text-align: right;margin-top: 40px; margin-bottom: 5px;margin-right: 40px;"><img src="<?php echo base_url(); ?>documents/tourismevent/<?php echo $tourismevent_data['signature']; ?>" height="80px" width="80px"></div>-->
<div style="font-size: 14px; text-align: right; margin-top: 0px; margin-bottom: 0px;font-weight: bold;margin-right: 20px;word-spacing: 5px;">Director of Tourism<br>DNH & DD.</div>

<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-8">
                <h1 class="m-0 text-dark"><i class="nav-icon fas fa-film"></i> Tourism Event for Performance License</h1>
            </div>
            <div class="col-sm-4">
...
<section class="content">
    <div class="container-fluid" id="tourismevent_form_and_datatable_container">
    </div>
</section>

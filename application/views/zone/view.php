                ...
                <div class="card-body">
                    ...
                    <div class="row">
                     ...
                     <div class="form-group col-sm-12" id="site_plan_name_container_for_zone" style="display: none;">
                            ...
                            <a id="site_plan_download" target="_blank"><label id="site_plan_name_image_for_zone" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div>
                     ...
                     <div class="form-group col-sm-12" id="I_XIV_nakal_name_container_for_zone" style="display: none;">
                            ...
                            <a id="I_XIV_nakal_download" target="_blank"><label id="I_XIV_nakal_name_image_for_zone" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_zone" style="display: none;">
                            ...
                            <a id="seal_and_stamp_download" target="_blank">
                                <img id="seal_and_stamp_name_image_for_zone" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>

            ...
            <form role="form" id="zone_form" name="zone_form" onsubmit="return false;">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_zone" class="btn btn-sm btn-nic-blue" onclick="Zone.listview.submitZone({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>

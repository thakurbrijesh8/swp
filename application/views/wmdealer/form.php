        ...
        <div class="card">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_dealer" class="btn btn-sm btn-nic-blue" onclick="Dealer.listview.submitDealer({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>
                        <button type="button" id="submit_btn_for_dealer" class="btn btn-sm btn-success" onclick="Dealer.listview.askForSubmitDealer({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>

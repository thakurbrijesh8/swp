        ...
        <div class="card">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_dealer" class="btn btn-sm btn-nic-blue" onclick="Dealer.listview.submitDealer({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>

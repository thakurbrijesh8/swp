            ...
            <form role="form" id="subletting_form" name="subletting_form" onsubmit="return false;">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="villages_for_noc_data" name="villages_for_noc_data"
                                        data-placeholder="Status !" onblur="checkValidation('subletting', 'villages_for_noc_data', villageNameValidationMessage); getPlotData($(this), 'plot_no', 'transfer_data');" disabled="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 m-b-5px" id="authorization_sign_lessee_container_for_subletting_view">
                            <label>21.1  Sign on behalf of Lessee. 
                                <label class="f-w-n">Document Not Uploaded</label><br>
                                </div>
                                <div class="form-group col-sm-12" id="authorization_sign_lessee_name_container_for_subletting_view" style="display: none;">
                                    <label>21.1  Sign on behalf of Lessee. <span style="color: red;">* </label><br>
                                    <a target="_blank" id="authorization_sign_lessee_download">
                                        <img id="authorization_sign_lessee_name_image_for_subletting_view" style="width: 250px; height: 250px; border: 2px solid blue;">
                                        </div>
                                        </div>

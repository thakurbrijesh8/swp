                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control select2" id="plot_no_for_subletting_data" name="plot_no_for_subletting_data"
                                        data-placeholder="Select Plot No." onchange="checkValidation('subletting', 'plot_no_for_subletting_data', plotnoValidationMessage);
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="govt_industrial_estate_area" name="govt_industrial_estate_area" class="form-control" placeholder="Enter admeasuring in square meter!"  maxlength="100" value="{{subletting_data.govt_industrial_estate_area}}" readonly="">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="admeasuring" name="admeasuring" class="form-control" placeholder=" Enter Government Industrial Estate!" maxlength="100" value="{{subletting_data.admeasuring}}" onblur="checkValidation('subletting', 'admeasuring', admeasuringValidationMessage);">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" request_letter_div" style="display: none;">
                            <div class="form-group col-sm-12" id="request_letter_premises_container_for_subletting">
                                <label>12.1 Request letter of sub-let premises.<span style="color: red;"><br> (Maximum File Size: 2MB) &nbsp; (Upload pdf Only)</span></label><br>
                                <input type="file" id="request_letter_premises_for_subletting" name="request_letter_premises_for_subletting"
                                       accept="application/pdf" class="spinner_container_for_subletting_{{VALUE_ONE}}" onchange="Subletting.listview.uploadDocumentForSubletting(VALUE_ONE);">
                            ...
                            <div class="form-group col-sm-12" id="request_letter_premises_name_container_for_subletting" style="display: none;">
                                <label>12.1 Request letter of sub-let premises.<span style="color: red;"><br>(Maximum File Size: 2MB)(Upload pdf Only) <span style="color: red;"></span></label><br>
                                <a id="request_letter_premises_download" target="_blank"><label id="request_letter_premises_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_subletting_{{VALUE_ONE}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="request_letter_premises_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_ONE}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_ONE);">
                    ...
                    <div class="row">
                        ...
                        <div class=" original_extract_div" style="display: none;">
                            <div class="form-group col-sm-12" id="original_extract_certificate_container_for_subletting">
                                <label>13.1 Original 7 X 12 extract. <span style="color: red;"><br> (Maximum File Size: 2MB)  &nbsp; (Upload pdf Only)</span></label><br>
                                <input type="file" id="original_extract_certificate_for_subletting" name="original_extract_certificate_for_subletting"
                                       accept="application/pdf" class="spinner_container_for_subletting_{{VALUE_TWO}}" onchange="Subletting.listview.uploadDocumentForSubletting(VALUE_TWO);">
                            ...
                            <div class="form-group col-sm-12" id="original_extract_certificate_name_container_for_subletting" style="display: none;">
                                <label>13.1 Original 7 X 12 extract.  <span style="color: red;"><br>(Maximum File Size: 2MB)(Upload pdf Only) <span style="color: red;"></span></label><br>
                                <a id="original_extract_certificate_download" target="_blank"><label id="original_extract_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_subletting_{{VALUE_TWO}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="original_extract_certificate_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_TWO}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_TWO);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="radio" id="land_revenue_yes" name="land_revenue"  value="{{IS_CHECKED_YES}}"> Yes &emsp; 
                            <input type="radio" id="land_revenue_no" name="land_revenue"  value="{{IS_CHECKED_NO}}">  No &emsp;
                        ...
                        <div class=" land_revenue_div" style="display: none;">
                            <div class="form-group col-sm-12" id="land_revenue_certificate_container_for_subletting">
                                <label>14.1 No Due Certificate regarding land revenue.<span style="color: red;"><br> (Maximum File Size: 2MB)&nbsp; (Upload pdf Only)</span></label><br>
                                <input type="file" id="land_revenue_certificate_for_subletting" name="land_revenue_certificate_for_subletting"
                                       accept="application/pdf" class="spinner_container_for_subletting_{{VALUE_THREE}}" onchange="Subletting.listview.uploadDocumentForSubletting(VALUE_THREE);">
                            ...
                            <div class="form-group col-sm-12" id="land_revenue_certificate_name_container_for_subletting" style="display: none;">
                                <label>14.1 No Due Certificate regarding land revenue. <span style="color: red;"><br>(Maximum File Size: 2MB)(Upload pdf Only) <span style="color: red;"></span></label><br>
                                <a id="land_revenue_certificate_download" target="_blank"><label id="land_revenue_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_subletting_{{VALUE_THREE}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="land_revenue_certificate_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_THREE}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_THREE);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" electricity_bill_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="electricity_bill_certificate_name_container_for_subletting" style="display: none;">
                                <label>15.1 No Due Certificate from Electricity Department.  <span style="color: red;"><br>(Maximum File Size: 2MB)(Upload pdf Only) <span style="color: red;"></span></label><br>
                                <a id="electricity_bill_certificate_download" target="_blank"><label id="electricity_bill_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_subletting_{{VALUE_FOUR}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="electricity_bill_certificate_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_FOUR}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_FOUR);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" bank_loan_div" style="display: none;">
                            <div class="form-group col-sm-12" id="bank_loan_certificate_container_for_subletting">
                                <label>16.1 No Dues Certificate from Banks regarding loan.<span style="color: red;"><br> (Maximum File Size: 2MB) &nbsp; (Upload pdf Only)</span></label><br>
                                <input type="file" id="bank_loan_certificate_for_subletting" name="bank_loan_certificate_for_subletting"
                                       accept="application/pdf" class="spinner_container_for_subletting_{{VALUE_FIVE}}" onchange="Subletting.listview.uploadDocumentForSubletting(VALUE_FIVE);">
                            ...
                            <div class="form-group col-sm-12" id="bank_loan_certificate_name_container_for_subletting" style="display: none;">
                                <label>16.1 No Dues Certificate from Banks regarding loan. <span style="color: red;"><br>(Maximum File Size: 2MB)(Upload pdf Only) <span style="color: red;"></span></label><br>
                                <a id="bank_loan_certificate_download" target="_blank"><label id="bank_loan_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_subletting_{{VALUE_FIVE}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="bank_loan_certificate_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_FIVE}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_FIVE);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" panchayat_tax_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="panchayat_tax_certificate_name_container_for_subletting" style="display: none;">
                                <label>17.1 No Dues Certificate from group Gram Panchayat regarding panchayat tax.. <span style="color: red;"><br>(Maximum File Size: 2MB)(Upload pdf Only) <span style="color: red;"></span></label><br>
                                <a id="panchayat_tax_certificate_download" target="_blank"><label id="panchayat_tax_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_subletting_{{VALUE_SIX}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="panchayat_tax_certificate_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_SIX}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_SIX);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" challan_of_lease_div" style="display: none;">
                            <div class="form-group col-sm-12" id="challan_of_lease_rent_container_for_subletting">
                                <label>18.1 Challan of lease. <span style="color: red;"><br> (Maximum File Size: 2MB) &nbsp; (Upload pdf Only)</span></label><br>
                                <input type="file" id="challan_of_lease_rent_for_subletting" name="challan_of_lease_rent_for_subletting"
                                       accept="application/pdf" class="spinner_container_for_subletting_{{VALUE_SEVEN}}" onchange="Subletting.listview.uploadDocumentForSubletting(VALUE_SEVEN);">
                            ...
                            <div class="form-group col-sm-12" id="challan_of_lease_rent_name_container_for_subletting" style="display: none;">
                                <label>18.1 Challan of lease.  <span style="color: red;"><br>(Maximum File Size: 2MB)(Upload pdf Only) <span style="color: red;"></span></label><br>
                                <a id="challan_of_lease_rent_download" target="_blank"><label id="challan_of_lease_rent_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_subletting_{{VALUE_SEVEN}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="challan_of_lease_rent_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_SEVEN}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_SEVEN);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" occupancy_div" style="display: none;">
                            <div class="form-group col-sm-12" id="occupancy_certificate_container_for_subletting">
                                <label>19.1  Occupancy Certificate.<span style="color: red;"><br> (Maximum File Size: 2MB)  &nbsp; (Upload pdf Only)</span></label><br>
                                <input type="file" id="occupancy_certificate_for_subletting" name="occupancy_certificate_for_subletting"
                                       accept="application/pdf" class="spinner_container_for_subletting_{{VALUE_EIGHT}}" onchange="Subletting.listview.uploadDocumentForSubletting(VALUE_EIGHT);">
                            ...
                            <div class="form-group col-sm-12" id="occupancy_certificate_name_container_for_subletting" style="display: none;">
                                <label>19.1  Occupancy Certificate. <span style="color: red;"><br>(Maximum File Size: 2MB)(Upload pdf Only) <span style="color: red;"></span></label><br>
                                <a id="occupancy_certificate_download" target="_blank"><label id="occupancy_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_subletting_{{VALUE_EIGHT}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="occupancy_certificate_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_EIGHT}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_EIGHT);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" central_excise_div" style="display: none;">
                            <div class="form-group col-sm-12" id="central_excise_certificate_container_for_subletting">
                                <label>20.1 No Due Certificate from Central Excise.<span style="color: red;"><br> (Maximum File Size: 2MB)&nbsp; (Upload pdf Only)</span></label><br>
                                <input type="file" id="central_excise_certificate_for_subletting" name="central_excise_certificate_for_subletting"
                                       accept="application/pdf" class="spinner_container_for_subletting_{{VALUE_NINE}}" onchange="Subletting.listview.uploadDocumentForSubletting(VALUE_NINE);">
                            ...
                            <div class="form-group col-sm-12" id="central_excise_certificate_name_container_for_subletting" style="display: none;">
                                <label>20.1 No Due Certificate from Central Excise. <span style="color: red;"><br>(Maximum File Size: 2MB)(Upload pdf Only) <span style="color: red;"></span></label><br>
                                <a id="central_excise_certificate_download" target="_blank"><label id="central_excise_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_subletting_{{VALUE_NINE}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="central_excise_certificate_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_NINE}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_NINE);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" authorization_sign_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="authorization_sign_lessee_name_container_for_subletting" style="display: none;">
                                ...
                                <a target="_blank" id="authorization_sign_lessee_download"><img id="authorization_sign_lessee_name_image_for_subletting" class="spinner_name_container_for_subletting_{{VALUE_TEN}}" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                                <button type="button" id="authorization_sign_lessee_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_TEN}}" style="vertical-align: top;"
                                        onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_TEN);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>     
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_subletting" style="display: none;">
                            ...
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_subletting" class="spinner_name_container_for_subletting_{{VALUE_ELEVEN}}" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                            <button type="button" id="seal_and_stamp_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_subletting_{{VALUE_ELEVEN}}" style="vertical-align: top;"
                                    onclick="Subletting.listview.askForRemove('{{subletting_data.subletting_id}}', VALUE_ELEVEN);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <hr class="m-b-1rem"> 

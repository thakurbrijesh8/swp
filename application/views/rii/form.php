            ...
            <form role="form" id="rii_form" name="rii_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_rii" class="btn btn-sm btn-success" onclick="RII.listview.askForSubmitRII({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>

<html>
    ...
    <body>
        ...
        <!-- <tr>
            ...
            <td class="third-column">
                // <a href ="<?php // echo base_url(); ?>documents/bocw/<?php // echo $bocw_data['form_one']; ?>" target="_blank"> View Document </a>
            </td>
            </td>
        </tr>
        <tr>
            ...
            <td class="third-column">
                // <a href ="<?php // echo base_url(); ?>documents/bocw/<?php // echo $bocw_data['workorder_copy']; ?>" target="_blank"> View Document </a>
            </td>
            </td>
        </tr>
        <tr>
            ...
            <td class="third-column">
                // <a href ="<?php // echo base_url(); ?>documents/bocw/<?php // echo $bocw_data['copy_of_challan']; ?>" target="_blank"> View Document </a>
            </td>
            </td>
        </tr> -->
    </table>
    ...
    <table style="margin-left: 475px;">
        <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/bocw/<?php echo $bocw_data['sign_of_principal_employee']; ?>" height="100px" width="100px"></td></tr>
    </table>

            ...
            <form role="form" id="boiler_manufacture_form" name="boiler_manufacture_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="copy_of_noc_container_for_boilermanufacture">
                            <label>13. Copy of NOC from Local authorities to undertake Manufacturing facility are to be enclosed.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-6" id="copy_of_noc_name_container_for_boilermanufacture" style="display: none;">
                            <label>13. Copy of NOC from Local authorities to undertake Manufacturing facility are to be enclosed.</label><br>
                            <a id="copy_of_noc_download" target="_blank"><label id="copy_of_noc_name_image_for_boilermanufacture" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="plan_of_workshop_container_for_boilermanufacture">
                            <label>15. plan of workshop showing the location of machines,Fabrication equipments, NDT equipments covering All the space area.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-6" id="plan_of_workshop_name_container_for_boilermanufacture" style="display: none;">
                            <label>15. plan of workshop showing the location of machines,Fabrication equipments, NDT equipments covering All the space area.</label><br>
                            <a id="plan_of_workshop_download" target="_blank"><label id="plan_of_workshop_name_image_for_boilermanufacture" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="occupancy_certificate_copy_container_for_boilermanufacture">
                            <label>19.  A Copy of Occupancy Certificate.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="occupancy_certificate_copy_name_container_for_boilermanufacture" style="display: none;">
                            <label>19.  A Copy of Occupancy Certificate.</label><br>
                            <a id="occupancy_certificate_copy_download" target="_blank"><label id="occupancy_certificate_copy_name_image_for_boilermanufacture" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="factory_license_copy_container_for_boilermanufacture">
                            <label>20.  A Copy of Factory License.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="factory_license_copy_name_container_for_boilermanufacture" style="display: none;">
                            <label>20.  A Copy of Factory License.</label><br>
                            <a id="factory_license_copy_download" target="_blank"><label id="factory_license_copy_name_image_for_boilermanufacture" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="machinery_layout_copy_container_for_boilermanufacture">
                            <label>21.  Copy of Plan of Machinery layout along with the list of equipment & machinery, tools & tackles and NDT facilities.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="machinery_layout_copy_name_container_for_boilermanufacture" style="display: none;">
                            <label>21.  Copy of Plan of Machinery layout along with the list of equipment & machinery, tools & tackles and NDT facilities.</label><br>
                            <a id="machinery_layout_copy_download" target="_blank"><label id="machinery_layout_copy_name_image_for_boilermanufacture" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="qualification_detail_container_for_boilermanufacture">
                            <label>22.  Details of a qualification & experience of personnel employed (Certificates of welders are to be enclosed).</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="qualification_detail_name_container_for_boilermanufacture" style="display: none;">
                            <label>22.  Details of a qualification & experience of personnel employed (Certificates of welders are to be enclosed).</label><br>
                            <a id="qualification_detail_download" target="_blank"><label id="qualification_detail_name_image_for_boilermanufacture" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="shop_photograph_copy_container_for_boilermanufacture">
                            <label>23.  Few photographs of shop floor showing equipment, machinery and NDT facilities.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="shop_photograph_copy_name_container_for_boilermanufacture" style="display: none;">
                            <label>23.  Few photographs of shop floor showing equipment, machinery and NDT facilities.</label><br>
                            <a id="shop_photograph_copy_download" target="_blank"><label id="shop_photograph_copy_name_image_for_boilermanufacture" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 m-b-5px" id="signature_and_seal_container_for_boilermanufacture">
                            <label>24. Signature & Seal.</span></label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>
                        <div class="form-group col-sm-12" id="signature_and_seal_name_container_for_boilermanufacture" style="display: none;">
                            <label>24. Signature & Seal.</label><br>
                            <a id="signature_and_seal_download" target="_blank"><img id="signature_and_seal_name_image_for_boilermanufacture" style="width: 250px; height: 250px; border: 2px solid black;"></a>
                        </div>
                    </div>

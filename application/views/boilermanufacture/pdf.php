<html>
    ...
    <table style="margin-left: 475px;">
        <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/boilermanufactures/<?php echo $boilermanufactures_data['signature_and_seal']; ?>" height="100px" width="100px"></td></tr>
    </table>

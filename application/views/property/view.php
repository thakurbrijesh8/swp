       ...
       <div class="row">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="pan_card_name_container_for_property" style="display: none;">
                            ...
                            <a target="_blank" id="pan_card_download"><img id="pan_card_name_image_for_property" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>                       
                </div>
            </div>
                 ...
                 <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="aadhaar_card_name_container_for_property" style="display: none;">
                            ...
                            <a target="_blank" id="aadhaar_card_download"><img id="aadhaar_card_name_image_for_property" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>

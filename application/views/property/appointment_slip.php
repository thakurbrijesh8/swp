<div class="card-header" >
   ...
   <!--  <h3 class="card-title" style="float: none; text-align: center;">Appointment Detail</h3> -->
</div>
  <form role="form" id="appointment_slip" name="appointment_slip" onsubmit="return false;" style="font-size: 14px;">
    ...
    <div class="card-body p-b-0px text-left" id='DivIdToPrint'>
      <h3 class="card-title" style="float: none; text-align: center;">Appointment Slip</h3>
        ...
        <div class="form-group">
             <button type="button" class="btn btn-sm btn-danger" value='Print'  onclick='printDiv();'>Print</button>
        </div>

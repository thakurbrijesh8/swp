                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="workorder_copy_name_container_for_bocw" style="display: none;">
                            <label>11.  Attach a copy of work order. <span style="color: red;">*<br> (Maximum File Size: 1MB)(Upload pdf Only) </span></label><br>
                            <a id="workorder_copy_name_download" target="_blank" ><label id="workorder_copy_name_image_for_bocw" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">

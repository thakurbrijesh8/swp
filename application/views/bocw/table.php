<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="BOCW.listview.newBOCWForm(false, {});">Apply for New Registration / Renewal</button>
        </h3>
    </div>
            ...
            <table id="bocw_datatable" class="table table-bordered table-hover">
                <thead>
                    <tr class="bg-light-gray">
                        ...
                        <th class="text-center" style="width: 165px;">Establishment Name & Location</th>

<div class="text-center">
    ...
    {{/if}}
    <button type="button" class="btn btn-sm btn-nic-blue" onclick="Seller.listview.editOrViewSeller($(this),'{{seller_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    {{/if}}
    {{#if show_query_btn}}
    <button type="button" class="btn btn-sm btn-warning" id="query_btn_for_seller_id_{{seller_id}}" onclick="Seller.listview.getQueryData('{{seller_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">

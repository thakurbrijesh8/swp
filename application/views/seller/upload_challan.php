    ...
    <div class="card-body p-b-0px text-left">
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                ...
                <div id="user_payment_type_container_for_seller_upload_challan"></div>
                <span class="error-message error-message-seller-uc-user_payment_type_for_seller_upload_challan"></span>
            </div>
        </div>
        {{/if}}
        <div class="row" id="uc_container_for_seller_upload_challan" style="{{style}}">

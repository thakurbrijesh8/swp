<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="HotelRenewal.listview.newHotelRenewalForm(false, {});">
                <i class="fas fa-plus"></i>&nbsp; Apply for License for Hotel - Renewal
            </button>
        </h3>
    </div>

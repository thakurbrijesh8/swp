            ...
            <form role="form" id="hotel_renewal_form" name="hotel_renewal_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_hotelrenewal" class="btn btn-sm btn-nic-blue" onclick="HotelRenewal.listview.submitHotelRenewal({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>

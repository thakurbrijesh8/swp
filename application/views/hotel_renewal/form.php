                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_number" name="registration_number" class="form-control" placeholder="Enter Hotel's License Number !"
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="noc_fire_container_for_hotelrenewal">
                            <!--<label>18. N.O.C. issued by Station Fire Officer, Daman. <span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>-->
                            <label>9. Upload Fire NOC. <span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="noc_fire_for_hotelrenewal" name="noc_fire_for_hotelrenewal"
                                   accept="application/pdf" class="spinner_container_for_hotelrenewal_{{VALUE_ONE}}" onchange="HotelRenewal.listview.uploadDocumentForHotelRenewal(VALUE_ONE);">
                        ...
                        <div class="form-group col-sm-12" id="noc_fire_name_container_for_hotelrenewal" style="display: none;">
                            ...
                            <a target="_blank" id="noc_fire_download"><label id="noc_fire_name_image_for_hotelrenewal" style="border: 2px solid black;" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_hotelrenewal_{{VALUE_ONE}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            <button type="button" id="noc_fire_remove_btn"  class="btn btn-sm btn-danger spinner_name_container_for_hotelrenewal_{{VALUE_ONE}}" style="vertical-align: top;"
                                    onclick="HotelRenewal.listview.askForRemove('{{hotelrenewal_data.hotel_renewal_id}}', VALUE_ONE);">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_hotelrenewal">
                            ...
                            <input type="file" id="seal_and_stamp_for_hotelrenewal" name="seal_and_stamp_for_hotelrenewal" class="spinner_container_for_hotelrenewal_{{VALUE_TWO}}"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif" onchange="HotelRenewal.listview.uploadDocumentForHotelRenewal(VALUE_TWO);">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_hotelrenewal" style="display: none;">
                            ...
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_hotelrenewal" style="width: 250px; height: 250px; border: 2px solid blue;" class="spinner_name_container_for_hotelrenewal_{{VALUE_TWO}}"></a>
                            <button type="button" id="seal_and_stamp_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_hotelrenewal_{{VALUE_TWO}}" style="vertical-align: top;"
                                    onclick="HotelRenewal.listview.askForRemove('{{hotelrenewal_data.hotel_renewal_id}}', VALUE_TWO);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_hotelrenewal" class="btn btn-sm btn-nic-blue" onclick="HotelRenewal.listview.submitHotelRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>
                        <button type="button" id="submit_btn_for_hotelrenewal" class="btn btn-sm btn-success" onclick="HotelRenewal.listview.askForSubmitHotelRenewal({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

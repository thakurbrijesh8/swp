        ...
        <div class="card">
            ...
            <form role="form" id="factory_license_form" name="factory_license_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="form_two_copy_container_for_factorylicense">
                            <label>21.  Form II along with the paid challans.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="form_two_copy_name_container_for_factorylicense" style="display: none;">
                            <label>21.  Form II along with the paid challans.</label><br>
                            <a id="form_two_copy_download" target="_blank"><label id="form_two_copy_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="occupancy_certificate_container_for_factorylicense">
                            <label>22. Occupancy Certificate.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="occupancy_certificate_name_container_for_factorylicense" style="display: none;">
                            <label>22. Occupancy Certificate.</label><br>
                            <a id="occupancy_certificate_download" target="_blank"><label id="occupancy_certificate_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="stability_certificate_container_for_factorylicense">
                            <label>23. Certificate regarding stability of the structure form a qualified structural engineer.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="stability_certificate_name_container_for_factorylicense" style="display: none;">
                            <label>23. Certificate regarding stability of the structure form a qualified structural engineer.</label><br>
                            <a id="stability_certificate_download" target="_blank"><label id="stability_certificate_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="safety_equipments_list_container_for_factorylicense">
                            <label>24. List of safety equipments / precautionary measures taken on site.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="safety_equipments_list_name_container_for_factorylicense" style="display: none;">
                            <label>24. List of safety equipments / precautionary measures taken on site.</label><br>
                            <a id="safety_equipments_list_download" target="_blank"><label id="safety_equipments_list_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="machinery_layout_container_for_factorylicense">
                            <label>25.  Machinery layout drawing architect approved.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="machinery_layout_name_container_for_factorylicense" style="display: none;">
                            <label>25.  Machinery layout drawing architect approved.</label><br>
                            <a id="machinery_layout_download" target="_blank"><label id="machinery_layout_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="approved_plan_copy_container_for_factorylicense">
                            <label>26. A copy of the approved plan.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="approved_plan_copy_name_container_for_factorylicense" style="display: none;">
                            <label>26. A copy of the approved plan.</label><br>
                            <a id="approved_plan_copy_download" target="_blank"><label id="approved_plan_copy_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="safety_provision_container_for_factorylicense">
                            <label>27. Provisions of Health, Safety and Welfare under the Factory Act, 1948.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="safety_provision_name_container_for_factorylicense" style="display: none;">
                            <label>27. Provisions of Health, Safety and Welfare under the Factory Act, 1948.</label><br>
                            <a id="safety_provision_download" target="_blank"><label id="safety_provision_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                   <div class="row">
                        <div class="form-group col-sm-12" id="copy_of_site_plans_container_for_factorylicense">
                            <label>28. A copy of ON SITE/OFF SITE PLANS if applicable/ signed statement on company’s letterhead that it is not applicable.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="copy_of_site_plans_name_container_for_factorylicense" style="display: none;">
                            <label>28. A copy of ON SITE/OFF SITE PLANS if applicable/ signed statement on company’s letterhead that it is not applicable.</label><br>
                            <a id="copy_of_site_plans_download" target="_blank"><label id="copy_of_site_plans_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="plan_approval_container_for_factorylicense">
                            <label>29. Approval of the plans from the Chief Controller of Explosives, Nagpur in respect of the storage of Petroleum and Hazardous substances, if applicable /signed statement on company’s letterhead that it is not applicable.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="plan_approval_name_container_for_factorylicense" style="display: none;">
                            <label>29. Approval of the plans from the Chief Controller of Explosives, Nagpur in respect of the storage of Petroleum and Hazardous substances, if applicable /signed statement on company’s letterhead that it is not applicable.</label><br>
                            <a id="plan_approval_download" target="_blank"><label id="plan_approval_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="self_certificate_container_for_factorylicense">
                            <label>30. Self Certification by the Management whether the premises is Owned/Leased.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="self_certificate_name_container_for_factorylicense" style="display: none;">
                            <label>30. Self Certification by the Management whether the premises is Owned/Leased.</label><br>
                            <a id="self_certificate_download" target="_blank"><label id="self_certificate_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="project_report_container_for_factorylicense">
                            <label>31. Project Report (including flow chart) (Signed).</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="project_report_name_container_for_factorylicense" style="display: none;">
                            <label>31. Project Report (including flow chart) (Signed).</label><br>
                            <a id="project_report_download" target="_blank"><label id="project_report_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="land_document_copy_container_for_factorylicense">
                            <label>32. Copy of land document (Form I & XIV).</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="land_document_copy_name_container_for_factorylicense" style="display: none;">
                            <label>32. Copy of land document (Form I & XIV).</label><br>
                            <a id="land_document_copy_download" target="_blank"><label id="land_document_copy_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="ssi_registration_copy_container_for_factorylicense">
                            <label>33. A Copy of SSI Registration/Industrial Licence /In principle clearance in case of MSI/LSL.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="ssi_registration_copy_name_container_for_factorylicense" style="display: none;">
                            <label>33. A Copy of SSI Registration/Industrial Licence /In principle clearance in case of MSI/LSL.</label><br>
                            <a id="ssi_registration_copy_download" target="_blank"><label id="ssi_registration_copy_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>

                    <div class="row">
                        <div class="form-group col-sm-12" id="detail_of_etp_container_for_factorylicense">
                            <label>34.  Details of ETP, if any, (On company letterhead and signed).</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="detail_of_etp_name_container_for_factorylicense" style="display: none;">
                            <label>34.  Details of ETP, if any, (On company letterhead and signed).</label><br>
                            <a id="detail_of_etp_download" target="_blank"><label id="detail_of_etp_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="questionnaire_copy_container_for_factorylicense">
                            <label>35.  A copy of Questionnaire duly filled and signed by the Manager and the Occupier.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="questionnaire_copy_name_container_for_factorylicense" style="display: none;">
                            <label>35.  A copy of Questionnaire duly filled and signed by the Manager and the Occupier.</label><br>
                            <a id="questionnaire_copy_download" target="_blank"><label id="questionnaire_copy_name_image_for_factorylicense" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_factorylicense">
                            <label>36. Signature of Occupier. </span></label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_factorylicense" style="display: none;">
                            ...
                            <a id="seal_and_stamp_download" target="_blank"><img id="seal_and_stamp_name_image_for_factorylicense" style="width: 250px; height: 250px; border: 2px solid black;"></a>
                        </div>
                    </div>

<html>
    ...
    <table style="margin-left: 475px;">
        <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/factorylicense/<?php echo $factorylicense_data['sign_of_occupier']; ?>" height="100px" width="100px"></td></tr>
    </table>

    ...
    <body>
        ...
        <table class="CompanyDetails">
            ...
            <tr>
                ...
                <td class="third-column">
                   <a href ="<?php echo base_url(); ?>documents/dealer/<?php echo $dealer_renewal_data['import_model']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <!-- <tr>
                <td class="first-column" style="height: 30px;">9</td>
                ...
                <td class="third-column">
                    <?php //echo $dealer_renewal_data['any_previous_application']; ?><br/>
                    <?php //echo $dealer_renewal_data['license_application_date']; ?><br/>
                    <?php //echo $dealer_renewal_data['license_application_result']; ?>
                </td>
            </tr> -->
        </table>
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/dealer/<?php echo $dealer_renewal_data['signature']; ?>" height="100px" width="100px"></td></tr>
        </table>

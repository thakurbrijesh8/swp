            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-left">
                        ...
                        <li class="breadcrumb-item">Legal Metrology (Weights & Measures)</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title text-left pb-0">
                    <h2 class="text-grad">Department of Legal Metrology (Weights & Measures)</h2>
                    ...
                    <h6 class="lh-15 text-grad" style="font-size: 20px;">Registration Licenses under the Legal Metrology Act, 2009</h6>
                </div>
            </div>
        </div>

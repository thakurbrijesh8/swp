        ...
        <div class="card">
            ...
            <form role="form" id="boiler_act_renewal_form" name="boiler_act_renewal_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="company_letter_head_container_for_boileract_renewal">
                        ...
                        <div class="form-group col-sm-12" id="company_letter_head_name_container_for_boileract_renewal" style="display: none;">
                            <label>20.  Application on Company Letter head.</label><br>
                            <a id="company_letter_head_download" target="_blank"><label id="company_letter_head_name_image_for_boileract_renewal" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="copy_of_challan_container_for_boileract_renewal">
                        ...
                        <div class="form-group col-sm-12" id="copy_of_challan_name_container_for_boileract_renewal" style="display: none;">
                            <label>21.  Fees as per the schedule.</label><br>
                            <a id="copy_of_challan_download" target="_blank"><label id="copy_of_challan_name_image_for_boileract_renewal" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                   
                    <div class="row">
                        <div class="form-group col-sm-12" id="last_boiler_license_container_for_boileract_renewal">
                        ...
                        <div class="form-group col-sm-12" id="last_boiler_license_name_container_for_boileract_renewal" style="display: none;">
                            <label>22.  A copy of last Boiler License</label><br>
                            <a id="last_boiler_license_download" target="_blank"><label id="last_boiler_license_name_image_for_boileract_renewal" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="sign_of_applicant_name_container_for_boileract_renewal" style="display: none;">
                            ...
                            <a id="sign_of_applicant_download" target="_blank"><img id="sign_of_applicant_name_image_for_boileract_renewal" style="width: 250px; height: 250px; border: 2px solid black;"></a>
                        </div>
                    </div>

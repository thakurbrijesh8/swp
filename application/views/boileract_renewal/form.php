...
<!--                     <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_bolier" class="btn btn-sm btn-nic-blue" onclick="BoilerActRenewal.listview.submitBoilerActRenewal({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>
                        <button type="button" id="submit_btn_for_boiler" class="btn btn-sm btn-success" onclick="BoilerActRenewal.listview.askForBoilerActRenewal({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>

<html>
    ...
    <body>
            ...
            <tr>
                ...
                <td class="third-column">
                    ...
                    <?php if($msme_data['is_women_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/msme/<?php echo $msme_data['women_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?><br/>

                    <?php echo $msme_data['is_sc_st_entrepreneur'] == 1 ? 'SC/ST' : ''; ?>

                    <?php if($msme_data['is_sc_st_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/msme/<?php echo $msme_data['sc_st_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?><br/>

                    <?php echo $msme_data['is_physically_entrepreneur'] == 1 ? 'Physically Disabled' : ''; ?>

                    <?php if($msme_data['is_physically_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/msme/<?php echo $msme_data['physically_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?><br/>

                    <?php echo $msme_data['is_transgender_entrepreneur'] == 1 ? 'Transgender' : ''; ?>

                    <?php if($msme_data['is_transgender_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/msme/<?php echo $msme_data['transgender_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?><br/>

                    <?php echo $msme_data['is_other_entrepreneur'] == 1 ? 'Others' : ''; ?>

                    <?php if($msme_data['is_other_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/msme/<?php echo $msme_data['other_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="third-column">
                    ...
                    <?php if($msme_data['financial_assistance'] == 1){ ?>
                        <a href ="<?php echo base_url(); ?>documents/msme/<?php echo $msme_data['financial_assistance_upload']; ?>" target="_blank"> View Document </a>
                    <?php } ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    ...
                    <?php if($msme_data['govt_dues'] == 1){ ?>
                        <a href ="<?php echo base_url(); ?>documents/msme/<?php echo $msme_data['govt_dues_upload']; ?>" target="_blank"> View Document </a>
                    <?php } ?>
                </td>
            </tr>
            <tr>
        ...
        <br/>
         <table class="CompanyDetails">
            ...
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/msme/<?php echo $msme_data['audit_report']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column">3 </td>
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/msme/<?php echo $msme_data['sign_seal']; ?>" height="100px" width="100px"></td></tr>
        </table>

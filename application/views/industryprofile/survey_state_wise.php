<tr id="state_wise_pe_{{cnt}}" class="state_wise_pe">
    ...
    <td style="text-align: left !important;">
        ...
        <select id="state_for_survey_{{cnt}}" class="form-control"
                ...
                onchange="checkValidation('survey', 'state_for_survey_{{cnt}}', selectStateValidationMessage);">
    ...
    <td style="text-align: left !important;">
        <input type="text" id="skilled_others_pe_for_survey_{{cnt}}" class="form-control" placeholder="Skilled"
               onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{skilled}}" maxlength="5"/>
    </td>
    <td style="text-align: left !important;">
        <input type="text" id="semi_skilled_others_pe_for_survey_{{cnt}}" class="form-control" placeholder="Semi-Skilled"
               onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{semi_skilled}}" maxlength="5"/>
    </td>
    <td style="text-align: left !important;">
        <input type="text" id="unskilled_others_pe_for_survey_{{cnt}}" class="form-control" placeholder="Unskilled"
               onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{unskilled}}" maxlength="5"/>
    </td>
    <td style="width: 20px;">
        <button type="button" class="btn btn-xs btn-danger"
                onclick="IndustryProfile.listview.removePE('{{cnt}}');" style="cursor: pointer;">

                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="company_name_for_survey" name="company_name_for_survey" class="form-control" placeholder="Name of Enterprise / Unit" value="{{company_name}}" onblur="checkValidation('survey', 'company_name_for_survey', companyNameValidationMessage);"/>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="entrepreneur_name_for_survey" name="entrepreneur_name_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'entrepreneur_name_for_survey', entrepreneurNameValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <textarea id="company_address_for_survey" name="company_address_for_survey"
                                      ...
                                      onblur="checkValidation('survey', 'company_address_for_survey', companyAddressValidationMessage);"
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="estate_name_for_survey" name="estate_name_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'estate_name_for_survey', eStateNameValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="estate_details_for_survey" name="estate_details_for_survey" value="{{ESTATE_GOVERNMENT}}">
                                    Government
                                </label>
                                <label style="margin-right: 8px;">
                                    <input type="radio" name="estate_details_for_survey" value="{{ESTATE_PRIVATE}}">
                                    Private
                                </label>
                                <label>
                                    <input type="radio" name="estate_details_for_survey" value="{{ESTATE_OTHER}}">
                                    Other
                                </label>
                            </div>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="udyog_aadhar_memorandum_for_survey" name="udyog_aadhar_memorandum_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'udyog_aadhar_memorandum_for_survey', udyogAadharMemorandumValidationMessage);"
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="pan_number_for_survey" name="pan_number_for_survey"
                                   ...
                                   onblur="checkValidationForPAN('survey', 'pan_number_for_survey');"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <textarea id="official_address_for_survey" name="official_address_for_survey" class="form-control"
                                      onblur="checkValidation('survey', 'official_address_for_survey', officialAddressValidationMessage);"
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="authorized_person_name_for_survey" name="authorized_person_name_for_survey" class="form-control" placeholder="Name of Authorized Person" value="{{authorized_person_name}}" onblur="checkValidation('survey', 'authorized_person_name_for_survey', personNameValidationMessage);"/>
                        </div>
                        <div class="col-sm-4 form-group">
                            <label>Contact Number of Authorized Person <span style="color: red;">*</span></label>
                            <input type="text" id="authorized_person_contactno_for_survey" name="authorized_person_contactno_for_survey" class="form-control" placeholder="Contact Number of Authorized Person" value="{{authorized_person_contactno}}" onblur="checkValidationForMobileNumber('survey', 'authorized_person_contactno_for_survey', mobileValidationMessage);"/>
                        </div>
                        <div class="col-sm-4 form-group">
                            <label>E-Mail Id <span style="color: red;">*</span></label>
                            <input type="text" id="authorized_person_email_for_survey" name="authorized_person_email_for_survey" class="form-control" placeholder="E-Mail Id" value="{{authorized_person_email}}" onblur="checkValidationForEmail('survey', 'authorized_person_email_for_survey', emailValidationMessage);"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            <label>Type of Industry <span style="color: red;">*</span></label>
                            <select id="industry_type_for_survey" name="industry_type_for_survey" class="form-control"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="turnover_for_survey" name="turnover_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'turnover_for_survey', turnoverValidationMessage);"
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3    form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="major_activity_for_survey" name="major_activity_for_survey" value="{{VALUE_ONE}}">
                                    Manufacturing
                                </label>
                                <label>
                                    <input type="radio" name="major_activity_for_survey" value="{{VALUE_TWO}}">
                                    Service
                                </label>
                            </div>
                        ...
                        <div class="col-sm-4 col-md-3 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="nature_activity_for_survey" name="nature_activity_for_survey" value="{{VALUE_ONE}}">
                                    Perennial
                                </label>
                                <label>
                                    <input type="radio" name="nature_activity_for_survey" value="{{VALUE_TWO}}">
                                    Seasonal
                                </label>
                            </div>
                        ...
                        <div class="col-sm-4 col-md-3 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="social_category_for_survey" name="social_category_for_survey" value="{{CATEGORY_SC}}">
                                    SC
                                </label>
                                <label style="margin-right: 8px;">
                                    <input type="radio" name="social_category_for_survey" value="{{CATEGORY_ST}}">
                                    ST
                                </label>
                                <label style="margin-right: 8px;">
                                    <input type="radio" name="social_category_for_survey" value="{{CATEGORY_OBC}}">
                                    OBC
                                </label>
                                <label>
                                    <input type="radio" name="social_category_for_survey" value="{{CATEGORY_GENERAL}}">
                                    General
                                </label>
                            </div>
                        ...
                        <div class="col-sm-4 col-md-3 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="gender_for_survey" name="gender_for_survey" value="{{GENDER_MALE}}">
                                    Male
                                </label>
                                <label style="margin-right: 8px;">
                                    <input type="radio" name="gender_for_survey" value="{{GENDER_FEMALE}}">
                                    Female
                                </label>
                                <label>
                                    <input type="radio" name="gender_for_survey" value="{{GENDER_OTHER}}">
                                    Other
                                </label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="differently_abled_for_survey" name="differently_abled_for_survey" value="{{VALUE_ONE}}">
                                    Yes
                                </label>
                                <label>
                                    <input type="radio" name="differently_abled_for_survey" value="{{VALUE_TWO}}">
                                    No
                                </label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label class="col-xs-6 col-sm-3 col-md-4">
                                    <input type="radio" id="organization_type_for_survey" name="organization_type_for_survey"
                                           onclick="IndustryProfile.listview.orgTypeChangeEvent('{{O_PROPRIETARY}}');"
                                           value="{{O_PROPRIETARY}}">
                                    Proprietary
                                </label>
                                <label class="col-xs-6 col-sm-3 col-md-4">
                                    <input type="radio" name="organization_type_for_survey"
                        ...
                        <div class="col-sm-4 col-md-3 form-group" id="other_org_container" style="display: none;">
                            ...
                            <input type="text" id="other_organization_for_survey" name="other_organization_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'other_organization_for_survey', otherOrgValidationMessage);"
                        ...
                        <div class="col-sm-4 col-md-3 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="pcc_category_for_survey" name="pcc_category_for_survey" value="{{PCC_RED}}">
                                    Red
                                </label>
                                <label style="margin-right: 8px;">
                                    <input type="radio" name="pcc_category_for_survey" value="{{PCC_ORANGE}}">
                                    Green
                                </label>
                                <label style="margin-right: 8px;">
                                    <input type="radio" name="pcc_category_for_survey" value="{{PCC_GREEN}}">
                                    Orange
                                </label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="total_employment_for_survey" name="total_employment_for_survey"
                                   ...
                                   value="{{total_employment}}" maxlength="5"/>
                                        ...
                                        <tr>
                                            <td class="p-0px">
                                                <input type="text" id="skilled_employment_for_survey" name="skilled_employment_for_survey" class="form-control" placeholder="Skilled"
                                                       onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{skilled_employment}}" maxlength="5"/>
                                            </td>
                                            <td class="p-0px">
                                                <input type="text" id="semi_skilled_employment_for_survey" name="semi_skilled_employment_for_survey" class="form-control" placeholder="Semi-Skilled"
                                                       onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{semi_skilled_employment}}" maxlength="5"/>
                                            </td>
                                            <td class="p-0px">
                                                <input type="text" id="unskilled_employment_for_survey" name="unskilled_employment_for_survey" class="form-control" placeholder="Unskilled"
                                                       onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{unskilled_employment}}" maxlength="5"/>
                                            </td>
                                            <td class="p-0px">
                                                <input type="text" id="managerial_employment_for_survey" name="managerial_employment_for_survey" class="form-control" placeholder="Managerial"
                                                       onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{managerial_employment}}" maxlength="5"/>
                                            </td>
                                            <td class="p-0px">
                                                <input type="text" id="lcc_employment_for_survey" name="lcc_employment_for_survey" class="form-control" placeholder="Licenced Contractors / Contractors"
                                                       onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{lcc_employment}}" maxlength="5"/>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="emp_tlc_for_survey" name="emp_tlc_for_survey" value="{{VALUE_ONE}}">
                                    Yes
                                </label>
                                <label>
                                    <input type="radio" name="emp_tlc_for_survey" value="{{VALUE_TWO}}">
                                    No
                                </label>
                            </div>
                                        ...
                                        <tr>
                                            <td class="p-0px">
                                                <input type="text" id="skilled_local_pe_for_survey" name="skilled_local_pe_for_survey" class="form-control" placeholder="Skilled"
                                                       onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{skilled_local_pe}}" maxlength="5"/>
                                            </td>
                                            <td class="p-0px">
                                                <input type="text" id="semi_skilled_local_pe_for_survey" name="semi_skilled_local_pe_for_survey" class="form-control" placeholder="Semi-Skilled"
                                                       onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{semi_skilled_local_pe}}" maxlength="5"/>
                                            </td>
                                            <td class="p-0px">
                                                <input type="text" id="unskilled_local_pe_for_survey" name="unskilled_local_pe_for_survey" class="form-control" placeholder="Unskilled"
                                                       onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" value="{{unskilled_local_pe}}" maxlength="5"/>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-xs btn-success" id="add_btn_for_state_wise_pe"
                                    onclick="IndustryProfile.listview.addPE({});" style="margin-bottom: 10px;">
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="investment_for_survey" name="investment_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'investment_for_survey', amountValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="raw_material_for_survey" name="raw_material_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'raw_material_for_survey', rawMaterialValidationMessage);"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-xs btn-success" id="add_btn_for_ipc"
                                    onclick="IndustryProfile.listview.addIPC({});" style="margin-bottom: 10px;">
                                <label class="fa fa-plus label-btn-icon"></label>
                                &nbsp;<label class="label-btn-fonts">Add More</label>
                            </button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="major_product_for_survey" name="major_product_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'major_product_for_survey', majorProductValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <textarea id="industrial_process_for_survey" name="industrial_process_for_survey" class="form-control"
                                      onblur="checkValidation('survey', 'industrial_process_for_survey', industrialProductValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="past_year_turnover_for_survey" name="past_year_turnover_for_survey"
                                   class="form-control" placeholder="Major Product / Finished Goods"
                                   onblur="checkValidation('survey', 'past_year_turnover_for_survey', pastYearTurnOverValidationMessage);"
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="intial_production_year_for_survey" name="intial_production_year_for_survey"
                                   ...
                                   value="{{intial_production_year}}" maxlength="4"/>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="expansion_year_for_survey" name="expansion_year_for_survey"
                                   ...
                                   onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));"
                                   value="{{expansion_year}}" maxlength="4"/>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="proposed_expansion_year_for_survey" name="proposed_expansion_year_for_survey"
                                   ...
                                   onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));"
                                   value="{{proposed_expansion_year}}" maxlength="4"/>
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="skill_requirement_for_survey" name="skill_requirement_for_survey"
                                   ...
                                   value="{{skill_requirement}}" maxlength="100"/>
                                        ...
                                        <tr>
                                            <td class="p-0px">
                                                <input type="text" id="loan_outstanding_for_survey" name="loan_outstanding_for_survey"
                                                       class="form-control" placeholder="Loan Outstanding (Principal)"
                                            ...
                                            <td class="p-0px">
                                                <input type="text" id="foreign_direct_investment_for_survey" name="foreign_direct_investment_for_survey"
                                                       class="form-control" placeholder="Foreign Direct Investment / Equity."
                    ...
                    <div class="row">
                        <div class="col-sm-5 form-group">
                            ...
                            <input type="text" id="registered_number_for_survey" name="registered_number_for_survey"
                                   ...
                                   value="{{registered_number}}" maxlength="50"/>
                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="is_gstin_for_survey" name="is_gstin_for_survey"
                                           onclick="IndustryProfile.listview.isGSTINChangeEvent('{{VALUE_ONE}}')"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="is_gstin_for_survey"
                        ...
                        <div class="col-sm-4 form-group" id="gstin_number_container" style="display: none;">
                            ...
                            <input type="text" id="gstin_number_for_survey" name="gstin_number_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'gstin_number_for_survey', gstinNumberValidationMessage);"
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-2 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="social_distancing_for_survey" name="social_distancing_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="social_distancing_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-2 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="thermal_screening_for_survey" name="thermal_screening_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="thermal_screening_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-2 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="mask_availability_for_survey" name="mask_availability_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="mask_availability_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-2 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="face_shield_for_survey" name="face_shield_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="face_shield_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-4 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="washing_hands_for_survey" name="washing_hands_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="washing_hands_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="avoiding_water_for_survey" name="avoiding_water_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="avoiding_water_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="phsw_for_survey" name="phsw_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'phsw_for_survey', detailsValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="cleanliness_for_survey" name="cleanliness_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'cleanliness_for_survey', detailsValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="overcrowding_for_survey" name="overcrowding_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'overcrowding_for_survey', detailsValidationMessage);"
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="arrangements_for_survey" name="arrangements_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="arrangements_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="fire_saftey_measures_for_survey" name="fire_saftey_measures_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'fire_saftey_measures_for_survey', fireSafteyMeasuresValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="washing_facilities_for_survey" name="washing_facilities_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="washing_facilities_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="first_aid_appliances_for_survey" name="first_aid_appliances_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'first_aid_appliances_for_survey', firstAidAppliancesValidationMessage);"
                        ...
                        <div class="col-sm-2 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="workers_quarters_for_survey" name="workers_quarters_for_survey"
                                           onclick="IndustryProfile.listview.quartersNumberChangeEvent('{{VALUE_ONE}}');"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="workers_quarters_for_survey"
                        ...
                        <div class="col-sm-3 form-group" id="quarters_number_container" style="display: none;">
                            ...
                            <input type="text" id="quarters_number_for_survey" name="quarters_number_for_survey"
                                   ...
                                   value="{{quarters_number}}" maxlength="4"/>
                        ...
                        <div class="col-sm-3 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="canteen_for_survey" name="canteen_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="canteen_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <textarea id="commu_fiber_for_survey" name="commu_fiber_for_survey" class="form-control"
                                      onblur="checkValidation('survey', 'commu_fiber_for_survey', detailsValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="srl_for_survey" name="srl_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="srl_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="checkbox mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="checkbox" id="connectivity_for_survey" name="connectivity_for_survey"
                                           value="{{VALUE_ONE}}">Mobile Connectivity</label>
                                <label>
                                    <input type="checkbox" name="connectivity_for_survey"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="apprenticeship_for_survey" name="apprenticeship_for_survey"
                                   ...
                                   onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));"
                                   value="{{apprenticeship}}" maxlength="100"/>
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <textarea id="saftey_measures_for_survey" name="saftey_measures_for_survey" class="form-control"
                                      onblur="checkValidation('survey', 'saftey_measures_for_survey', safteyMeasuresValidationMessage);"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <textarea id="pollution_control_measures_for_survey" name="pollution_control_measures_for_survey" class="form-control"
                                      onblur="checkValidation('survey', 'pollution_control_measures_for_survey', pollutionControlValidationMessage);"
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <textarea id="air_pcm_for_survey" name="air_pcm_for_survey" class="form-control"
                                      onblur="checkValidation('survey', 'air_pcm_for_survey', detailsValidationMessage);"
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="wpit_for_survey" name="wpit_for_survey"
                                           value="{{VALUE_ONE}}">Yes</label>
                                <label>
                                    <input type="radio" name="wpit_for_survey"
                                           value="{{VALUE_TWO}}">No</label>
                            </div>
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="radio mb-none" style="margin-top: 0px !important;">
                                <label style="margin-right: 8px;">
                                    <input type="radio" id="unit_status_for_survey" name="unit_status_for_survey"
                                           value="{{VALUE_ONE}}">Functioning</label>
                                <label>
                                    <input type="radio" name="unit_status_for_survey"
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input type="text" id="tax_due_ppy_for_survey" name="tax_due_ppy_for_survey"
                                   ...
                                   onblur="checkValidation('survey', 'tax_due_ppy_for_survey', taxDuePPYValidationMessage);"

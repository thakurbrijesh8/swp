...
<!--                                <tr class="doc-for-all">
                    ...
                    <div>
                        <button type="button" id="draft_btn_for_msme" class="btn btn-sm btn-nic-blue" onclick="MSME.listview.submitMSME('{{VALUE_ONE}}');" style="margin-right: 5px;">Save As Draft</button>

    ...
    {{#if show_bd_div}}
        ...
        <div>
            {{#if show_plan_of_building_document}}
                <a target="_blank" href="documents/cinema/{{plan_of_building_document}}">
        ...
        <div class="row building_details_div" style="display: none">
            <div class="form-group col-sm-12">
                {{#if show_character_licence_certificate}}
                    <a target="_blank" href="documents/cinema/{{character_licence_certificate}}">
                        <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
                            <i class="fas fa-download"></i> &nbsp; II.Certificate of Chief of Police
                        </label>
                    </a>
                {{/if}}
            </div>
            <div class="form-group col-sm-12">
                {{#if show_photo_state_copy}}
                    <a target="_blank" href="documents/cinema/{{photo_state_copy}}">
                        <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
                            <i class="fas fa-download"></i> &nbsp; III.Photo State Copy
                        </label>
                    </a>
                {{/if}}
            </div>
            ...
            <div class="form-group col-sm-12">
                {{#if show_ownership_document}}
                    <a target="_blank" href="documents/cinema/{{ownership_document}}">
                        <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
                            <i class="fas fa-download"></i> &nbsp;IV. Ownership or Tenancy of The Place
                        </label>
                    </a>
                {{/if}}
            </div>
            <div class="form-group col-sm-12">
                {{#if show_motor_vehicles_document}}
                    <a target="_blank" href="documents/cinema/{{motor_vehicles_document}}">
                        <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
                            <i class="fas fa-download"></i> &nbsp; VI.Showing The Ownership or Tenancy
                        </label>
                    </a>
                {{/if}}
            </div>
    ...
    <div class="row" style="margin-top: 20px;">
        ...
        <div class="form-group col-sm-12">
            {{#if show_business_trade_authority_license}}
                <a target="_blank" href="documents/cinema/{{business_trade_authority_license}}">
                    <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
                        <i class="fas fa-download"></i> &nbsp; Trade or Business Has Been From The Competent
                    </label>
                </a>
            {{/if}}
        </div>

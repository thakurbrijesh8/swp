                ...
                <div class="card-body">
                    ...
                    <div class="row building_details_div" style="display: none">
                        <div class="form-group col-sm-12" id="plan_of_building_document_container">
                            ...
                            <input type="file" id="plan_of_building_document" name="plan_of_building_document"
                                   accept="application/pdf" class="spinner_container_for_cinema_{{VALUE_TWO}}" onchange="Cinema.listview.uploadDocumentForCinema(VALUE_TWO);">
                        ...
                        <div class="form-group col-sm-12" id="plan_of_building_document_name_container" style="display: none;">
                            <label>I. Please attach the site plan of the building as approved by the Mamlatdar in counsultation with Associate Town
                                Planner, and give the names, places  and distance by public road of the Proposed site to the nearest place of exhibition etc. Attached <span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span> </label><br>
                            <a id="plan_of_building_document_download" target="_blank"><lable id="plan_of_building_document_name_image" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_cinema_{{VALUE_TWO}}" style="border: 2px solid blue;">{{VIEW_UPLODED_DOCUMENT}}</lable></a>
                            <button type="button" id="plan_of_building_document_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_cinema_{{VALUE_TWO}}" style="vertical-align: top;"
                                    onclick="Cinema.listview.askForRemove('{{cinema_data.cinema_id}}', VALUE_TWO);">
                    ...
                    <div class="row building_details_div" style="display: none">
                        <div class="form-group col-sm-12" id="character_licence_certificate_container">
                            <label>II. Certificate of Chief of Police (regarding character of the license). <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="character_licence_certificate" name="character_licence_certificate"
                                   accept="application/pdf" class="spinner_container_for_cinema_{{VALUE_THREE}}" onchange="Cinema.listview.uploadDocumentForCinema(VALUE_THREE);">
                        ...
                        <div class="form-group col-sm-12" id="character_licence_certificate_name_container" style="display: none;">
                            <label>II. Certificate of Chief of Police (regarding character of the license).  <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span> </label><br>
                            <a id="character_licence_certificate_download" target="_blank"><lable id="character_licence_certificate_name_image" style="border: 2px solid blue;" class="spinner_name_container_for_cinema_{{VALUE_THREE}} btn btn-sm btn-nic-blue f-w-n">{{VIEW_UPLODED_DOCUMENT}}</lable></a>
                            <button type="button" id="character_licence_certificate_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_cinema_{{VALUE_THREE}}" style="vertical-align: top;"
                                    onclick="Cinema.listview.askForRemove('{{cinema_data.cinema_id}}', VALUE_THREE);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="row building_details_div" style="display: none">
                        <div class="form-group col-sm-12" id="photo_state_copy_container">
                            <label>III. Photo-state copy of license obtained for the commercial use video/television under the Indian Telegraph Act, 1885 (No. 13 of 1885). <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="photo_state_copy" name="photo_state_copy"
                                   accept="application/pdf" class="spinner_container_for_cinema_{{VALUE_FOUR}}" onchange="Cinema.listview.uploadDocumentForCinema(VALUE_FOUR);">
                        ...
                        <div class="form-group col-sm-12" id="photo_state_copy_name_container" style="display: none;">
                            <label>III. Photo-state copy of license obtained for the commercial use video/television under the Indian Telegraph Act, 1885 (No. 13 of 1885). <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                            <a id="photo_state_copy_download" target="_blank"><lable id="photo_state_copy_name_image" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_cinema_{{VALUE_FOUR}}" style="border: 2px solid blue;">{{VIEW_UPLODED_DOCUMENT}}</lable></a>
                            <button type="button" id="photo_state_copy_remove_btn" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Cinema.listview.askForRemove('{{cinema_data.cinema_id}}', VALUE_FOUR);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="row building_details_div" style="display: none">
                        <div class="form-group col-sm-12" id="ownership_document_container">
                            <label>IV. Documents showing the ownership or tenancy of the place <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="ownership_document" name="ownership_document"
                                   accept="application/pdf" class="spinner_container_for_cinema_{{VALUE_FIVE}}" onchange="Cinema.listview.uploadDocumentForCinema(VALUE_FIVE);">
                        ...
                        <div class="form-group col-sm-12" id="ownership_document_name_container" style="display: none;">
                            <label>IV. Documents showing the ownership or tenancy of the place <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                            <a id="ownership_document_download" target="_blank"><lable id="ownership_document_name_image" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_cinema_{{VALUE_FIVE}}" style="border: 2px solid blue;">{{VIEW_UPLODED_DOCUMENT}}</lable></a>
                            <button type="button" id="ownership_document_remove_btn" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Cinema.listview.askForRemove('{{cinema_data.cinema_id}}', VALUE_FIVE);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                        ...
                        <div class="form-group col-sm-12" id="motor_vehicles_document_container">
                            <label>V. In the case of omnibus used as a contract carriage, a photo-state copy of the documents of its registration under the motor Vehicles Act, 1939. <span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="motor_vehicles_document" name="motor_vehicles_document"
                                   accept="application/pdf" class="spinner_container_for_cinema_{{VALUE_SIX}}" onchange="Cinema.listview.uploadDocumentForCinema(VALUE_SIX);">
                        ...
                        <div class="form-group col-sm-12" id="motor_vehicles_document_name_container" style="display: none;">
                            <label>V. In the case of omnibus used as a contract carriage, a photo-state copy of the documents of its registration under the motor Vehicles Act, 1939. <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span> </label><br>
                            <a id="motor_vehicles_document_download" target="_blank"><lable id="motor_vehicles_document_name_image" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_cinema_{{VALUE_SIX}}" style="border: 2px solid blue;">{{VIEW_UPLODED_DOCUMENT}}</lable></a>
                            <button type="button" id="motor_vehicles_document_remove_btn" class="btn btn-sm btn-danger" style="vertical-align: top;"        
                                    onclick="Cinema.listview.askForRemove('{{cinema_data.cinema_id}}', VALUE_SIX);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="business_trade_authority_license_container">
                            <label>I. Has license for such trade or business has been from the competent authority. <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="business_trade_authority_license" name="business_trade_authority_license"
                                   accept="application/pdf" class="spinner_container_for_cinema_{{VALUE_SEVEN}}" onchange="Cinema.listview.uploadDocumentForCinema(VALUE_SEVEN);">
                        ...
                        <div class="form-group col-sm-12" id="business_trade_authority_license_name_container" style="display: none;">
                            <label>I. Has license for such trade or business has been from the competent authority. <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                            <a id="business_trade_authority_license_download" target="_blank"><lable id="business_trade_authority_license_name_image" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_cinema_{{VALUE_SEVEN}}" style="border: 2px solid blue;">{{VIEW_UPLODED_DOCUMENT}}</lable></a>
                            <button type="button" id="business_trade_authority_license_remove_btn" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Cinema.listview.askForRemove('{{cinema_data.cinema_id}}', VALUE_SEVEN);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_cinema">
                            <label>13. Signature <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <input type="file" id="seal_and_stamp_for_cinema" name="seal_and_stamp_for_cinema"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif" class="spinner_container_for_cinema_{{VALUE_EIGHT}}" onchange="Cinema.listview.uploadDocumentForCinema(VALUE_EIGHT);">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_cinema" style="display: none;">
                            <label>13. Principal Employer Seal & Stamp <span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_cinema" class="spinner_name_container_for_cinema_{{VALUE_EIGHT}}" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                            <button type="button" id="seal_and_stamp_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_cinema_{{VALUE_EIGHT}}" style="vertical-align: top;"
                                    onclick="Cinema.listview.askForRemove('{{cinema_data.cinema_id}}', VALUE_EIGHT);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_cinema" class="btn btn-sm btn-nic-blue f-w-n" onclick="Cinema.listview.submitCinema({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_cinema" class="btn btn-sm btn-success" onclick="Cinema.listview.askForSubmitCinema({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

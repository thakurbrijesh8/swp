            ...
            <form role="form" id="cinema_form" name="cinema_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_cinema" class="btn btn-sm btn-nic-blue f-w-n" onclick="Cinema.listview.submitCinema({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>

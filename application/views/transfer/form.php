                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="application_date" id="application_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{application_date}}" onblur="checkValidation('transfer', 'application_date', appDateValidationMessage);" readonly="">
                   ...
                   <div class="form-group col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="govt_industrial_estate_area" name="govt_industrial_estate_area" class="form-control" placeholder="Enter Admeasuring in square metre!"  maxlength="100" onblur="checkValidation('transfer', 'govt_industrial_estate_area', govtIndustrialEstateAreaValidationMessage);" value="{{transfer_data.govt_industrial_estate_area}}" readonly="">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="admeasuring_square_metre" name="admeasuring_square_metre" class="form-control" placeholder="Enter Government Industrial Estate!"  maxlength="100" onblur="checkValidation('transfer', 'admeasuring_square_metre', admeasuringValidationMessage);" value="{{transfer_data.admeasuring_square_metre}}">
                            </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_transfer" class="btn btn-sm btn-nic-blue" onclick="Transfer.listview.submitTransfer({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_transfer" class="btn btn-sm btn-success" onclick="Transfer.listview.askForSubmitTransfer({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

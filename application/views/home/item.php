<tr>
    ...
    <td class="text-center f-w-b f-s-16px cursor-pointer" onclick="Home.listview.changeRouter({{module_type}},{{district}},'{{VALUE_THREE}}');">{{all_fees_pending_app}}</td>
    <td class="text-center f-w-b f-s-16px cursor-pointer" onclick="Home.listview.changeRouter({{module_type}},{{district}},'{{VALUE_FOUR}}');">{{all_fees_paid_app}}</td>
    <td class="text-center f-w-b f-s-16px cursor-pointer" onclick="Home.listview.changeRouter({{module_type}},{{district}},'{{VALUE_EIGHT}}');">{{all_pay_at_office_app}}</td>
    <td class="text-center f-w-b f-s-16px cursor-pointer" onclick="Home.listview.changeRouter({{module_type}},{{district}},'{{VALUE_NINE}}');">{{all_fess_na_app}}</td>

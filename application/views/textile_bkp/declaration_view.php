            ...
            <form role="form" id="declaration_form" name="declaration_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="previous_btn_for_incentive_details" class="btn btn-sm btn-success pull-right" onclick="Textile.listview.editOrViewForms($('#previous_btn_for_parte_details'), '{{incentive_id}}', false, 'declaration_form');" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                    </div>
                </div>
            </form>
        </div>

                ...
                <div class="card-body">
                    ...
                    <div class="enterprise_accqu_div" style="display :none">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12" id="arrangement_uploader_name_container_for_textile" style="display: none;">
                                ...
                                <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                        onclick="Dealer.listview.askForRemove('{{incentive_id}}','arrangement_uploader','incentive_parth');">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12" id="mou_uploader_name_container_for_textile" style="display: none;">
                                ...
                                <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                        onclick="Dealer.listview.askForRemove('{{incentive_id}}','mou_uploader','incentive_parth');">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="loan_accountno" name="loan_accountno" class="form-control" placeholder="Enter Part i E.M. No. !" maxlength="100" onblur="checkValidation('incentive-parth', 'loan_accountno', loanAccountNoValidationMessage);" value="{{loan_accountno}}">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="project_profile_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Dealer.listview.askForRemove('{{incentive_id}}','project_profile_uploader','incentive_parth');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="details_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Dealer.listview.askForRemove('{{incentive_id}}','details_uploader','incentive_parth');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="investment_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Dealer.listview.askForRemove('{{incentive_id}}','investment_uploader','incentive_parth');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="annual_production_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Dealer.listview.askForRemove('{{incentive_id}}','annual_production_uploader','incentive_parth');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="power_consumption_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Dealer.listview.askForRemove('{{incentive_id}}','power_consumption_uploader','incentive_parth');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="impact_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Dealer.listview.askForRemove('{{incentive_id}}','impact_uploader','incentive_parth');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>

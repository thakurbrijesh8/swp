<html>
    ...
    <body>
            ...
            <tr>
                ...
                <td class="third-column">
                    ...
                    <?php if($textile_data['is_women_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_data['women_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?><br/>

                    <?php echo $textile_data['is_sc_st_entrepreneur'] == 1 ? 'SC/ST' : ''; ?>

                    <?php if($textile_data['is_sc_st_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_data['sc_st_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?><br/>

                    <?php echo $textile_data['is_physically_entrepreneur'] == 1 ? 'Physically Disabled' : ''; ?>

                    <?php if($textile_data['is_physically_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_data['physically_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?><br/>

                    <?php echo $textile_data['is_transgender_entrepreneur'] == 1 ? 'Transgender' : ''; ?>

                    <?php if($textile_data['is_transgender_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_data['transgender_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?><br/>

                    <?php echo $textile_data['is_other_entrepreneur'] == 1 ? 'Others' : ''; ?>

                    <?php if($textile_data['is_other_entrepreneur'] == 1){ ?>
                        <br/><a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_data['other_entrepreneur']; ?>" target="_blank"> View Document </a>
                    <?php } ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="third-column">
                    ...
                    <?php if($textile_data['financial_assistance'] == 1){ ?>
                        <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_data['financial_assistance_upload']; ?>" target="_blank"> View Document </a>
                    <?php } ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    ...
                    <?php if($textile_data['govt_dues'] == 1){ ?>
                        <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_data['govt_dues_upload']; ?>" target="_blank"> View Document </a>
                    <?php } ?>
                </td>
            </tr>
            <tr>
        ...
        <br/>
         <table class="CompanyDetails">
            ...
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_partf_data['project_profile_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_partf_data['details_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_partf_data['investment_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column">10 </td>
        ...
        <br/>
         <table class="CompanyDetails">
            ...
            <tr>
                ...
                <td class="second-column">Project Report,covering Project Profile :</td>
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_partg_data['project_profile_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column"> </td>
                <td class="second-column">Details of equipments & machineries :</td>
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_partg_data['details_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column"> </td>
                <td class="second-column">Fixed Capital investment :</td>
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_partg_data['investment_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column">11 </td>
        ...
        <br/>
         <table class="CompanyDetails">
            ...
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_parth_data['project_profile_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column"> </td>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_parth_data['mou_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column">4 </td>
            ...
            <tr>
                ...
                <td class="second-column">Details of equipments & machineries :</td>
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_parth_data['details_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                ...
                <td class="second-column">Fixed Capital investment :</td>
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_parth_data['investment_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_parth_data['annual_production_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_parth_data['power_consumption_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column">(vi) </td>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/textile/<?php echo $textile_parth_data['impact_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column">11 </td>
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/textile/<?php echo $textile_declaration_data['sign_seal']; ?>" height="100px" width="100px"></td></tr>
        </table>

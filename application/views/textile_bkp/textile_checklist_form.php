                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="entrepreneur_memorandum_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','entrepreneur_memorandum_uploader','textile_checklist');">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="partnership_deed_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','partnership_deed_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="lease_agreement_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','lease_agreement_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="loan_sanction_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','loan_sanction_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="power_release_order_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','power_release_order_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="invoice_copy_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','invoice_copy_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="ca_prescribed_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','ca_prescribed_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="certificate_commencement_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','certificate_commencement_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="engineer_certificate_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','engineer_certificate_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="expenses_certificate_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','expenses_certificate_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="stamped_receipt_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','stamped_receipt_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="sale_invoice_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','sale_invoice_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="additional_document_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','additional_document_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="factorylicence_copy_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','factorylicence_copy_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="pcc_copy_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','pcc_copy_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="expansion_date_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','expansion_date_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="production_turnover_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','production_turnover_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="fix_assets_value_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','fix_assets_value_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="production_capacity_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','production_capacity_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="patent_registration_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','patent_registration_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="energy_water_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','energy_water_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="quality_certificate_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','quality_certificate_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="resident_certificate_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','resident_certificate_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="bank_total_interest_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','bank_total_interest_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="bank_statement_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','bank_statement_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="annexure3_declaration_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','annexure3_declaration_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="interest_subsidy_cal_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','interest_subsidy_cal_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="year_annual_prod_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','year_annual_prod_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="year_bank_statement_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','year_bank_statement_uploader','textile_checklist');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    </div>
                    <div class="form-group">
                        <button type="button" id="previous_btn_for_incentive_details" class="btn btn-sm btn-success" onclick="Textile.listview.editOrViewDeclaration($('#previous_btn_for_declaration_details'), '{{incentive_id}}', true);" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                        <button type="button" id="submit_btn_for_incentive" class="btn btn-sm btn-nic-blue" onclick="Textile.listview.submitTextileChecklist('{{VALUE_ONE}}');" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>
                        <button type="button" id="draft_btn_for_incentive" class="btn btn-sm btn-success" onclick="Textile.listview.askForSubmitTextile('{{VALUE_TWO}}');"  style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="Textile.listview.loadTextileData();"  style="margin-right: 5px;"><i class="fas fa-times"></i>&nbsp; Cancel</button>
                    </div>
                </div>
            </form>
        </div>

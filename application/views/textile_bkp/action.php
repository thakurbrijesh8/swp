<div class="text-center">
    ...
    {{/if}}
    <button type="button" class="btn btn-sm btn-nic-blue" onclick="Textile.listview.editOrViewTextile($(this),'{{incentive_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <a class="btn btn-sm btn-warning" target="_blank"
       href="{{ADMIN_TEXTILE_DOC_PATH}}{{challan}}" id="download_challan_btn_{{incentive_id}}"
       style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <button type="button" class="btn btn-sm btn-info" id="download_upload_btn_{{incentive_id}}"
            onclick="Textile.listview.downloadUploadChallan('{{incentive_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-cloud-upload-alt" style="margin-right: 2px;"></i> Pay Your Fees</button>
    {{/if}}
    {{#if show_download_certificate_btn}}
    <button type="button" class="btn btn-sm btn-nic-blue" onclick="Textile.listview.generateCertificate('{{incentive_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">

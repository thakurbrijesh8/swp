    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;">COMMON APPLICATION FORM</div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="women_entrepreneur_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{textile_data.incentive_id}}','women_entrepreneur','incentive_generalform_textile');">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="sc_st_entrepreneur_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{textile_data.incentive_id}}','sc_st_entrepreneur','incentive_generalform_textile');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="physically_entrepreneur_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{textile_data.incentive_id}}','physically_entrepreneur','incentive_generalform_textile');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="transgender_entrepreneur_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{textile_data.incentive_id}}','transgender_entrepreneur','incentive_generalform_textile');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="other_entrepreneur_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{textile_data.incentive_id}}','other_entrepreneur','incentive_generalform_textile');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="financial_assistance_upload_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{textile_data.incentive_id}}','financial_assistance_upload','incentive_generalform_textile');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="govt_dues_upload_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{textile_data.incentive_id}}','govt_dues_upload','incentive_generalform_textile');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>

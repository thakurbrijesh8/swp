                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="project_profile_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','project_profile_uploader','incentive_partf');">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="details_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','details_uploader','incentive_partf');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="investment_uploader_name_container_for_textile" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="Textile.listview.askForRemove('{{incentive_id}}','investment_uploader','incentive_partf');">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>

                                    ...
                                    <tr style="background-color: #fff;">
                                        ...
                                        <td>
                                            <div class="form-group col-sm-12" id="certified_copy_container">
                                                <label><span style="color: red;">(Maximum File Size: 10MB) &nbsp;<br> (Upload PDF Only)</span></label><br>
                                                <input type="file" id="certified_copy" name="certified_copy" accept="application/pdf"
                                                       class="spinner_container_for_na_{{VALUE_FOUR}}" onchange="Na.listview.uploadDocumentForNa(VALUE_FOUR);">
                                            ...
                                            <div class="form-group col-sm-12" id="certified_copy_name_container" style="display: none;">
                                                ...
                                                <button type="button" id="certified_copy_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_na_{{VALUE_FOUR}}" style="vertical-align: top;"
                                                        onclick="Na.listview.askForRemove('{{na_data.na_id}}', VALUE_FOUR);">
                                    ...
                                    <tr style="background-color: #fff;">
                                        ...
                                        <td>
                                            <div class="form-group col-sm-12" id="sketch_layout_container">
                                                <label><span style="color: red;">(Maximum File Size: 10MB) &nbsp;<br> (Upload PDF Only)</span></label><br>
                                                <input type="file" id="sketch_layout" name="sketch_layout" accept="application/pdf"
                                                       class="spinner_container_for_na_{{VALUE_FIVE}}" onchange="Na.listview.uploadDocumentForNa(VALUE_FIVE);">
                                            ...
                                            <div class="form-group col-sm-12" id="sketch_layout_name_container" style="display: none;">
                                                ...
                                                <button type="button" id="sketch_layout_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_na_{{VALUE_FIVE}}" style="vertical-align: top;"
                                                        onclick="Na.listview.askForRemove('{{na_data.na_id}}', VALUE_FIVE);">
                                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                                            </div>
                                    ...
                                    <tr style="background-color: #fff;">
                                        ...
                                        <td>
                                            <div class="form-group col-sm-12" id="written_consent_container">
                                                <label><span style="color: red;">(Maximum File Size: 10MB) &nbsp;<br> (Upload PDF Only)</span></label><br>
                                                <input type="file" id="written_consent" name="written_consent" accept="application/pdf"
                                                       class="spinner_container_for_na_{{VALUE_SIX}}" onchange="Na.listview.uploadDocumentForNa(VALUE_SIX);">
                                            ...
                                            <div class="form-group col-sm-12" id="written_consent_name_container" style="display: none;">
                                                ...
                                                <button type="button" id="written_consent_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_na_{{VALUE_SIX}}" style="vertical-align: top;"
                                                        onclick="Na.listview.askForRemove('{{na_data.na_id}}', VALUE_SIX);">
                                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                                            </div>
...
<!--                            <input type="radio" id="rejected_land_yes" name="rejected_land"  
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="form_land_document_container">
                            ...
                            <input type="file" id="form_land_document" name="form_land_document" accept="application/pdf"
                                   class="spinner_container_for_na_{{VALUE_ONE}}" onchange="Na.listview.uploadDocumentForNa(VALUE_ONE);">
                        ...
                        <div class="form-group col-sm-12" id="form_land_document_name_container" style="display: none;">
                            ...
                            <button type="button" id="form_land_document_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_na_{{VALUE_ONE}}" style="vertical-align: top;"
                                    onclick="Na.listview.askForRemove('{{na_data.na_id}}', VALUE_ONE);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="site_plan_document_container">
                            ...
                            <input type="file" id="site_plan_document" name="site_plan_document" accept="application/pdf"
                                   class="spinner_container_for_na_{{VALUE_TWO}}" onchange="Na.listview.uploadDocumentForNa(VALUE_TWO);">
                        ...
                        <div class="form-group col-sm-12" id="site_plan_document_name_container" style="display: none;">
                            ...
                            <button type="button" id="site_plan_document_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_na_{{VALUE_TWO}}" style="vertical-align: top;"
                                    onclick="Na.listview.askForRemove('{{na_data.na_id}}', VALUE_TWO);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_na">
                            ...
                            <input type="file" id="seal_and_stamp_for_na" name="seal_and_stamp_for_na" accept="image/jpg,image/png,image/jpeg,image/jfif"
                                   class="spinner_container_for_na_{{VALUE_THREE}}" onchange="Na.listview.uploadDocumentForNa(VALUE_THREE);">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_na" style="display: none;">
                            ...
                            <button type="button" id="seal_and_stamp_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_na_{{VALUE_THREE}}" style="vertical-align: top;"
                                    onclick="Na.listview.askForRemove('{{na_data.na_id}}', VALUE_THREE);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>

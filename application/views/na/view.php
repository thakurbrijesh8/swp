        ...
        <div class="card">
            ...
            <form role="form" id="na_form" name="na_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>9. Whether the applicant is occupant Class-I or Class-II or a Tenant or a government lessee <span style="color: red;">*</span></label>
                            <select class="form-control" id="occupant_class" name="occupant_class"
                                    data-placeholder="Whether the applicant is occupant Class-I or Class-II or a Tenant or a government lessee. !" readonly="">
                                <option value="">Select occupant class</option>
                                <option value="Class-I">Class-I</option>
                                <option value="Class-II">Class-II</option>
                            </select>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>11. Whether the land is Situated or Included. <span style="color: red;">*</span></label>
                            <select class="form-control" id="situated_land" name="situated_land"

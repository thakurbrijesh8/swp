                ...
                <tr style="background-color: #fff;">
                    ...
                    <td>
                            {{#if show_certified_copy}}
                                <a target="_blank" href="documents/na/{{certified_copy}}">
                ...
                <tr>
                    ...
                    <td>
                            {{#if show_sketch_layout}}
                                <a target="_blank" href="documents/na/{{sketch_layout}}">
                                    <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
                ...
                <tr>
                    ...
                    <td>
                            {{#if show_written_consent}}
                                <a target="_blank" href="documents/na/{{written_consent}}">
                                    <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
            ...
            <tr style="background-color: #fff;">
                ...
                <td>
                    {{#if show_form_land_document}}
                        <a target="_blank" href="documents/na/{{form_land_document}}">
                            <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">
            ...
            <tr>
                ...
                <td>
                    {{#if show_site_plan_document}}
                        <a target="_blank" href="documents/na/{{site_plan_document}}">
                            <label class="btn btn-sm btn-nic-blue f-w-n cursor-pointer mb-1">

<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="Na.listview.newNaForm(false, {});">
                <i class="fas fa-plus"></i>&nbsp; Apply for Change In Land Use ( N.A.)
            </button>
        </h3>
    </div>
            ...
            <table id="na_datatable" class="table table-bordered table-hover">
                <thead>
                    <tr class="bg-light-gray">
                        ...
                        <th class="text-center" style="min-width: 165px;">Purpose</th>
                        <th class="text-center" style="min-width: 165px;">Occupation</th>

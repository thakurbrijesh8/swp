...
<div style="font-size: 14px; text-align: right; margin-bottom: 5px;margin-right: 40px;"><img src="<?php echo base_url(); ?>documents/na/<?php echo $na_data['signature']; ?>" height="80px" width="80px"></div>

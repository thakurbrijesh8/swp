<html>
    ...
    <body>
        ...
        <!--<div style="font-size: 14px; text-align: left; margin-top: 25px;margin-left: 50px;word-spacing: 5px;">I/We,&emsp;<span style="font-weight: bold;"><?php echo $na_data['name_of_applicant']; ?></span>, &emsp;<?php echo $na_data['postel_address']; ?>, &emsp;Taluka  <?php echo $na_data['village']; ?> in &emsp; <?php echo $na_data['postel_address']; ?></div>-->
        ...
        <div style="font-size: 14px; text-align: right; margin-bottom: 5px;"><img src="<?php echo base_url(); ?>documents/na/<?php echo $na_data['signature']; ?>" height="80px" width="80px"></div>

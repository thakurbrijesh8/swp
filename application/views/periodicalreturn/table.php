<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="Periodicalreturn.listview.newPeriodicalreturnForm(false, {});">
                <i class="fas fa-plus"></i>&nbsp; Apply for Periodical Return
            </button>
        </h3>
    </div>
                ...
                <thead>
                    <tr class="bg-light-gray">
                       ...
                       <th class="text-center" style="min-width: 165px;">Applicant Name</th>
                        ...
                        <th class="text-center" style="min-width: 165px;">Applicant License No</th>

            ...
            <div class="row applicant_ld_div" style="display: none">                    
                ...
                <div class="col-xs-12 applicant_lm_div" style="display: none">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_periodicalreturn" class="btn btn-sm btn-nic-blue" onclick="Periodicalreturn.listview.submitPeriodicalreturn({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>
                        <button type="button" id="submit_btn_for_periodicalreturn" class="btn btn-sm btn-success" onclick="Periodicalreturn.listview.askForSubmitPeriodicalreturn({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="Periodicalreturn.listview.loadPeriodicalreturnData();">Close</button>
                    </div>
                </div>
            </form>
        </div>

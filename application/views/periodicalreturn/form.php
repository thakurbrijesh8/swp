<div class="row">
                            ...
                            <label>2. Select type of Application<span class="color-nic-red">*</span></label>
                             <div class="input-group">
                                <select class="form-control select2" id="application_category" name="application_category"  onchange="Periodicalreturn.listview.getApplicanttype(this);"
                                        data-placeholder="Type Of Application !"   onblur="checkValidation('periodicalreturn', 'application_category', applicationCategoryValidationMessage);" >
 ...
 -->
            ...
            <div class="row applicant_ld_div" style="display: none">                    
                ...
                <div class="col-xs-12 applicant_ld_div" style="display: none">
                        <div style="background-color: #d2d6de; padding: 5px;">
                            <span class="f-w-b" style="font-size: 15px; color: #000;">12. Details of Dealer</span>
                            <hr>
                ...
                <div class="col-xs-12 applicant_lm_div" style="display: none">
                        <div style="background-color: #d2d6de; padding: 5px;">
                            <span class="f-w-b" style="font-size: 15px; color: #000;">11. Details of Manufacturer</span>
                            <hr>
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_periodicalreturn" class="btn btn-sm btn-nic-blue" onclick="Periodicalreturn.listview.submitPeriodicalreturn({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>
                        <button type="button" id="submit_btn_for_periodicalreturn" class="btn btn-sm btn-success" onclick="Periodicalreturn.listview.askForSubmitPeriodicalreturn({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="Periodicalreturn.listview.loadPeriodicalreturnData();"><i class="fas fa-times"></i>&nbsp; Close</button>
                    </div>
                </div>
            </form>
        </div>

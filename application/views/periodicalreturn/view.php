    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title" style="float: none; text-align: center;">Periodical Return </h3>
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                      <div class="form-group col-sm-6">
                            ...
                            <span class="error-message error-message-periodicalreturn-district"></span>
                        </div>
                        <div class="form-group col-sm-6">
                       ...
                       <div class="row">
                        <div class="form-group col-sm-6">
                            <label>2. Select type of Application<span class="color-nic-red">*</span></label>
                             <div class="input-group">
                                <select class="form-control select2" id="application_category" name="application_category"  onchange="Periodicalreturn.listview.getApplicanttype(this);"
                                        data-placeholder="Type Of Application !"   onblur="checkValidation('obc_certificate', 'application_category', selectApplicationValidationMessage);" disabled="" >
                            ...
                            <span class="error-message error-message-obc_certificate-application_category"></span>
                        </div></br>  
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
               ...
               <div class="row applicant_ld_lm_div" style="display: none">
                ...
                <div class="col-xs-12 applicant_lr_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product_manufacturer" disabled onclick="Periodicalreturn.listview.addMultipleRepairer({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;" disabled></i>Add Details
                            </button>
                        </div>
                </div>
                ...
                <div class="col-xs-12 applicant_ld_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product" disabled onclick="Periodicalreturn.listview.addMultipleProprietor({});" style="margin-right: 5px;margin-top: 5px;" disabled><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Details
                            </button>
                        </div>
                    </div>
                    <br/>
                ...
                <div class="col-xs-12 applicant_ld_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product_detail" disabled onclick="Periodicalreturn.listview.addOther({});" style="margin-right: 5px;margin-top: 5px;" disabled><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Details
                            </button>
                        </div>
                </div>
                ...
                <div class="col-xs-12 applicant_lm_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product_manufacturer" disabled onclick="Periodicalreturn.listview.addMultipleManufacturer({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;" disabled></i>Add Details
                            </button>
                        </div>
                    </div>
                    <br/>
                ...
                <div class="col-xs-12 applicant_lm_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product_manufacturer" disabled onclick="Periodicalreturn.listview.addMultipleManufacturertwo({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;" disabled></i>Add Details
                            </button>
                        </div>
                    </div>

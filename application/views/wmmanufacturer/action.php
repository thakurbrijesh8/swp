<div class="text-center">
    ...
    {{/if}}
    <button type="button" class="btn btn-sm btn-nic-blue" onclick="Manufacturer.listview.editOrViewManufacturer($(this),'{{manufacturer_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <a class="btn btn-sm btn-warning" target="_blank"
       href="{{ADMIN_MANUFACT_DOC_PATH}}{{challan}}" id="download_challan_btn_{{manufacturer_id}}"
       style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-cloud-download-alt" style="margin-right: 2px;"></i> Payment Requested
    </a>
    <button type="button" class="btn btn-sm btn-info" id="download_upload_btn_{{manufacturer_id}}"
            onclick="Manufacturer.listview.downloadUploadChallan('{{manufacturer_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-cloud-upload-alt" style="margin-right: 2px;"></i> Pay Your Fees</button>
    {{/if}}
    {{#if show_download_certificate_btn}}
    <button type="button" class="btn btn-sm btn-nic-blue" onclick="Manufacturer.listview.generateCertificate('{{manufacturer_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-certificate" style="margin-right: 2px;"></i> Download Certificate</button>
    {{/if}}
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="askForFeedbackRating($(this), VALUE_FOUR,'{{manufacturer_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">

            ...
            <form role="form" id="repairer_renewal_form" name="repairer_renewal_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_repairer_renewal" class="btn btn-sm btn-nic-blue" onclick="Repairer.listview.submitRepairerRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_repairer_renewal" class="btn btn-sm btn-success" onclick="Repairer.listview.askForSubmitRepairerRenewal({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

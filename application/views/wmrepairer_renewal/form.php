            ...
            <form role="form" id="repairer_renewal_form" name="repairer_renewal_form" onsubmit="return false;">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_repairer_renewal" class="btn btn-sm btn-nic-blue" onclick="RepairerRenewal.listview.submitRepairerRenewal({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>
                        <button type="button" id="submit_btn_for_repairer_renewal" class="btn btn-sm btn-success" onclick="RepairerRenewal.listview.askForSubmitRepairerRenewal({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>

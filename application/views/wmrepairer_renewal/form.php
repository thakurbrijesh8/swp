        ...
        <div class="card">
            ...
            <form role="form" id="repairer_renewal_form" name="repairer_renewal_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <br/>
                     <div class="row">
                        <div class="col-12 m-b-5px" id="original_licence_container_for_repairer">
                            <label>14. Original Licence.<span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="original_licence_for_repairer" name="original_licence_for_repairer" class="spinner_container_for_repairer_{{VALUE_ONE}}"
                                   accept="application/pdf" onchange="RepairerRenewal.listview.uploadDocumentForRepairerRenewal(VALUE_ONE);">
                        ...
                        <div class="form-group col-sm-12" id="original_licence_name_container_for_repairer" style="display: none;">
                            <label>14.1 Original Licence.<span style="color: red;">* </span></label><br>
                            <a target="_blank" id="original_licence_download"><label id="original_licence_name_image_for_repairer" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_repairer_renewal_{{VALUE_ONE}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            <button type="button" id="original_licence" class="btn btn-sm btn-danger spinner_name_container_for_repairer_renewal_{{VALUE_ONE}}" style="vertical-align: top;"
                                    onclick="RepairerRenewal.listview.askForRemove('{{repairer_renewal_data.repairer_renewal_id}}', VALUE_ONE);">
                ...
                <div class="row">
                        <div class="col-12 m-b-5px" id="renewed_licence_container_for_repairer">
                            <label>15. Renewed Licence.<span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="renewed_licence_for_repairer" name="renewed_licence_for_repairer" class="spinner_container_for_repairer_{{VALUE_TWO}}"
                                   accept="application/pdf" onchange="RepairerRenewal.listview.uploadDocumentForRepairerRenewal(VALUE_TWO);">
                        ...
                        <div class="form-group col-sm-12" id="renewed_licence_name_container_for_repairer" style="display: none;">
                            <label>15.1 Renewed Licence.<span style="color: red;">* </span></label><br>
                            <a target="_blank" id="renewed_licence_download"><label id="renewed_licence_name_image_for_repairer" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_repairer_renewal_{{VALUE_TWO}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            <button type="button" id="renewed_licence" class="btn btn-sm btn-danger spinner_name_container_for_repairer_renewal_{{VALUE_TWO}}" style="vertical-align: top;"
                                    onclick="RepairerRenewal.listview.askForRemove('{{repairer_renewal_data.repairer_renewal_id}}', VALUE_TWO);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                ...
                <div class="row">
                        <div class="col-12 m-b-5px" id="periodical_return_container_for_repairer">
                            <label>16. Register/ Periodical Return LM-4.<span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="periodical_return_for_repairer" name="periodical_return_for_repairer" class="spinner_container_for_repairer_{{VALUE_THREE}}"
                                   accept="application/pdf" onchange="RepairerRenewal.listview.uploadDocumentForRepairerRenewal(VALUE_THREE);">
                        ...
                        <div class="form-group col-sm-12" id="periodical_return_name_container_for_repairer" style="display: none;">
                            <label>16.1 Register/ Periodical Return LM-4.<span style="color: red;">* </span></label><br>
                            <a target="_blank" id="periodical_return_download"><label id="periodical_return_name_image_for_repairer" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_repairer_renewal_{{VALUE_THREE}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            <button type="button" id="periodical_return" class="btn btn-sm btn-danger spinner_name_container_for_repairer_renewal_{{VALUE_THREE}}" style="vertical-align: top;"
                                    onclick="RepairerRenewal.listview.askForRemove('{{repairer_renewal_data.repairer_renewal_id}}', VALUE_THREE);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                ...
                <div class="row">
                        <div class="col-12 m-b-5px" id="verification_certificate_container_for_repairer">
                            <label>17. Verification Certificate of Weights & Measures and Test Equipment Tools.<span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>
                            <input type="file" id="verification_certificate_for_repairer" name="verification_certificate_for_repairer" class="spinner_container_for_repairer_{{VALUE_FOUR}}"
                                   accept="application/pdf" onchange="RepairerRenewal.listview.uploadDocumentForRepairerRenewal(VALUE_FOUR);">
                        ...
                        <div class="form-group col-sm-12" id="verification_certificate_name_container_for_repairer" style="display: none;">
                            <label>17.1 Verification Certificate of Weights & Measures and Test Equipment Tools.<span style="color: red;">* </span></label><br>
                            <a target="_blank" id="verification_certificate_download"><label id="verification_certificate_name_image_for_repairer" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_repairer_renewal_{{VALUE_FOUR}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            <button type="button" id="verification_certificate" class="btn btn-sm btn-danger spinner_name_container_for_repairer_renewal_{{VALUE_FOUR}}" style="vertical-align: top;"
                                    onclick="RepairerRenewal.listview.askForRemove('{{repairer_renewal_data.repairer_renewal_id}}', VALUE_FOUR);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_repairer">
                            <label>21. Signature <span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <input type="file" id="seal_and_stamp_for_repairer" name="seal_and_stamp_for_repairer" class="spinner_container_for_repairer_{{VALUE_FIVE}}"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif" onchange="RepairerRenewal.listview.uploadDocumentForRepairerRenewal(VALUE_FIVE);">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_repairer" style="display: none;">
                            <label>21. Principal Employer Seal & Stamp <span style="color: red;">* </span></label><br>
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_repairer" style="width: 250px; height: 250px; border: 2px solid blue;" class="spinner_name_container_for_repairer_{{VALUE_FIVE}}"></a>
                            <button type="button" id="seal_and_stamp" class="btn btn-sm btn-danger spinner_name_container_for_repairer_{{VALUE_FIVE}}" style="vertical-align: top;" 
                                    onclick="RepairerRenewal.listview.askForRemove('{{repairer_renewal_data.repairer_renewal_id}}', VALUE_FIVE);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_repairer_renewal" class="btn btn-sm btn-nic-blue" onclick="RepairerRenewal.listview.submitRepairerRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>
                        <button type="button" id="submit_btn_for_repairer_renewal" class="btn btn-sm btn-success" onclick="RepairerRenewal.listview.askForSubmitRepairerRenewal({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

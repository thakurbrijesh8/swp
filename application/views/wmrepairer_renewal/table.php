<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="RepairerRenewal.listview.newRepairerRenewalForm(false, {});">Apply for Renewal under "License for Repairer"</button>
        </h3>
    </div>

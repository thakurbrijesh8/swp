        ...
        <div class="card">
            ...
            <form role="form" id="construction_form" name="construction_form" onsubmit="return false;">
                ...
                <div class="row">
                     ...
                     <div class="row">
                      <div class="form-group col-sm-6">
                            <label>10. Architect/ Engineer /Structural License valid upto</span></label>
                            <div class="input-group">
                 ...
                 <div class="row">
                   <div  class="annexure_III_item_container_for_construction" style="display: none;"> 
                        <div class="form-group col-sm-12" id="annexure_III_container_for_construction">
                            <label>11. Annexure III.<span style="color: red;">* <br></span></label><br>
                     ...
                     <div class="form-group col-sm-12" id="annexure_III_name_container_for_construction" style="display: none;">
                          <label class="dnh_for_cp_div" style="display: none">11.1 Annexure <span style="color: red;">*<br></span></label>
                            <label class="dd_for_cp_div" >11.1 Annexure III.<span style="color: red;">*<br></span></label><br>
                            <a id="annexure_III_download" target="_blank"><label id="annexure_III_name_image_for_construction" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div>
                  </div> 
                   ...
                   <div class="row">
                     <div  class="annexure_IV_item_container_for_construction" style="display: none;">
                        <div class="form-group col-sm-12" id="annexure_IV_container_for_construction">
                            <label>12. Annexure IV<span style="color: red;">* <br></span></label><br>
                     ...
                     <div class="form-group col-sm-12" id="annexure_IV_name_container_for_construction" style="display: none;">
                            <label>12.1 Annexure IV<span style="color: red;">*<br></span></label><br>
                            <a id="annexure_IV_download" target="_blank"><label id="annexure_IV_name_image_for_construction" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div>
                </div>
                    ...
                    <div  class="copy_of_na_item_container_for_construction" style="display: none;">
                     ...
                     <div class="form-group col-sm-12" id="copy_of_na_name_container_for_construction" style="display: none;">
                      <label class="dnh_for_cp_div" style="display: none">12.1  N.A Order <span style="color: red;">* </span></label>
                            <label class="dd_for_cp_div">13.1 Copy of N.A.<span style="color: red;">*<br></span></label><br>
                            <a id="copy_of_na_download" target="_blank"><label id="copy_of_na_name_image_for_construction" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div  class="original_certified_map_item_container_for_construction" style="display: none;">
                        <div class="form-group col-sm-12" id="original_certified_map_container_for_construction">
                            <label>14. Original certified Map of Survey/Plot no. issued by City Survey office, Daman.<span style="color: red;">* <br></span></label><br>
                     ...
                     <div class="form-group col-sm-12" id="original_certified_map_name_container_for_construction" style="display: none;">
                      <label class="dnh_for_cp_div" style="display: none">13.1 Certified Map. <span style="color: red;">* </span></label>
                            <label class="dd_for_cp_div">14.1 Original certified Map of Survey/Plot no.<span style="color: red;">*<br></span></label><br>
                            <a id="original_certified_map_download" target="_blank"><label id="original_certified_map_name_image_for_construction" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                     ...
                     <div class="form-group col-sm-12" id="I_and_XIV_nakal_name_container_for_construction" style="display: none;">
                       <label class="dnh_for_cp_div" style="display: none">14.1 7x12 Nakal of land. <span style="color: red;">* </span></label>
                            <label class="dd_for_cp_div">15.1  Copy of RoR (I and XIV nakal Copy or 7/12 extract Copy).<span style="color: red;">*<br></span> </label><br>
                            <a id="I_and_XIV_nakal_download" target="_blank"><label id="I_and_XIV_nakal_name_image_for_construction" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                     ...
                     <div class="form-group col-sm-12" id="building_plan_dcr_name_container_for_construction" style="display: none;">
                      <label class="dnh_for_cp_div" style="display: none">15.1 Building Plan <span style="color: red;">* </span></label>
                            <label class="dd_for_cp_div">16.1 Building Plan with complete details as per Rule 6.7 to 6.12 of DCR 2005 (Building plan shall also include Key Plan/Location plan, Site plan and Service plan.)<span style="color: red;">*<br> </span></label><br>
                            <a id="building_plan_dcr_download" target="_blank"><label id="building_plan_dcr_name_image_for_construction" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div> 
                </div>
                   ...
                   <div class="row">
                     ...
                     <div class="form-group col-sm-12" id="cost_estimate_name_container_for_construction" style="display: none;">
                            <label>17.1 Cost Estimate.<span style="color: red;">*<br></span></label><br>
                            <a id="cost_estimate_download" target="_blank"><label id="cost_estimate_name_image_for_construction" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div> 
                </div>
                   ...
                   <div class="row">
                    <div  class="noc_coast_guard_item_container_for_construction" style="display: none;"> 
                     ...
                     <div class="form-group col-sm-12" id="noc_coast_guard_name_container_for_construction" style="display: none;">
                            <label>18.1 NOC of the coast Guard Authority.<span style="color: red;">*<br></span></label><br>
                            <a id="noc_coast_guard_download" target="_blank"><label id="noc_coast_guard_name_image_for_construction" class="btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                  </div>
                  </div> 
                     ...
                     <div  class="annexure_V_item_container_for_construction" style="display: none;"> 
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 m-b-5px" id="layout_plan_container_for_construction">
                            <label class="dd_for_cp_div">21.1 Certificate of completion of Development work as per approval layout plan or singed statement on company’s letterhead that it is not applicable.</label>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                  ...
                  <div class="row">
                    <div  class="provisional_noc_fire_item_container_for_construction" style="display: none;">
                        <div class="form-group col-sm-12">
                            <label>22. Copy of N.A. Sanad /Order/ Property card for existing Gaothan area. &emsp;</label>
                        ...
                        <div class="col-12 m-b-5px" id="provisional_noc_fire_container_for_construction">
                            <label>22.1  Provisional NOC from Fire Department.</label> 
                            <label class="f-w-n">Document Not Uploaded</label><br>
                     ...
                     <div class="row">
                       <div  class="crz_clearance_certificate_item_container_for_construction" style="display: none;">
                        ...
                        <div class="col-12 m-b-5px" id="crz_clearance_certificate_container_for_construction">
                            <label>23.1  CRZ clearance certificate of the concerned authority.</label> 
                            <label class="f-w-n">Document Not Uploaded</label><br>
                     ...
                     <div class="row">
                      <div  class="sub_division_order_item_container_for_construction" style="display: none;">
                        ...
                        <div class="col-12 m-b-5px" id="sub_division_order_container_for_construction">
                            <label>24.1  True copy of approved layout plan and Sub division order.</label> 
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        ...
                        <div class="form-group col-sm-12" id="sub_division_order_name_container_for_construction" style="display: none;">
                           <label class="dnh_for_cp_div" style="display: none">17.1 Copy of Approved Layout <span class="color-nic-red">*</span></label>
                            <label class="dd_for_cp_div">24.1  True copy of approved layout plan and Sub division order.</label><br>
                     ...
                     <div class="row">
                      <div  class="amalgamation_order_item_container_for_construction" style="display: none;">
                        ...
                        <div class="col-12 m-b-5px" id="amalgamation_order_container_for_construction">
                            <label>25.1  Copy of the amalgamation order.</label> 
                            <label class="f-w-n">Document Not Uploaded</label><br>
                     ...
                     <div class="row">
                       <div  class="occupancy_certificate_item_container_for_construction" style="display: none;">
                        ...
                        <div class="col-12 m-b-5px" id="occupancy_certificate_container_for_construction">
                            <label>26.1  Occupancy Certificate.</label> 
                            <label class="f-w-n">Document Not Uploaded</label><br>
                     ...
                     <div class="row">
                      <div  class="certificate_land_acquisition_item_container_for_construction" style="display: none;">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="radio" id="certificate_land_yes" name="certificate_land"  
                                   disabled=""  value="{{IS_CHECKED_YES}}"> Yes &emsp;  
                            <input type="radio" id="certificate_land_no" name="certificate_land" 
                                   disabled=""  value="{{IS_CHECKED_NO}}"> No
                        </div>
                         <div class="col-12 m-b-5px" id="certificate_land_acquisition_container_for_construction">
                            <label>27.1  Certificate or order of the Land Acquisition.</label>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                            <div class="error-message error-message-construction-occupancy_certificate_for_construction"></div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_construction" style="display: none;">
                            ...
                            <a id="seal_and_stamp_download" target="_blank">
                                <img id="seal_and_stamp_name_image_for_construction" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>
                  </div>
                   ...
                   <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="licensed_engineer_signature_name_container_for_construction" style="display: none;">
                            <label>29. Signature of the Licensed Architect / Engineer / Surveyor / Structural Engineer <span style="color: red;"><br></span></label><br>
                  ...
                  <div class="row">
                    <div  class="labour_cess_item_container_for_construction" style="display: none;">
                     ...
                     <div class="form-group col-sm-12" id="labour_cess_name_container_for_construction" style="display: none;">
                            <label >19.1 Labour Cess Certificate.<span style="color: red;">*<br></span></label><br>
                 ...
                 <div class="row">
                    <div  class="undertaking_item_container_for_construction" style="display: none;">
                     ...
                     <div class="form-group col-sm-12" id="undertaking_name_container_for_construction" style="display: none;">
                            <label >20.1 Undertaking on Rs. 100/- Stamp Paper for Labour Cess.<span style="color: red;">*<br></span></label><br>
                   ...
                   <div class="row">
                    <div  class="fire_noc_item_container_for_construction" style="display: none;">
                        <div class="form-group col-sm-12" id="fire_noc_container_for_construction">
                            <label>21. Provisional NOC from Fire Department (Applicable to all building except Residential building having height less than 15m).<span style="color: red;">* <br></span></label><br>
                     ...
                     <div class="form-group col-sm-12" id="fire_noc_name_container_for_construction" style="display: none;">
                            <label >21.1 Provisional NOC from Fire Department.<span style="color: red;">*<br></span></label><br>
                   ...
                   <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="owner_signature_name_container_for_construction" style="display: none;">
                            <label>22.1 Signature of Owner <span style="color: red;"><br></span></label><br>

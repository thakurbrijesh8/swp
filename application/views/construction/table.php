<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="Construction.listview.newConstructionForm(false, {});">
                <i class="fas fa-plus"></i>&nbsp; Apply for Construction Permission
            </button>
        </h3>
    </div>

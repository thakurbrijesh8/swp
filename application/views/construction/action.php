<div class="text-center">
    ...
    {{/if}}
    <button type="button" class="btn btn-sm btn-nic-blue" onclick="Construction.listview.editOrViewConstruction($(this),'{{construction_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    {{/if}}
    {{#if show_query_btn}}
    <button type="button" class="btn btn-sm btn-warning" id="query_btn_for_wc_{{wmregistration_id}}" onclick="Construction.listview.getQueryData('{{construction_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <a class="btn btn-sm btn-warning" target="_blank"
       href="{{ADMIN_CONSTRUCTION_DOC_PATH}}{{challan}}" id="download_challan_btn_{{construction_id}}"
       style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-cloud-download-alt" style="margin-right: 2px;"></i> Payment Requested
    </a>
    <button type="button" class="btn btn-sm btn-info" id="download_upload_btn_{{construction_id}}"
            onclick="Construction.listview.downloadUploadChallan('{{construction_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    {{/if}}
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="askForFeedbackRating($(this), VALUE_TWENTYSIX,'{{construction_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">

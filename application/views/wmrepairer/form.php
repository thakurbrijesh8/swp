            ...
            <form role="form" id="repairer_form" name="repairer_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_repairer" class="btn btn-sm btn-nic-blue" onclick="Repairer.listview.submitRepairer({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>
                        <button type="button" id="submit_btn_for_repairer" class="btn btn-sm btn-success" onclick="Repairer.listview.askForSubmitRepairer({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>

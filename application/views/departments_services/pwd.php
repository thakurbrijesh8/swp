            ...
            <table class="table p-04 table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-grad btn-sm" href="<?php echo $base_url; ?>assets/department/pwd/Reform_155_v1.pdf" target="_blank">View</a>
                        </td>
...
<div class="table-responsive">
    <table class="table p-04 table-hover">
        ...
        <tbody>  
            <tr>
                <td class="text-center">1</td>                                
                <td>Display information on tariffs (in Rs. per kL) </td>
                    ...
                    <table class="table mb-0">
                        <tr>
                            <td style="border: none; border-right: 1px solid #dee2e6;
                                ...
                                <a target="_blank" href="<?php echo $base_url; ?>assets/department/pwd/reforms_149.pdf"><button type="button" class="btn btn-grad btn-sm">View</button></a>
                            </td>
            ...
            <tr>
                ...
                <td>Timelines mandated through the Public Service Delivery Guarantee Act </td>
                ...
                <td class="text-center" style="padding: 0px;">
                    <table class="table mb-0">
                        <tr>
                            <td style="border: none; border-right: 1px solid #dee2e6;
                                border-bottom: 1px solid #dee2e6; width: 33.33%;" class="text-center">
                                <a target="_blank" href="<?php echo $base_url; ?>assets/department/pwd/reforms_151.pdf"><button type="button" class="btn btn-grad btn-sm">View</button></a>
                            </td>
            ...
            <tr>
                ...
                <td>Fees Details for Mutation / Name Change at Water Department</td>
                ...
                <td class="text-center" style="padding: 0px;">
                    <table class="table mb-0">
                        <tr>
                            <td style="border: none; border-right: 1px solid #dee2e6;
                                border-bottom: 1px solid #dee2e6; width: 33.33%;" class="text-center">
                                <a target="_blank" href="assets/department/pwd/NameChangeCharges.jpg"><button type="button" class="btn btn-grad btn-sm">View</button></a>
                            </td>

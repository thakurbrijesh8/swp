<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="FactoryLicenseRenewal.listview.askForNewFactoryLicenseRenewalForm($(this));">Apply for Factories License - Renewal</button>
        </h3>
    </div>

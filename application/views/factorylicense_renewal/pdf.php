<html>
    ...
    <body>
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/factorylicense/<?php echo $factorylicense_renewal_data['sign_of_manager']; ?>" height="100px" width="100px"></td></tr>
        </table>
        ...
        <br/>
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/factorylicense/<?php echo $factorylicense_renewal_data['sign_of_occupier']; ?>" height="100px" width="100px"></td></tr>
        </table>
        <table style="margin-left: 70%;margin-top: 0px;word-spacing: 2px;">

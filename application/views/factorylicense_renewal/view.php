                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-12 m-b-5px" id="sign_of_occupier_container_for_factorylicense_renewal">
                            <label>10. Signature of Occupier of the factory</span></label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>
                        <div class="form-group col-sm-12" id="sign_of_occupier_name_container_for_factorylicense_renewal" style="display: none;">
                            <label>10. Signature of Occupier of the factory</label><br>
                            <a id="sign_of_occupier_download" target="_blank"><img id="sign_of_occupier_name_image_for_factorylicense_renewal" style="width: 250px; height: 250px; border: 2px solid black;"></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 m-b-5px" id="sign_of_manager_container_for_factorylicense_renewal">
                            <label>11. Signature of Manager of the factory</span></label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>
                        <div class="form-group col-sm-12" id="sign_of_manager_name_container_for_factorylicense_renewal" style="display: none;">
                            <label>11. Signature of Manager of the factory</label><br>
                            <a id="sign_of_manager_download" target="_blank"><img id="sign_of_manager_name_image_for_factorylicense_renewal" style="width: 250px; height: 250px; border: 2px solid black;"></a>
                        </div>
                    </div>

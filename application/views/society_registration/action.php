<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{society_registration_id}}" onclick="SocietyRegistration.listview.editOrViewSocietyRegistration($(this),'{{society_registration_id}}', true);"

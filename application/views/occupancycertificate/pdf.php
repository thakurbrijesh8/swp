<html>
    ...
    <body>
        ...
        <div style="font-size: 14px;margin-top: 20px;line-height: 1.6;">
            <img src="<?php echo base_url(); ?>documents/occupancycertificate/<?php echo  $occupancycertificate_data['licensed_engineer_signature']; ?>" height="100px" width="100px">
        </div>
        <div style="font-size: 14px;margin-top: 20px;line-height: 1.6;">
            Name of Owner : <b><?php echo $occupancycertificate_data['owner_name']; ?></b>
        </div>
        <div style="font-size: 14px;margin-top: 20px;line-height: 1.6;">
            <img src="<?php echo base_url(); ?>documents/occupancycertificate/<?php echo  $occupancycertificate_data['owner_signature']; ?>" height="100px" width="100px">
        </div>
        <div style="font-size: 14px;margin-top: 20px;line-height: 1.6;">
            Signature of Owner 
        </div>

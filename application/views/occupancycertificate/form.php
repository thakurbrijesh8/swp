                 ...
                 <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_occupancycertificate" class="btn btn-sm btn-nic-blue" onclick="OccupancyCertificate.listview.submitOccupancyCertificate({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_occupancycertificate" class="btn btn-sm btn-success" onclick="OccupancyCertificate.listview.askForSubmitOccupancyCertificate({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

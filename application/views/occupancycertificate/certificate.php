<?php
$barcode_number = generate_barcode_number(VALUE_TWENTYEIGHT, $occupancy_data['occupancy_certificate_id']);
...
<table class="CompanyDetails">
    ...
    <tr>
        ...
        <td class="second-column"><?php echo $occupancy_data['location_of_factory']; ?></td>
...
<table style="margin-left: 490px;">
    <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/wmregistration/<?php echo $occupancy_data['mw_sign_of_principal_employer']; ?>" height="60px" width="90px"></td></tr>
</table>

...
<div style="font-size: 14px; text-align: right; margin-bottom: 5px; margin-right: 40px;"><img src="<?php echo base_url(); ?>documents/hotelregi/<?php echo $hotelregi_data['signature']; ?>" height="80px" width="80px"></div>

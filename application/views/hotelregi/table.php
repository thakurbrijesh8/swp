<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="Hotelregi.listview.newHotelregiForm(false, {});">
                <i class="fas fa-plus"></i>&nbsp; Apply for New Hotel Registration
            </button>
        </h3>
    </div>

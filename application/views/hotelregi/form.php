            ...
            <form role="form" id="hotelregi_form" name="hotelregi_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_hotelregi" class="btn btn-sm btn-nic-blue" onclick="Hotelregi.listview.submitHotelregi({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>

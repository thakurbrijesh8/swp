    ...
    <body>
        ...
        <?php if (strlen($hotelregi_data['full_address']) < 30) { ?>
            ...
            <?php } else { ?>
                ...
                <div style="font-size: 14px; text-align: right; margin-bottom: 5px;"><img src="<?php echo base_url(); ?>documents/hotelregi/<?php echo $hotelregi_data['signature']; ?>" height="80px" width="80px"></div>
                ...
                <div style="font-size: 14px; text-align: center; margin-bottom: 5px;text-decoration: underline;margin-top: 150px;font-weight: bold;">C  H  E C  K    L  I  S  T</div>

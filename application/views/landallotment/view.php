                ...
                <div class="card-body">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_applicant" name="name_of_applicant" readonly="" class="form-control" placeholder="Enter Name of Applicant !"
                    ...
                    <br/>
                        ...
                        <div class="form-group col-sm-12" id="bio_data_doc_container_for_landallotment">
                            <label>9. (b) Complete bio-data of above persons.<span style="color: red;"> <br></span></label><br><br>
                     ...
                     <div class="form-group col-sm-12" id="bio_data_doc_name_container_for_landallotment" style="display: none;">
                            ...
                            <a id="bio_data_doc_download" target="_blank"><label id="bio_data_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                        ...
                        <div class=" constitution_artical_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="constitution_artical_doc_name_container_for_landallotment" style="display: none;">
                                ...
                                <a id="constitution_artical_doc_download" target="_blank"><label id="constitution_artical_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                ...
                <div class="row">
                    ...
                    <div class=" obtained_letter_of_intent_div" style="display: none;">
                        ...
                        <div class="form-group col-sm-12" id="obtained_letter_of_intent_doc_name_container_for_landallotment" style="display: none;">
                            ...
                            <a id="obtained_letter_of_intent_doc_download" target="_blank"><label id="obtained_letter_of_intent_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class=" regist_letter_msme_div" style="display: none;">
                        ...
                        <div class="form-group col-sm-12" id="regist_letter_msme_doc_name_container_for_landallotment" style="display: none;">
                            ...
                            <a id="regist_letter_msme_doc_download" target="_blank"><label id="regist_letter_msme_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                         <div class="form-group col-sm-12 " id="detailed_project_report_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="detailed_project_report_doc_name_container_for_landallotment" style="display: none;">
                                ...
                                <a id="detailed_project_report_doc_download" target="_blank"><label id="detailed_project_report_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                         <div class="form-group col-sm-12 " id="proposed_finance_terms_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="proposed_finance_terms_doc_name_container_for_landallotment" style="display: none;">
                                ...
                                <a id="proposed_finance_terms_doc_download" target="_blank"><label id="proposed_finance_terms_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">17.1 &nbsp;
                            <input type="checkbox" id="no_of_persons_likely_emp" name="no_of_persons_likely_emp" class="checkbox" disabled="" value="{{is_checked}}">&nbsp;Women
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">17.2 &nbsp;
                            <input type="checkbox" disabled="" id="no_of_persons_likely_emp_unskilled" name="no_of_persons_likely_emp_unskilled" class="checkbox" disabled="" value="{{is_checked}}">&nbsp;Unskilled
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">17.3 &nbsp;
                            <input type="checkbox" id="no_of_persons_likely_emp_staff" disabled="" name="no_of_persons_likely_emp_staff" class="checkbox" value="{{is_checked}}">&nbsp;Staff
                        </div>
                    ...
                    <div class="row">
                         <div class="form-group col-sm-12 " id="details_of_manufacturing_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="details_of_manufacturing_doc_name_container_for_landallotment" style="display: none;">
                                ...
                                <a id="details_of_manufacturing_doc_download" target="_blank"><label id="details_of_manufacturing_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        ...
                        <div class=" if_backward_class_bac_div" style="display: none;">
                           <div class="form-group col-sm-12 " id="if_backward_class_bac_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="if_backward_class_bac_doc_name_container_for_landallotment" style="display: none;">
                                ...
                                <a id="if_backward_class_bac_doc_download" target="_blank"><label id="if_backward_class_bac_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                       ...
                       <div class="form-group col-sm-12 " id="if_backward_class_scst_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="if_backward_class_scst_doc_name_container_for_landallotment" style="display: none;">
                                ...
                                <a id="if_backward_class_scst_doc_download" target="_blank"><label id="if_backward_class_scst_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        ...
                        <div class="row if_backward_class_ex_serv_div" style="display: none;">   
                         <div class="form-group col-sm-12" id="if_backward_class_ex_serv_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="if_backward_class_ex_serv_doc_name_container_for_landallotment" style="display: none;">
                                <label>Please Upload document<span style="color: red;"><br>  <span style="color: red;"></span></label><br>
                                <a id="if_backward_class_ex_serv_doc_download" target="_blank"><label id="if_backward_class_ex_serv_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        ...
                        <div class="row if_backward_class_wm_div" style="display: none;">
                          <div class="form-group col-sm-12" id="if_backward_class_wm_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="if_backward_class_wm_doc_name_container_for_landallotment" style="display: none;">
                                <label>Please Upload document<span style="color: red;"><br>  <span style="color: red;"></span></label><br>
                                <a id="if_backward_class_wm_doc_download" target="_blank"><label id="if_backward_class_wm_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                     ...
                     <div class="row if_backward_class_ph_div" style="display: none;">
                        <div class="form-group col-sm-12" id="if_backward_class_ph_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="if_backward_class_ph_doc_name_container_for_landallotment" style="display: none;">
                                <label>Please Upload document<span style="color: red;"><br>  <span style="color: red;"></span></label><br>
                                <a id="if_backward_class_ph_doc_download" target="_blank"><label id="if_backward_class_ph_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                     ...
                     <div class="row if_belonging_transg_div" style="display: none;">
                        <div class="form-group col-sm-12" id="if_belonging_transg_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="if_belonging_transg_doc_name_container_for_landallotment" style="display: none;">
                                <label>Please Upload document</label><br>
                                <a id="if_belonging_transg_doc_download" target="_blank"><label id="if_belonging_transg_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class=" if_bonafide_div" style="display: none;">
                         <div class="form-group col-sm-12 " id="bonafide_of_dnh_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="bonafide_of_dnh_doc_name_container_for_landallotment" style="display: none;">
                                ...
                                <a id="bonafide_of_dnh_doc_download" target="_blank"><label id="bonafide_of_dnh_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                         <div class="form-group col-sm-12 " id="information_raw_materials_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="information_raw_materials_doc_name_container_for_landallotment" style="display: none;">
                                ...
                                <a id="information_raw_materials_doc_download" target="_blank"><label id="information_raw_materials_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                         <div class="form-group col-sm-12 " id="infrastructure_requirement_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="infrastructure_requirement_doc_name_container_for_landallotment" style="display: none;">
                                <label>22. Upload the Infrastructure requirement. </label><br>
                                <a id="infrastructure_requirement_doc_download" target="_blank"><label id="infrastructure_requirement_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 " id="effluent_teratment_doc_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="effluent_teratment_doc_name_container_for_landallotment" style="display: none;">
                                <label>22.2 Upload Document of separate sheet for the process of effluent treatment.</label><br>
                                <a id="effluent_teratment_doc_download" target="_blank"><label id="effluent_teratment_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        ...
                        <div class="form-group col-sm-12" id="emission_of_gases_doc_name_container_for_landallotment" style="display: none;">
                            ...
                            <a id="emission_of_gases_doc_download" target="_blank"><label id="emission_of_gases_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="copy_authority_letter_doc_name_container_for_landallotment" style="display: none;">
                            ...
                            <a id="copy_authority_letter_doc_download" target="_blank"><label id="copy_authority_letter_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        ...
                        <div class="form-group col-sm-12" id="copy_project_profile_doc_name_container_for_landallotment" style="display: none;">
                            <label>24. Upload Copy of Project profile.</label><br>
                            <a id="copy_project_profile_doc_download" target="_blank"><label id="copy_project_profile_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        ...
                        <div class="form-group col-sm-12 " id="demand_of_deposit_draft_container_for_landallotment">
                            ...
                            <div class="form-group col-sm-12" id="demand_of_deposit_draft_name_container_for_landallotment" style="display: none;">
                                ...
                                <a id="demand_of_deposit_draft_download" target="_blank"><label id="demand_of_deposit_draft_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                              </div> 
                        ...
                        <div class="form-group col-sm-12" id="copy_proposed_land_doc_name_container_for_landallotment" style="display: none;">
                            <label>26. Upload Copy of proposed land utilization plan. </label><br>
                            <a id="copy_proposed_land_doc_download" target="_blank"><label id="copy_proposed_land_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        ...
                        <div class="form-group col-sm-12" id="copy_of_partnership_deed_doc_name_container_for_landallotment" style="display: none;">
                            ...
                            <a id="copy_of_partnership_deed_doc_download" target="_blank"><label id="copy_of_partnership_deed_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        ...
                        <div class="form-group col-sm-12" id="relevant_experience_doc_name_container_for_landallotment" style="display: none;">
                            ...
                            <a id="relevant_experience_doc_download" target="_blank"><label id="relevant_experience_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class=" if_promotion_council_div" style="display: none;">
                        ...
                        <div class="form-group col-sm-12" id="certy_by_direc_indus_doc_name_container_for_landallotment" style="display: none;">
                            ...
                            <a id="certy_by_direc_indus_doc_download" target="_blank"><label id="certy_by_direc_indus_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        ...
                        <div class="form-group col-sm-12" id="other_relevant_doc_name_container_for_landallotment" style="display: none;">
                            <label>30. Upload Any other relevant document.</label><br>
                            <a id="other_relevant_doc_download" target="_blank"><label id="other_relevant_doc_name_image_for_landallotment" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_landallotment" style="display: none;">
                            ...
                            <a id="seal_and_stamp_download" target="_blank"><img id="seal_and_stamp_name_image_for_landallotment" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <button type="button" class="btn btn-sm btn-danger" onclick="Landallotment.listview.loadLandallotmentData();"><i class="fas fa-times"></i>&nbsp; Close</button>
                    </div>
                </div>
            </form>
        </div>

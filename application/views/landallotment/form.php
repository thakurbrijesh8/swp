            ...
            <form role="form" id="landallotment_form" name="landallotment_form" onsubmit="return false;">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_landallotment" class="btn btn-sm btn-nic-blue" onclick="Landallotment.listview.submitLandallotment({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_landallotment" class="btn btn-sm btn-success" onclick="Landallotment.listview.askForSubmitLandallotment({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

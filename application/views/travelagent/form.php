                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="copy_of_registration_container_for_travelagent">
                            ...
                            <input type="file" id="copy_of_registration_for_travelagent" name="copy_of_registration_for_travelagent" class="spinner_container_for_travelagent_{{VALUE_ONE}}"
                                   accept="application/pdf" onchange="TravelAgent.listview.uploadDocumentForTravelAgent(VALUE_ONE);">
                        ...
                        <div class="form-group col-sm-12" id="copy_of_registration_name_container_for_travelagent" style="display: none;">
                            <label>7. Upload Copy of Registration of firm/company (Issued by Municipality or Concerned Panchayat). <span style="color: red;">* </span></label><br>
                            <a target="_blank" id="copy_of_registration_download"><label id="copy_of_registration_name_image_for_travelagent" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_travelagent_{{VALUE_ONE}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            <button type="button" id="copy_of_registration" class="btn btn-sm btn-danger spinner_name_container_for_travelagent_{{VALUE_ONE}}" style="vertical-align: top;"
                                    onclick="TravelAgent.listview.askForRemove('{{travelagent_data.travelagent_id}}', VALUE_ONE);">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_travelagent">
                            ...
                            <input type="file" id="seal_and_stamp_for_travelagent" name="seal_and_stamp_for_travelagent" class="spinner_container_for_travelagent_{{VALUE_TWO}}"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif" onchange="TravelAgent.listview.uploadDocumentForTravelAgent(VALUE_TWO);">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_travelagent" style="display: none;">
                            <label>8. Principal Employer Seal & Stamp <span style="color: red;">* </span></label><br>
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_travelagent" style="width: 250px; height: 250px; border: 2px solid blue;" class="spinner_name_container_for_travelagent_{{VALUE_TWO}}"></a>
                            <button type="button" id="seal_and_stamp" class="btn btn-sm btn-danger spinner_name_container_for_travelagent_{{VALUE_TWO}}" style="vertical-align: top;" 
                                    onclick="TravelAgent.listview.askForRemove('{{travelagent_data.travelagent_id}}', VALUE_TWO);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_travelagent" class="btn btn-sm btn-nic-blue" onclick="TravelAgent.listview.submitTravelAgent({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>

                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="copy_of_registration_name_container_for_travelagent" style="display: none;">
                            ...
                            <a target="_blank" id="copy_of_registration_download"><label id="copy_of_registration_name_image_for_travelagent" class="btn btn-sm btn-nic-blue f-w-n">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">

<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="TravelAgent.listview.newTravelAgentForm(false, {});">
                <i class="fas fa-plus"></i>&nbsp; Apply for New Travel Agent Registration
            </button>
        </h3>
    </div>
            ...
            <table id="travelagent_datatable" class="table table-bordered table-hover">
                <thead>
                    <tr class="bg-light-gray">
                        ...
                        <th class="text-center" style="min-width: 165px;">Area of Agency</th>

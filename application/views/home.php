            ...
            <div class="col-sm-6 col-md-4 mt-30">
                <div class="feature-box f-style-2 icon-grad h-100 pb-2">
                    ...
                    <div class="list-groupmbe-nur list-unstyled list-group-borderless">
                        ...
                        <a class="list-group-item list-group-item-action" href="<?php echo $base_url; ?>assets/pdf/FAQs_IPS_2022.pdf" target="_blank"><i class="fa fa-circle"></i> FAQs_IPS 2022</a>

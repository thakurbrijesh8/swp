            ...
            <div class="col-md-12">
                <div class="title text-left pb-0">
                    ...
                    <div class="list-group-number list-unstyled list-group-borderless">
                        ...
                        <a class="list-group-item list-group-item-action" href="<?php echo $base_url; ?>assets/pdf/FAQs_IPS_2022_12072024.pdf" target="_blank"><i class="fa fa-circle text-grad"></i> FAQs_IPS 2022</a>

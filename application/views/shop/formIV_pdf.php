<html>
    ...
    <body>
        ...
        <div style="font-size: 14px; text-align: right; margin-bottom: 5px;"><img src="<?php echo base_url(); ?>documents/shop/<?php echo $shop_data['s_sign_of_employer']; ?>" height="60px" width="90px"></div>

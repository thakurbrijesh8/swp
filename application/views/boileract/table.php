<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="BoilerAct.listview.askForNewBoilerActForm($(this));">
                <i class="fas fa-plus"></i>&nbsp; Apply for New Registration Boiler Act
            </button>
        </h3>
    </div>

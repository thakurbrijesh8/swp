    ...
    <body>
        ...
        <table class="CompanyDetails">
            ...
            <!-- <tr>
                ...
                <td class="third-column"><a href ="<?php //echo base_url(); ?>documents/boileract/<?php //echo $boileract_data['pipe_line_deawing']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column"><a href ="<?php //echo base_url(); ?>documents/boileract/<?php //echo $boileract_data['copy_of_challan']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column" style="height: 30px;">21</td>
                <td class="second-column">Upload IBR Documents</td>
                <td class="third-column"><a href ="<?php //echo base_url(); ?>documents/boileract/<?php //echo $boileract_data['ibr_document']; ?>" target="_blank"> View Document </a>
                </td>
            </tr> -->
    </table>
    <br />
    <table style="margin-left: 475px;">
        <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/boileract/<?php echo $boileract_data['sign_of_applicant']; ?>" height="100px" width="100px"></td></tr>
    </table>

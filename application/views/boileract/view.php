        ...
        <div class="card">
            ...
            <form role="form" id="boiler_act_form" name="boiler_act_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="company_letter_head_container_for_boileract">
                        ...
                        <div class="form-group col-sm-12" id="company_letter_head_name_container_for_boileract" style="display: none;">
                            <label>19.  Application on Company Letter head.</label><br>
                            <a id="company_letter_head_download" target="_blank"><label id="company_letter_head_name_image_for_boileract" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="copy_of_challan_container_for_boileract">
                        ...
                        <div class="form-group col-sm-12" id="copy_of_challan_name_container_for_boileract" style="display: none;">
                            <label>20.  Fees as per the schedule.</label><br>
                            <a id="copy_of_challan_download" target="_blank"><label id="copy_of_challan_name_image_for_boileract" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                   
                    <div class="row">
                        <div class="form-group col-sm-12" id="pipe_line_deawing_container_for_boileract">
                        ...
                        <div class="form-group col-sm-12" id="pipe_line_deawing_name_container_for_boileract" style="display: none;">
                            <label>21. Plans of Pipeline.</label><br>
                            <a id="pipe_line_deawing_download" target="_blank"><label id="pipe_line_deawing_name_image_for_boileract" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="ibr_document_container_for_boileract">
                        ...
                        <div class="form-group col-sm-12" id="ibr_document_name_container_for_boileract" style="display: none;">
                            <label>22. Original Document of Boiler.</label><br>
                            <a id="ibr_document_download" target="_blank"><label id="ibr_document_name_image_for_boileract" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 m-b-5px" id="sign_of_applicant_container_for_boileract">
                            <label>23. Signature of Applicant.</span></label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>
                        <div class="form-group col-sm-12" id="sign_of_applicant_name_container_for_boileract" style="display: none;">
                            ...
                            <a id="sign_of_applicant_download" target="_blank"><img id="sign_of_applicant_name_image_for_boileract" style="width: 250px; height: 250px; border: 2px solid black;"></a>
                        </div>
                    </div>

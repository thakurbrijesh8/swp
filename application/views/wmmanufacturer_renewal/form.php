            ...
            <form role="form" id="manufacturer_renewal_form" name="manufacturer_renewal_form" onsubmit="return false;">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_manufacturer" class="btn btn-sm btn-nic-blue" onclick="ManufacturerRenewal.listview.submitManufacturerRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>

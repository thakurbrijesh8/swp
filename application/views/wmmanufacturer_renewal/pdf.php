    ...
    <body>
        ...
        <table class="CompanyDetails">
            ...
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/manufacturer/<?php echo $manufacturer_renewal_data['monogram_uploader']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/manufacturer/<?php echo $manufacturer_renewal_data['signature']; ?>" height="100px" width="100px"></td></tr>
        </table>

...
<!-- Annexure-9 -->
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_inspection" class="btn btn-sm btn-nic-blue" onclick="Inspection.listview.submitInspection({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_inspection" class="btn btn-sm btn-success" onclick="Inspection.listview.askForSubmitInspection({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

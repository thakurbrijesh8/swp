            ...
            <form role="form" id="inspection_form" name="inspection_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="plinth_column" name="plinth_column" class="form-control" placeholder="Enter construction up to Plinth/column up to plinth level !"
                                       maxlength="200"  value="{{plinth_column}}" readonly="">
                            </div>
                     ...
                     <div class="row">                      
                        <div class="form-group col-sm-6">
                            <label>3. Permission/Licsencse Number vide dated issued by PDA <span class="color-nic-red">*</span></label>
                            <div class="input-group">
                                <input type="text" id="communication_number" name="communication_number" class="form-control" placeholder="Enter Plot No/column up to plinth level !" onblur="checkValidation('inspection', 'communication_number', CommunicationValidationMessage);"
                     ...
                     <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_licensed" name="name_licensed" class="form-control" placeholder="Enter Plot No/column up to plinth level !" onblur="checkValidation('inspection', 'name_licensed', LicensedNameValidationMessage);"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_no" name="registration_no" class="form-control" placeholder="Enter Plot No/column up to plinth level !" onblur="checkValidation('inspection', 'registration_no', RegistraNoValidationMessage);"
                                       maxlength="100"  value="{{registration_no}}" readonly="">
                            </div>
                            <span class="error-message error-message-inspection-registration_no"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>6. Licsence of (Architect/Engineer/Structural Engineer) Valid upto<span class="color-nic-red">*</span></label>
                ...
                <div class="row">
                        <div class="col-12 m-b-5px" id="signature_architecture_container_for_inspection">
                            ...
                            <div class="form-group col-sm-12" id="signature_architecture_name_container_for_transfer" style="display: none;">
                                <label>9.1 Authorized Signature <span style="color: red;">*</label><br>
                                <label class="f-w-n">Document Not Uploaded</label><br>
                            </div>
                            ...
                            <div class="form-group col-sm-12" id="signature_architecture_name_container_for_inspection" style="display: none;">
                                ...
                                <a id="signature_architecture_download" target="_blank">
                ...
                <h2 class="box-title f-w-b page-header color-nic-black f-s-20px m-b-0" style="text-align: left;">Document Required to be Uploaded with the Application</h2>    
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="annexure_9_container_for_inspection">
                            <label>13. Please Upload Annexure-9 Form for Notice for Commencement of work<span style="color: red;">*<a href="<?=base_url();?>documents/inspection/Form for Notice for Commencement of Work (Annexure_9).doc">(Download Format of Form for Notice for Commencement of Work (Annexure_9) )</a>  <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                        ...
                        <div class="form-group col-sm-6" id="annexure_9_name_container_for_inspection" style="display: none;">
                            <label>13.1. Upload Annexure-9 Form for Notice for Commencement of work<span style="color: red;">* <br></span></label><br>
                            <a id="annexure_9_download" target="_blank"><label id="annexure_9_name_image_for_inspection" class="btn btn-sm btn-nic-blue f-w-n">{{VIEW_UPLODED_DOCUMENT}}</label></a>
...
<!-- Annexure-9 -->
              ...
              <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="approved_license_container_for_inspection">
                            <label>14. Pleae Upload the Certified copy of construciton License and Approved Building Plan.<span style="color: red;">* <br></span></label><br>
                        ...
                        <div class="form-group col-sm-6" id="approved_license_name_container_for_inspection" style="display: none;">
                            <label>14.1. Upload the Certified copy of construciton License and Approved Building Plan.<span style="color: red;">* <br></span></label><br>
                            <a id="approved_license_download" target="_blank"><label id="approved_license_name_image_for_inspection" class="btn-nic-blue f-w-n" style="border: 2px solid black;padding: 4px 4px 4px 4px;">{{VIEW_UPLODED_DOCUMENT}}</label></a>

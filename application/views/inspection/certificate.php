...
<div style="font-size: 14px; text-align: center;word-spacing: 10px;">[Development Control Rules - 2005 fir Daman District]</div><br/> -->
...
<!-- <div style="font-size: 14px; text-align: center; margin-top: 20px;margin-left: 50px;word-spacing: 4px;"> With reference to your intimation no <label style="width: 50%"><?php echo $inspection_data['communication_number'] ?> </label> dated <?php echo $inspection_data['dated'] ?> regarding the completion</div>
<div style="font-size: 14px; text-align: center; margin-top: 10px;word-spacing: 4px;"> of construction work up to plinth/columns up to plinth level for Building for <?php echo $inspection_data['plinth_column'] ?> </div>
<div style="font-size: 14px; text-align: center; margin-top: 10px;word-spacing: 4px;">  purpose on/PlotNo.<?php echo $inspection_data['plot_no'] ?> of <?php echo $inspection_data['zone'] ?> zone situted at <?php echo $inspection_data['road'] ?> Road/Street  <?php echo $inspection_data['street'] ?> in <?php echo $inspection_data['industrial_area'] ?>.&emsp;I</div>
<div style="font-size: 14px; text-align: center; margin-top: 10px;word-spacing: 4px;"> have to inform that further work may be proceeded with as per sanctioned plans/shall </div>
<div style="font-size: 14px; text-align: center; margin-top: 10px;word-spacing: 4px;"> not be proceeded with as the construction up to plinth level is not as per sanctioned plans.</div> -->

        ...
        <div class="card">
            ...
            <form role="form" id="aplicence_renewal_form" name="aplicence_renewal_form" onsubmit="return false;">
                ...
                <div class="card-body p-b-0px">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="contractor_contact" name="contractor_contact" class="form-control" placeholder="Enter Contact No!"
                                       maxlength="10" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this)); checkValidation('aplicence-renewal', 'contractor_contact', contractorCcontactValidationMessage);" value="{{aplicence_renewal_data.contractor_contact}}">
                            </div>
                    ...
                    <h3 class="box-title f-w-b page-header color-nic-blue f-s-20px m-b-0">3. Particulars of Establishment or Establishments where contract labour is to be employed</h3>
                    <hr class="m-b-5px">
                    <div class="row">
                        <div class="form-group col-sm-6">
                    ...
                    <h3 class="box-title f-w-b page-header color-nic-blue f-s-20px m-b-0">6. Particulars of Establishment or Extablishments where contract labour is to be employed</h3>
                    <hr class="m-b-5px">
                    <div class="row">
                        <div class="form-group col-sm-6">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="register_certification_doc_container_for_aplicence_renewal">
                            ...
                            <input type="file" id="register_certification_doc_for_aplicence_renewal" name="register_certification_doc_for_aplicence_renewal"
                                   accept="application/pdf" class="spinner_container_for_aplicence_renewal_{{VALUE_THREE}}" onchange="AplicenceRenewal.listview.uploadDocumentForAplicenceRenewal(VALUE_THREE);">
                        ...
                        <div class="form-group col-sm-12" id="register_certification_doc_name_container_for_aplicence_renewal" style="display: none;">
                            ...
                            <a id="register_certification_doc_name_download" target="_blank"><label id="register_certification_doc_name_image_for_aplicence_renewal" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_aplicence_renewal_{{VALUE_THREE}}" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            <button type="button" id="register_certification_doc_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_aplicence_renewal_{{VALUE_THREE}}" style="vertical-align: top;"
                                    onclick="AplicenceRenewal.listview.askForRemove('{{aplicence_renewal_data.aplicence_renewal_id}}', VALUE_THREE);">
                    ...
                    <div class="row">
                        <div class="col-6 m-b-5px" id="seal_and_stamp_container_for_aplicence_renewal">
                            ...
                            <input type="file" id="seal_and_stamp_for_aplicence_renewal" name="seal_and_stamp_for_aplicence_renewal"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif" class="spinner_container_for_aplicence_renewal_{{VALUE_FOUR}}" onchange="AplicenceRenewal.listview.uploadDocumentForAplicenceRenewal(VALUE_FOUR);">
                        ...
                        <div class="form-group col-sm-6" id="seal_and_stamp_name_container_for_aplicence_renewal" style="display: none;">
                            ...
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_aplicence_renewal" class="spinner_name_container_for_aplicence_renewal_{{VALUE_FOUR}}" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                            <button type="button" id="seal_and_stamp_remove_btn" class="btn btn-sm btn-danger" style="vertical-align: top;"
                                    onclick="AplicenceRenewal.listview.askForRemove('{{aplicence_renewal_data.aplicence_renewal_id}}', VALUE_FOUR);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_aplicence" class="btn btn-sm btn-nic-blue" onclick="AplicenceRenewal.listview.submitAplicenceRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_aplicence" class="btn btn-sm btn-success" onclick="AplicenceRenewal.listview.askForSubmitAplicenceRenewal({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

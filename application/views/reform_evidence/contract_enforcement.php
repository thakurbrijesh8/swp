            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-left">
                        ...
                        <li class="breadcrumb-item">Contract Enforcement</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title text-left pb-0">
                    <h2 class="fs-30px text-grad">Contract Enforcement</h2>
                     <?php $this->load->view('departments_services/contract_enforcement'); ?>
                </div>
            </div>
        </div>
    </div>

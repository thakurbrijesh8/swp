<html>
    ...
    <body>
        ...
        <div style="font-size: 14px; text-align: left; margin-bottom: 25px;margin-top: 20px;margin-left: 50px;word-spacing: 9px;">Original Certificate is enclosed. </div>
        ...
        <br />
        <div style="font-size: 14px; text-align: right; margin-bottom: 5px;margin-right: 40px;"><img src="<?php echo base_url(); ?>documents/shop/<?php echo $shop_renewal_data['signature']; ?>" height="80px" width="80px"></div>
        ...
        <!--        <div style="font-size: 14px; text-align: right; margin-bottom: 5px;"><img src="<?php echo base_url(); ?>documents/shop/<?php echo $shop_renewal_data['signature']; ?>" height="80px" width="80px"></div>

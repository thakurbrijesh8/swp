                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_employees" name="total_employees" class="form-control" placeholder="Total Number of employees !" maxlength="100" value="{{shoprenewal_data.total_employees}}" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this)); checkValidation('shoprenewal', 'total_employees', totalTotalValidationMessage);">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_shoprenewal">
                            ...
                            <input type="file" id="seal_and_stamp_for_shoprenewal" name="seal_and_stamp_for_shoprenewal"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif" class="spinner_container_for_shoprenewal_{{VALUE_ONE}}" onchange="ShopRenewal.listview.uploadDocumentForShopRenewal(VALUE_ONE);">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_shoprenewal" style="display: none;">
                            ...
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_shoprenewal" style="width: 250px; height: 250px; border: 2px solid blue;" class="spinner_name_container_for_shoprenewal_{{VALUE_ONE}}"></a>
                            <button type="button" style="vertical-align: top;" id="seal_and_stamp_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_shoprenewal_{{VALUE_ONE}}"
                                    onclick="ShopRenewal.listview.askForRemove('{{shoprenewal_data.shop_renewal_id}}', VALUE_ONE);">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_shoprenewal" class="btn btn-sm btn-nic-blue" onclick="ShopRenewal.listview.submitShopRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_shoprenewal" class="btn btn-sm btn-success" onclick="ShopRenewal.listview.askForSubmitShopRenewal({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

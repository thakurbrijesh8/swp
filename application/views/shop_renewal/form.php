            ...
            <form role="form" id="shop_renewal_form" name="shop_renewal_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_shoprenewal" class="btn btn-sm btn-nic-blue" onclick="ShopRenewal.listview.submitShopRenewal({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>

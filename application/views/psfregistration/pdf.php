    ...
    <body>
        ...
        <table class="CompanyDetails">
            ...
            <tr>
                ...
                <td class="second-column">Complete Address of Principal place of Business:</td>
                <td class="third-column">
            ...
            <tr>
                ...
                <td class="second-column">Complete Address of The names of any other places Where the firm carries on Business:</td>
                <td class="third-column">
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/psfregistration/<?php echo $psfregistration_data['signature']; ?>" height="100px" width="100px"></td></tr>
        </table>

        ...
        <div class="card">
            ...
            <form role="form" id="psfregistration_form" name="psfregistration_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6 m-b-5px" id="application_of_firm_document_container_for_psfregistration">
                        ...
                        <div class="form-group col-sm-12" id="application_of_firm_document_name_container_for_psfregistration" style="display: none;">
                            ...
                            <a id="application_of_firm_document_download" target="_blank"><label id="application_of_firm_document_name_image_for_psfregistration" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                   <div class="row">
                        <div class="col-6 m-b-5px" id="formII_document_container_for_psfregistration">
                        ...
                        <div class="form-group col-sm-12" id="formII_document_name_container_for_psfregistration" style="display: none;">
                            ...
                            <a id="formII_document_download" target="_blank"><label id="formII_document_name_image_for_psfregistration" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-6 m-b-5px" id="partnership_deed_container_for_psfregistration">
                        ...
                        <div class="form-group col-sm-12" id="partnership_deed_name_container_for_psfregistration" style="display: none;">
                            <label>9. Attached Partnership Deed which shall be registed by Sub Register Office.</label><br>
                             <a id="partnership_deed_download" target="_blank"><label id="partnership_deed_name_image_for_psfregistration" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                    ...
                    <div class="row aadharcard_all_parties_div" style="display: none;">
                        <div class="col-6 m-b-5px" id="aadharcard_container_for_psfregistration">
                        ...
                        <div class="form-group col-sm-12" id="aadharcard_name_container_for_psfregistration" style="display: none;">
                            ...
                            <a id="aadharcard_download" target="_blank"><label id="aadharcard_name_image_for_psfregistration" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                      </div>
                     </div>
                    </div>
                    ...
                    <div class="row pancard_all_parties_div" style="display: none;">
                        <div class="col-6 m-b-5px" id="pancard_container_for_psfregistration">
                        ...
                        <div class="form-group col-sm-12" id="pancard_name_container_for_psfregistration" style="display: none;">
                            <label>11.1 Pancard of all Parties.</label><br>
                             <a id="pancard_download" target="_blank"><label id="pancard_name_image_for_psfregistration" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                        </div>
                      </div>
                     </div>
                    ...
                    <div class="row alteration_name_firm_div" style="display: none;">
                        <div class="col-6 m-b-5px" id="alteration_name_firm_doc_container_for_psfregistration">
                        ...
                        <div class="form-group col-sm-12" id="alteration_name_firm_doc_name_container_for_psfregistration" style="display: none;">
                            ...
                            <a id="alteration_name_firm_doc_download" target="_blank"><label id="alteration_name_firm_doc_name_image_for_psfregistration" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    </div>
                    </div>
                <div class="row">
                   <div class="form-group col-sm-12">
                    ...
                    <div class="row import_from_outside_ret_div" style="display: none;">
                        <div class="col-6 m-b-5px" id="retirement_form_container_for_psfregistration">
                        ...
                        <div class="form-group col-sm-12" id="retirement_form_name_container_for_psfregistration" style="display: none;">
                            ...
                            <a id="retirement_form_download" target="_blank"><label id="retirement_form_name_image_for_psfregistration" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                     </div>
                 </div> 
                 ...
                 <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_psfregistration">
                            <label>14. Signature <span style="color: red;"> (Maximum File Size: 1MB)</span></label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_psfregistration" style="display: none;">
                            ...
                            <a id="seal_and_stamp_download" target="_blank"><img id="seal_and_stamp_name_image_for_psfregistration" style="width: 250px; height: 250px; border: 2px solid black;"></a>
                        </div>
                    </div>


                    <div class="form-group">
                        <button type="button" class="btn btn-sm btn-danger" onclick="Psfregistration.listview.loadPsfregistrationData();"><i class="fas fa-times"></i>&nbsp; Close</button>
                    </div>
                </div>
            </form>
        </div>

                  ...
                  <!------------------------Form No.II------------------------------------------------------------> 
                   <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_psfregistration" class="btn btn-sm btn-nic-blue" onclick="Psfregistration.listview.submitPsfregistration({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>
                        <button type="button" id="submit_btn_for_psfregistration" class="btn btn-sm btn-success" onclick="Psfregistration.listview.askForSubmitPsfregistration({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

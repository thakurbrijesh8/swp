        ...
        <div class="card">
            ...
            <form role="form" id="filmshooting_form" name="filmshooting_form" onsubmit="return false;">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="email" name="email" class="form-control" placeholder="Enter E-Mail  !"
                                       maxlength="100" onkeypress="emailIdValidation($(this));" onblur="checkValidationForEmail('filmshooting', 'email', emailValidationMessage);" value="{{filmshooting_data.email}}">
                            </div>
                    ...
                    <!-- New COde drct upload -->
                      <div class="row">
                        <div class="form-group col-sm-12" id="declaration_container_for_filmshooting">
                            <label>13 .Negative Portrayal Of The U.T. of Dadra and Nagar Haveli & 
                            Daman and Diu in Any Manner Is Not Permitted And Will Not Be Allowed. Therefore The Producer/ Production Company May Submit A Declaration 
                            To This Effect<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                            
                            <input type="file" id="declaration_for_filmshooting" name="declaration_for_filmshooting"
                                   accept="application/pdf"
                                   class="spinner_container_for_filmshooting_{{VALUE_ONE}}"
                                   onchange="FilmShooting.listview.uploadDocumentForFilmShooting(VALUE_ONE);">
                       ...
                       <div class="form-group col-sm-6" id="declaration_name_container_for_filmshooting" style="display: none;">
                            <label>13 .1 .Negative Portrayal Of The U.T. of Dadra and Nagar Haveli & Daman and Diu in Any Manner Is Not Permitted And Will Not Be 
                            Allowed. Therefore The Producer/ Production Company May Submit A Declaration To This Effect<span style="color: red;">* 
                            <br></span></label><br>   
                            
                            <a target="_blank" id="declaration_download">
                            
                            <label id="declaration_name_image_for_filmshooting" 
                            class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_filmshooting_{{VALUE_ONE}}">
                            {{VIEW_UPLODED_DOCUMENT}}</label>
                            </a>
                            
                            <button type="button" id="declaration" class="btn btn-sm btn-danger spinner_name_container_for_filmshooting_{{VALUE_ONE}}" 
                            style="vertical-align: top;"
                                    onclick="FilmShooting.listview.askForRemove('{{filmshooting_data.filmshooting_id}}',VALUE_ONE);">
                    ...
                    <!-- end drct upload -->
                     <div class="row">
                        <div class="col-12 m-b-5px" id="producer_signature_container_for_filmshooting">
                            <label>14. Signed By The Producer (Of The Film)<span style="color: red;">*
                            <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <input type="file" id="producer_signature_for_filmshooting" name="producer_signature_for_filmshooting"
                                   ...
                                   class="spinner_container_for_filmshooting_{{VALUE_TWO}}" 
                                   onchange="FilmShooting.listview.uploadDocumentForFilmShooting(VALUE_TWO);">
                        ...
                        <div class="form-group col-sm-12" id="producer_signature_name_container_for_filmshooting" style="display: none;">
                            <label>14.1 Signed By The Producer (Of The Film)<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp;
                            (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                             ...
                             class="spinner_name_container_for_filmshooting_{{VALUE_TWO}}"></a>
                             
                            <button type="button" id="producer_signature" 
                            class="btn btn-sm btn-danger spinner_name_container_for_filmshooting_{{VALUE_TWO}}" style="vertical-align: top;"  
                            onclick="FilmShooting.listview.askForRemove('{{filmshooting_data.filmshooting_id}}',VALUE_TWO);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>                   
                    <div class="row">
                        <div class="col-12 m-b-5px" id="authorized_representative_sign_container_for_filmshooting">
                            <label>15. Signature Of Authorized Representative<span style="color: red;">* 
                            <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <input type="file" id="authorized_representative_sign_for_filmshooting" name="authorized_representative_sign_for_filmshooting"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif"
                                   class="spinner_container_for_filmshooting_{{VALUE_THREE}}" 
                                   onchange="FilmShooting.listview.uploadDocumentForFilmShooting(VALUE_THREE);">
                        ...
                        <div class="form-group col-sm-12" id="authorized_representative_sign_name_container_for_filmshooting" style="display: none;">
                            <label>15. Signature Of Authorized Representative<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp;
                            (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                             <a target="_blank" id="authorized_representative_sign_download">
                            <img id="authorized_representative_sign_name_image_for_filmshooting" style="width: 250px; height: 250px; border: 2px solid blue;"
                            class="spinner_name_container_for_filmshooting_{{VALUE_THREE}}"></a>
                            
                            <button type="button" id="authorized_representative_sign"
                            class="btn btn-sm btn-danger spinner_name_container_for_filmshooting_{{VALUE_THREE}}" style="vertical-align: top;" 
                            onclick="FilmShooting.listview.askForRemove('{{filmshooting_data.filmshooting_id}}',VALUE_THREE);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_of_company_container_for_filmshooting">
                            <label>16. Seal Of Company<span style="color: red;">*
                            <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <input type="file" id="seal_of_company_for_filmshooting" name="seal_of_company_for_filmshooting"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif"
                                   class="spinner_container_for_filmshooting_{{VALUE_FOUR}}" 
                                   onchange="FilmShooting.listview.uploadDocumentForFilmShooting(VALUE_FOUR);">
                        ...
                        <div class="form-group col-sm-12" id="seal_of_company_name_container_for_filmshooting" style="display: none;">
                            <label>16. Seal Of Company<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; 
                            (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            
                            <a target="_blank" id="seal_of_company_download">
                            <img id="seal_of_company_name_image_for_filmshooting" style="width: 250px; height: 250px; border: 2px solid blue;"
                            class="spinner_name_container_for_filmshooting_{{VALUE_FOUR}}"></a>
                            
                            <button type="button" id="seal_of_company" 
                             class="btn btn-sm btn-danger spinner_name_container_for_filmshooting_{{VALUE_FOUR}}" style="vertical-align: top;" 
                            onclick="FilmShooting.listview.askForRemove('{{filmshooting_data.filmshooting_id}}',VALUE_FOUR);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>                   
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            That l' have submitted an application and conditions on it is true and correct to the best of my lknowledge.  
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="witness_one_sign_container_for_filmshooting">
                            <label>Witness-1 Signature<span style="color: red;">* 
                            <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <input type="file" id="witness_one_sign_for_filmshooting" name="witness_one_sign_for_filmshooting"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif"
                                   class="spinner_container_for_filmshooting_{{VALUE_FIVE}}" 
                                   onchange="FilmShooting.listview.uploadDocumentForFilmShooting(VALUE_FIVE);">
                        ...
                        <div class="form-group col-sm-12" id="witness_one_sign_name_container_for_filmshooting" style="display: none;">
                            <label>Witness-1 Signature<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; 
                            (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            
                            <a target="_blank" id="witness_one_sign_download">
                            <img id="witness_one_sign_name_image_for_filmshooting" style="width: 250px; height: 250px; border: 2px solid blue;"
                             class="spinner_name_container_for_filmshooting_{{VALUE_FIVE}}"></a>
                             
                            <button type="button" id="witness_one_sign" 
                            class="btn btn-sm btn-danger spinner_name_container_for_filmshooting_{{VALUE_FIVE}}" style="vertical-align: top;"
                            onclick="FilmShooting.listview.askForRemove('{{filmshooting_data.filmshooting_id}}',VALUE_FIVE);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-12 m-b-5px" id="witness_two_sign_container_for_filmshooting">
                            <label>witness-2 Signature<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; 
                            (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <input type="file" id="witness_two_sign_for_filmshooting" name="witness_two_sign_for_filmshooting"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif"
                                   class="spinner_container_for_filmshooting_{{VALUE_SIX}}" 
                                   onchange="FilmShooting.listview.uploadDocumentForFilmShooting(VALUE_SIX);">
                        ...
                        <div class="form-group col-sm-12" id="witness_two_sign_name_container_for_filmshooting" style="display: none;">
                            <label>witness-2 Signature<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; 
                            (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <a target="_blank" id="witness_two_sign_download">
                            <img id="witness_two_sign_name_image_for_filmshooting" style="width: 250px; height: 250px; border: 2px solid blue;"
                            class="spinner_name_container_for_filmshooting_{{VALUE_SIX}}"></a>
                            
                            <button type="button" id="witness_two_sign"
                            class="btn btn-sm btn-danger spinner_name_container_for_filmshooting_{{VALUE_SIX}}" style="vertical-align: top;" 
                            onclick="FilmShooting.listview.askForRemove('{{filmshooting_data.filmshooting_id}}',VALUE_SIX);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_filmshooting" class="btn btn-sm btn-nic-blue" onclick="FilmShooting.listview.submitFilmShooting({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_filmshooting" class="btn btn-sm btn-success" onclick="FilmShooting.listview.askForSubmitFilmShooting({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

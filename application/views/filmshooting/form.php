            ...
            <form role="form" id="filmshooting_form" name="filmshooting_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_filmshooting" class="btn btn-sm btn-success" onclick="FilmShooting.listview.askForSubmitFilmShooting({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>

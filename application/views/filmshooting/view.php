...
<div class="card-body p-b-0px text-left" style="font-size: 13px; ">
    <div class="row">
        ...
        <div class="form-group col-sm-12" id="declaration_container_for_filmshooting">
            ...
            {{#if show_declaration}}
                <a target="_blank" href="documents/filmshooting/{{declaration}}">
                    ...
                    <td>
                        {{#if show_producer_signature}}
                            <img style="border: 2px solid blue; width: 160px; height: 180px;"
                                src="documents/filmshooting/{{producer_signature}}">
                        {{/if}}
                    </td>
                    <td>
                        {{#if show_authorized_representative_sign}}
                            <img style="border: 2px solid blue; width: 160px; height: 180px;"
                                src="documents/filmshooting/{{authorized_representative_sign}}">
                        {{/if}}
                    </td>
                    <td>
                        {{#if show_seal_of_company}}
                            <img style="border: 2px solid blue; width: 160px; height: 180px;"
                                src="documents/filmshooting/{{seal_of_company}}">
                        {{/if}}
                    </td>
                </tr>
            </table>
                    ...
                    <tr>
                        <td class="text-left">
                            {{#if show_witness_one_sign}}
                                <img style="border: 2px solid blue; width: 160px; height: 180px;"
                                    src="documents/filmshooting/{{witness_one_sign}}">
                            {{/if}}
                        </td>
                        <td class="text-left">
                            {{#if show_witness_two_sign}}
                                <img style="border: 2px solid blue; width: 160px; height: 180px;"
                                    src="documents/filmshooting/{{witness_two_sign}}">
                            {{/if}}
                        </td>
                    </tr>
                </tbody>

                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="declaration_container_for_filmshooting">
                            ...
                            A Declaration To This Effect<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                        ...
                        <div class="form-group col-sm-6" id="declaration_name_container_for_filmshooting" style="display: none;">
                            ...
                            <a target="_blank" id="declaration_download"><label id="declaration_name_image_for_filmshooting"
                            class="btn btn-sm btn-nic-blue f-w-n">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <!-- drct end -->
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="producer_signature_name_container_for_filmshooting" style="display: none;">
                            <label>14. Signed By The Producer (Of The Film)<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                             <a target="_blank" id="producer_signature_download"><img id="producer_signature_name_image_for_filmshooting" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>
                    <div class="row">

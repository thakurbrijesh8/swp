    ...
    <body>
        ...
        <table class="CompanyDetails">
            ...
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php echo base_url(); ?>documents/filmshooting/<?php echo $filmshooting_data['declaration']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <img src="<?php echo base_url(); ?>documents/filmshooting/<?php echo $filmshooting_data['producer_signature']; ?>" height="100px" width="100px">
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <img src="<?php echo base_url(); ?>documents/filmshooting/<?php echo $filmshooting_data['authorized_representative_sign']; ?>" height="100px" width="100px">
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <img src="<?php echo base_url(); ?>documents/filmshooting/<?php echo $filmshooting_data['seal_of_company']; ?>" height="100px" width="100px">
                </td>
            </tr>
        </table>
        <br />
        ...
        <table>
            <tr>
                <td class="border-none"><img src="<?php echo base_url(); ?>documents/filmshooting/<?php echo  $filmshooting_data['witness_one_sign']; ?>" height="60px" width="90px"></td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                <td class="border-none"><img src="<?php echo base_url(); ?>documents/filmshooting/<?php echo  $filmshooting_data['witness_two_sign']; ?>" height="60px" width="90px"></td>
            </tr>
        </table>
        <table style="margin-top: 0px;word-spacing: 2px;">

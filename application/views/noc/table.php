<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="Noc.listview.newNocForm(false, {});">Apply for NOC for Mortgage</button>
        </h3>
    </div>
            ...
            <table id="noc_datatable" class="table table-bordered table-hover">
                <thead>
                    <tr class="bg-light-gray">
                        ...
                        <th class="text-center" style="min-width: 165px;">Survey No</th>
                        <th class="text-center" style="min-width: 165px;">Government Industrial Estate</th>

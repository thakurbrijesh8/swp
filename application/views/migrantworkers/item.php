...
<tr id="migrant_contractor_workers_name_id_{{item_cnt}}" style="background-color: #fff;">
    ...
    <td><label>Maximum No. of migrant workman to be employed on any day through each contractor<span style="color: red;">*</span></label>
        <input type="text" id="migrant_contractor_maximum_no_of_workers_{{item_cnt}}" name="migrant_contractor_maximum_no_of_workers" placeholder="Maximum No. of Workers !"
               class="form-control" maxlength="5" onkeyup="checkNumeric($(this));" 
               onblur="checkNumeric($(this)); checkValidation('migrantworkers', 'migrant_contractor_maximum_no_of_workers_{{item_cnt}}', contractorLabourValidationMessage);" value="{{mc_maximum_no_of_workers}}">

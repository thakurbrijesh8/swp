<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h1 class="m-0 text-dark"></i> Registration Certificate of "Establishment Inter State Migrant Workmen (RE&CS) Act, 1979 (License of Contractor Establishment)"</h1>
            </div>
            <div class="col-sm-12">
...
<section class="content">
    <div class="container-fluid" id="migrantworkers_form_and_table_container">
    </div>
</section>

        ...
        <div class="card">
            <form method="post" id="migrantworkers_form" autocomplete="off" class="m-t-15">
                ...
                <div class="card-body">
                    ...
                    <div class="row migrantworkers_hidden" style="display: none;">
                        <div class="col-sm-6 form-group">
                            <label>Establishment Challan No.<span style="color: red;">*</span></label>
                            <input type="text" name="challan_no_for_migrantworkers_registration" id="challan_no_for_migrantworkers_registration" class="form-control" value="{{migrantworkers_data.mw_challan_no}}"
                                   onblur="checkValidation('migrantworkers', 'challan_no_for_migrantworkers_registration', establishmentChallanNoValidationMessage);" placeholder="Establishment Challan No." readonly="">
                            <span class="error-message error-message-migrantworkers-challan_no_for_migrantworkers_registration"></span>
                        </div>
                        <div class="col-sm-6 form-group">
                            <label>Establishment Challan Date<span style="color: red;">*</span></label>
                            <div class="input-group date date_picker">
                                <input type="text" name="challan_date_for_migrantworkers_registration" id="challan_date_for_migrantworkers_registration" class="form-control" data-date-format="DD-MM-YYYY" placeholder="DD-MM-YYYY"
                                       onblur="checkValidation('migrantworkers', 'challan_date_for_migrantworkers_registration', establishmentChallanDateValidationMessage);" value="{{migrantworkers_data.mw_challan_date}}" readonly="">
                    ...
                    <div class="row migrantworkers_hidden" style="display: none;">
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" id="registration_no_for_migrantworkers_registration" name="registration_no_for_migrantworkers_registration" class="form-control" placeholder="Establishment Registration No. !"
                                   maxlength="50" onblur="checkValidation('migrantworkers', 'registration_no_for_migrantworkers_registration', establishmentRegistrationNoValidationMessage);" value="{{migrantworkers_data.mw_registration_no}}">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="input-group date date_picker">
                                <input type="text" id="cerificate_expiry_date_for_migrantworkers_registration" name="cerificate_expiry_date_for_migrantworkers_registration" class="form-control" placeholder="DD-MM-YYYY" data-date-format="DD-MM-YYYY"
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_migrantworkers">
                            <label>13. Upload Principal Employer Seal & Stamp <span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <input type="file" id="seal_and_stamp_for_migrantworkers" name="seal_and_stamp_for_migrantworkers"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif" class="spinner_container_for_migrantworkers_{{VALUE_ONE}}" onchange="MigrantWorkers.listview.uploadDocumentForMigrantWorkers(VALUE_ONE);">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_migrantworkers" style="display: none;">
                            ...
                            <img id="seal_and_stamp_name_image_for_migrantworkers" style="width: 250px; height: 250px; border: 2px solid blue;" class="spinner_name_container_for_migrantworkers_{{VALUE_ONE}}">
                            <button type="button" class="btn btn-sm btn-danger spinner_name_container_for_migrantworkers_{{VALUE_ONE}}" style="vertical-align: top;"
                                    onclick="MigrantWorkers.listview.askForRemove('{{migrantworkers_data.mw_id}}',VALUE_ONE);">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="declaration_for_migrantworkers_registration" name="declaration_for_migrantworkers_registration" value="{{is_checked}}">
                                <label class="form-check-label" for="declaration_for_migrantworkers_registration">
                            ...
                            <span class="error-message error-message-migrantworkers-declaration_for_migrantworkers_registration"></span>
                        </div>
                    </div>
                    <hr class="m-b-1rem">
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_migrantworkers" class="btn btn-sm btn-nic-blue" onclick="MigrantWorkers.listview.askForSubmitMigrantworkers('{{VALUE_ONE}}');" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>
                        <button type="button" id="draft_btn_for_migrantworkers" class="btn btn-sm btn-success" onclick="MigrantWorkers.listview.askForSubmitMigrantworkers('{{VALUE_TWO}}');"  style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

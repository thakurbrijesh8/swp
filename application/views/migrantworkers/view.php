                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="declaration_for_migrantworkers_registration" name="declaration_for_migrantworkers_registration" value="{{is_checked}}" disabled>

<div class="card">
    <div class="card-header">
        ...
        <div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;">APPLICATION FOR REGISTRATION / RENEWAL OF ESTABLISHMENTS EMPLOYING CONTRACT LABOUR</div>
    </div>
        ...
        <div class="card-body p-b-0px">
            ...
            <div class="row">
                <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_clact">
                    <label>15. Upload Principal Employer Seal & Stamp <span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                    <input type="file" id="seal_and_stamp_for_clact" name="seal_and_stamp_for_clact"
                           accept="image/jpg,image/png,image/jpeg,image/jfif" class="spinner_container_for_clact_{{VALUE_ONE}}" onchange="CLACT.listview.uploadDocumentForCLACT(VALUE_ONE);" >
                ...
                <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_clact" style="display: none;">
                    <label>15. Principal Employer Seal & Stamp <span style="color: red;">*</span></label><br>
                    <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_clact" style="width: 250px; height: 250px; border: 2px solid blue;" class="spinner_name_container_for_clact_{{VALUE_ONE}}"></a>
                    <button type="button" id="seal_and_stamp_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_clact_{{VALUE_ONE}}" style="vertical-align: top;" onclick="CLACT.listview.askForRemove('{{establishment_id}}', VALUE_ONE);">
            ...
            <div class="form-group">
                <button type="button" id="draft_btn_for_clact" class="btn btn-sm btn-nic-blue" onclick="CLACT.listview.submitCLACT({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>
                <button type="button" id="submit_btn_for_clact" class="btn btn-sm btn-success" onclick="CLACT.listview.askForSubmitCLACT({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>
                <button type="button" class="btn btn-sm btn-danger" onclick="CLACT.listview.loadCLACTData();"><i class="fas fa-times"></i>&nbsp; Close</button>
            </div>
        </div>
    </form>
</div>
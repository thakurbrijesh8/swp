<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="VC.listview.newVCForm(false, {});">Apply for New Verification Certificate</button>
        </h3>
    </div>
            ...
            <table id="vc_datatable" class="table table-bordered table-hover">
                <thead>
                    <tr class="bg-light-gray">
                        ...
                        <th class="text-center" style="min-width: 165px;">Model No</th>
                        <th class="text-center" style="min-width: 165px;">Serial No</th>

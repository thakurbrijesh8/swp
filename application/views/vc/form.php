                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="invoice_doc_container">
                            ...
                            <input type="file" id="invoice_doc" name="invoice_doc"
                                   accept="application/pdf" class="spinner_container_for_vc_{{VALUE_ONE}}" onchange="VC.listview.uploadDocumentForVC(VALUE_ONE);">
                        ...
                        <div class="form-group col-sm-12" id="invoice_doc_name_container" style="display: none;">
                            ...
                            <button type="button" id="invoice_doc_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_vc_{{VALUE_ONE}}" style="vertical-align: top;"
                                    onclick="VC.listview.askForRemove('{{vc_data.vc_id}}', VALUE_ONE);">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_vc" class="btn btn-sm btn-nic-blue" onclick="VC.listview.submitVC({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>
                        <button type="button" id="submit_btn_for_vc" class="btn btn-sm btn-success" onclick="VC.listview.askForSubmitVC({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

            ...
            <form role="form" id="vc_form" name="vc_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_vc" class="btn btn-sm btn-nic-blue" onclick="VC.listview.submitVC({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>
                        <button type="button" id="submit_btn_for_vc" class="btn btn-sm btn-success" onclick="VC.listview.askForSubmitVC({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>

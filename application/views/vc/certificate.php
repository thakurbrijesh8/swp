<?php
$barcode_number = generate_barcode_number(VALUE_FOURTYEIGHT, $vc_data['vc_id']);
...
<div style="font-size: 14px;text-align: center;margin-bottom:  7px;margin-top: 150px;margin-left: 505px;word-spacing: 1px;"><img src="<?php echo base_url(); ?>documents/vc/<?php echo $vc_data['signature']; ?>" height="80px" width="80px"></div>

<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="Wmregistration.listview.newWmregistrationForm(false, {});">Apply for  Registration under "Weights & Measure"</button>
        </h3>
    </div>

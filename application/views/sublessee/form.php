             ...
             <div class="row">
                ...
                <div class="col-12 m-b-5px" id="behalf_sign_sublessee_container_for_sublessee">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_sublessee" class="btn btn-sm btn-nic-blue" onclick="Sublessee.listview.submitSublessee({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>
                        <button type="button" id="submit_btn_for_sublessee" class="btn btn-sm btn-success" onclick="Sublessee.listview.askForSubmitSublessee({{VALUE_TWO}});" style="margin-right: 5px;">Submit Application</button>

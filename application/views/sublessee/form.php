                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select id="entity_establishment_type" name="entity_establishment_type" class="form-control select2"
                                        data-placeholder="Select Entity / Establishment Type" style="width: 100%;" onblur="checkValidation('sublessee', 'entity_establishment_type', entityEstablishmentTypeValidationMessage);">
                                </select>
                            </div>
                            <span class="error-message error-message-sublessee-entity_establishment_type"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="villages_for_noc_data" name="villages_for_noc_data"
                                        data-placeholder="Status !"  onchange="checkValidation('sublessee', 'villages_for_noc_data', villageNameValidationMessage);
                                            getPlotData($(this), 'plot_no', 'sublessee_data');">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control select2" id="plot_no_for_sublessee_data" name="plot_no_for_sublessee_data"
                                        data-placeholder="Plot No. !" onchange="checkValidation('sublessee', 'plot_no_for_sublessee_data', plotnoValidationMessage);
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="govt_industrial_estate_area" name="govt_industrial_estate_area" class="form-control" placeholder="Enter admeasuring in square meter!"  maxlength="100" value="{{sublessee_data.govt_industrial_estate_area}}" readonly="">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="admeasuring" name="admeasuring" class="form-control" placeholder=" Enter Government Industrial Estate !" maxlength="100" value="{{sublessee_data.admeasuring}}" onblur="checkValidation('sublessee', 'admeasuring', admeasuringValidationMessage);">
                            </div>
                        ...
                        <div class=" request_letter_div" style="display: none;">
                            <div class="form-group col-sm-12" id="request_letter_manufacture_container_for_sublessee" >
                                ...
                                <input type="file" id="request_letter_manufacture_for_sublessee" name="request_letter_manufacture_for_sublessee"
                                       accept="application/pdf" class="spinner_container_for_sublessee_{{VALUE_ONE}}" onchange="Sublessee.listview.uploadDocumentForSublessee(VALUE_ONE);">
                            ...
                            <div class="form-group col-sm-12" id="request_letter_manufacture_name_container_for_sublessee" style="display: none;">
                                ...
                                <a target="_blank" id="request_letter_manufacture_download"><label id="request_letter_manufacture_name_image_for_sublessee" style="border: 2px solid black;" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_sublessee_{{VALUE_ONE}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="request_letter_manufacture_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_sublessee_{{VALUE_ONE}}" style="vertical-align: top;"
                                        onclick="Sublessee.listview.askForRemove('{{sublessee_data.sublessee_id}}', VALUE_ONE);">
                    ...
                    <div class="row">
                        ...
                        <div class=" detail_project_div" style="display: none;">
                            <div class="col-12 m-b-5px" id="detail_project_report_container_for_sublessee" >
                                ...
                                <input type="file" id="detail_project_report_for_sublessee" name="detail_project_report_for_sublessee"
                                       accept="application/pdf" class="spinner_container_for_sublessee_{{VALUE_TWO}}" onchange="Sublessee.listview.uploadDocumentForSublessee(VALUE_TWO);">
                            ...
                            <div class="form-group col-sm-12" id="detail_project_report_name_container_for_sublessee" style="display: none;">
                                ...
                                <a target="_blank" id="detail_project_report_download"><label id="detail_project_report_name_image_for_sublessee" style="border: 2px solid black;" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_sublessee_{{VALUE_TWO}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="detail_project_report_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_sublessee_{{VALUE_TWO}}" style="vertical-align: top;"
                                        onclick="Sublessee.listview.askForRemove('{{sublessee_data.sublessee_id}}', VALUE_TWO);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" partnership_deed_div" style="display: none;">
                            <div class="col-12 m-b-5px" id="memorandum_partnership_deed_container_for_sublessee" >
                                ...
                                <input type="file" id="memorandum_partnership_deed_for_sublessee" name="memorandum_partnership_deed_for_sublessee"
                                       accept="application/pdf" class="spinner_container_for_sublessee_{{VALUE_THREE}}" onchange="Sublessee.listview.uploadDocumentForSublessee(VALUE_THREE);">
                            ...
                            <div class="form-group col-sm-12" id="memorandum_partnership_deed_name_container_for_sublessee" style="display: none;">
                                ...
                                <a target="_blank" id="memorandum_partnership_deed_download"><label id="memorandum_partnership_deed_name_image_for_sublessee" style="border: 2px solid black;" class="btn btn-sm btn-nic-blue f-w-n spinner_name_container_for_sublessee_{{VALUE_THREE}}">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                                <button type="button" id="memorandum_partnership_deed_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_sublessee_{{VALUE_THREE}}" style="vertical-align: top;"
                                        onclick="Sublessee.listview.askForRemove('{{sublessee_data.sublessee_id}}', VALUE_THREE);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" sign_sublessee_div" style="display: none;">
                            <div class="col-12 m-b-5px" id="behalf_sign_sublessee_container_for_sublessee">
                                ...
                                <input type="file" id="behalf_sign_sublessee_for_sublessee" name="behalf_sign_sublessee_for_sublessee"
                                       accept="image/jpg,image/png,image/jpeg,image/jfif" class="spinner_container_for_sublessee_{{VALUE_FOUR}}" onchange="Sublessee.listview.uploadDocumentForSublessee(VALUE_FOUR);">
                            ...
                            <div class="form-group col-sm-12" id="behalf_sign_sublessee_name_container_for_sublessee" style="display: none;">
                                ...
                                <a target="_blank" id="behalf_sign_sublessee_download"><img id="behalf_sign_sublessee_name_image_for_sublessee" class="spinner_name_container_for_sublessee_{{VALUE_FOUR}}" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                                <button type="button" id="behalf_sign_sublessee_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_sublessee_{{VALUE_FOUR}}" style="vertical-align: top;"
                                        onclick="Sublessee.listview.askForRemove('{{sublessee_data.sublessee_id}}', VALUE_FOUR);">
                                    <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_sublessee">
                            ...
                            <input type="file" id="seal_and_stamp_for_sublessee" name="seal_and_stamp_for_sublessee"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif" class="spinner_container_for_sublessee_{{VALUE_FIVE}}" onchange="Sublessee.listview.uploadDocumentForSublessee(VALUE_FIVE);">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_sublessee" style="display: none;">
                            ...
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_sublessee" class="spinner_name_container_for_sublessee_{{VALUE_FIVE}}" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                            <button type="button" id="seal_and_stamp_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_sublessee_{{VALUE_FIVE}}" style="vertical-align: top;"
                                    onclick="Sublessee.listview.askForRemove('{{sublessee_data.sublessee_id}}', VALUE_FIVE);">
                                <i class="fas fa-trash" style="padding-right: 4px;"></i> Remove</button>
                        </div>
                    </div>
                    <hr class="m-b-1rem"> 
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_sublessee" class="btn btn-sm btn-nic-blue" onclick="Sublessee.listview.submitSublessee({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>
                        <button type="button" id="submit_btn_for_sublessee" class="btn btn-sm btn-success" onclick="Sublessee.listview.askForSubmitSublessee({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

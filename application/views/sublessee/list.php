<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-8">
                <h1 class="m-0 text-dark"><i class="nav-icon fa fa-buildings"></i>Permission for sub-letting of premises on Plot For Sub-Lessee</h1>
            </div>
            <div class="col-sm-4">
...
<section class="content">
    <div class="container-fluid" id="sublessee_form_and_datatable_container">
    </div>
</section>

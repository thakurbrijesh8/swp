    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title" style="float: none; text-align: center;">Sub-letting of Sub-Lessee</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 m-b-5px" id="request_letter_manufacture_container_for_sublessee">
                            <label>12.1 Detail of manufacture item 
                                <label class="f-w-n">Document Not Uploaded</label><br>
                                <div class="error-message error-message-sublessee-application_form_for_sublessee"></div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 m-b-5px" id="memorandum_partnership_deed_container_for_sublessee">
                            <label>14.1  Memorandum and Article Association/Partnership Deed. 
                                <label class="f-w-n">Document Not Uploaded</label><br>
                                <div class="error-message error-message-sublessee-application_form_for_sublessee"></div>
                        </div>

                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_travelagentrenewal">
                            ...
                            <input type="file" id="seal_and_stamp_for_travelagentrenewal" name="seal_and_stamp_for_travelagentrenewal" class="spinner_container_for_travelagentrenewal_{{VALUE_ONE}}"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif" onchange="TravelagentRenewal.listview.uploadDocumentForTravelagentRenewal(VALUE_ONE);">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_travelagentrenewal" style="display: none;">
                            ...
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_travelagentrenewal" style="width: 250px; height: 250px; border: 2px solid blue;" class="spinner_name_container_for_travelagentrenewal_{{VALUE_ONE}}"></a>
                            <button type="button" id="seal_and_stamp_remove_btn" class="btn btn-sm btn-danger spinner_name_container_for_travelagentrenewal_{{VALUE_ONE}}" style="vertical-align: top;"
                                    onclick="TravelagentRenewal.listview.askForRemove('{{travelagentrenewal_data.travelagent_renewal_id}}', VALUE_ONE);">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_travelagentrenewal" class="btn btn-sm btn-nic-blue" onclick="TravelagentRenewal.listview.submitTravelagentRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as a Draft</button>
                        <button type="button" id="submit_btn_for_travelagentrenewal" class="btn btn-sm btn-success" onclick="TravelagentRenewal.listview.askForSubmitTravelagentRenewal({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i>&nbsp; Submit Application</button>

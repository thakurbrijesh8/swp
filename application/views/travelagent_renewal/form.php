            ...
            <form role="form" id="travelagent_renewal_form" name="travelagent_renewal_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_travelagentrenewal" class="btn btn-sm btn-nic-blue" onclick="TravelagentRenewal.listview.submitTravelagentRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-download"></i>&nbsp; Save as Draft</button>

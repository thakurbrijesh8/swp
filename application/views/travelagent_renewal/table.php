<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="TravelagentRenewal.listview.newTravelagentRenewalForm(false, {});">Apply for License for Travel Agent - Renewal</button>
        </h3>
    </div>

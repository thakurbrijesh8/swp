...
<script id="query_answer_template" type="text/x-handlebars-template">
<?php $this->load->view('query/answer'); ?>
</script>
...
<script id="approval_radio_template" type="text/x-handlebars-template">
<?php $this->load->view('approvals/radio'); ?>
</script>
<script id="approval_form_template" type="text/x-handlebars-template">
<?php $this->load->view('approvals/form'); ?>
</script>
<script id="approval_clearance_template" type="text/x-handlebars-template">
<?php $this->load->view('approvals/clearance'); ?>
</script>
<script id="approval_clearance_row_template" type="text/x-handlebars-template">
<?php $this->load->view('approvals/clearance_row'); ?>
</script>
<script id="approval_basic_details_template" type="text/x-handlebars-template">
<?php $this->load->view('approvals/basic_details'); ?>
</script>
...
<script type="text/x-handlebars-template" id="m_doc_item_template">
<?php $this->load->view('common/m_doc_item'); ?>
</script>
<script type="text/x-handlebars-template" id="m_doc_item_view_template">
<?php $this->load->view('common/m_doc_item_view'); ?>
</script>
<script type="text/x-handlebars-template" id="m_ref_doc_list_template">
<?php $this->load->view('common/m_ref_doc_list'); ?>
</script>
<script type="text/x-handlebars-template" id="m_ref_doc_item_template">
<?php $this->load->view('common/m_ref_doc_item'); ?>
</script>
<script type="text/x-handlebars-template" id="m_other_doc_list_template">
<?php $this->load->view('common/m_other_doc_list'); ?>
</script>
<script type="text/x-handlebars-template" id="m_other_doc_item_template">
<?php $this->load->view('common/m_other_doc_item'); ?>
</script>

<script type="text/javascript">
    ...
    var OTPValidationMessage = '<?php echo OTP_MESSAGE; ?>';
    var incorrectOTPValidationMessage = '<?php echo INCORRECT_OTP_MESSAGE; ?>';
    ...
    var selectDistrictValidationMessage = '<?php echo SELECT_DISTRICT; ?>';
    ...
    //Enterprise Module
    var enterpriseNameValidationMessage = '<?php echo ENTERPRISE_NAME_MESSAGE; ?>';
    var cityTownValidationMessage = '<?php echo CITY_TOWN_MESSAGE; ?>';
    var mainProductValidationMessage = '<?php echo MAIN_PRODUCT_MESSAGE; ?>';
    var rowMaterialValidationMessage = '<?php echo ROW_MATERIAL_MESSAGE; ?>';
    ...
    var panCardValidationMessage = '<?php echo PAN_NO_MESSAGE; ?>';
    ...
    var requestletterpremisesValidationMessage = '<?php echo REQUEST_LETTER_PREMISES_MESSAGE; ?>';
    var originalextractValidationMessage = '<?php echo ORIGINAL_EXTRACT_MESSAGE; ?>';
    var landrevenueValidationMessage = '<?php echo LAND_REVENUE_MESSAGE; ?>';
    var electricitybillValidationMessage = '<?php echo ELECTRICITY_BILL_MESSAGE; ?>';
    var bankloanValidationMessage = '<?php echo BANK_LOAN_MESSAGE; ?>';
    var panchyattaxValidationMessage = '<?php echo PANCHAYAT_TAX_MESSAGE; ?>';
    var challanofleaserentValidationMessage = '<?php echo CHALLAN_OF_LEASE_MESSAGE; ?>';
    var occupancyValidationMessage = '<?php echo OCCUPANCY_MESSAGE; ?>';
    var centralexciseValidationMessage = '<?php echo CENTRAL_EXCISE_MESSAGE; ?>';
    var authorizationsignValidationMessage = '<?php echo AUTHORIZATION_SIGN_MESSAGE; ?>';
    var authorizationsignValidationMessage = '<?php echo AUTHORIZATION_SIGN_MESSAGE; ?>';
    ...
    var sublesseesignValidationMessage = '<?php echo SUBLESSE_SIGN_MESSAGE; ?>';
    ...
    var ownerAddressValidationMessage = '<?php echo OWNER_ADDRESS_MESSAGE; ?>';
    ...
    //  Inspection
    var FullAddressValidationMessage = '<?php echo fULL_ADDRESS_MESSAGE; ?>';
    var plinthcolumnValidationMessage = '<?php echo plinth_column_MESSAGE; ?>';
    var PlotNoValidationMessage = '<?php echo PLOT_no_MESSAGE; ?>';
    var zoneValidationMessage = '<?php echo ZONE_MSG; ?>';
    var RoadValidationMessage = '<?php echo ROAD_MESSAGE; ?>';
    var StreetValidationMessage = '<?php echo STREET_MESSAGE; ?>';
    var IndustrialNameValidationMessage = '<?php echo INDUSTRIAL_AREA_MESSAGE; ?>';
    var CommunicationValidationMessage = '<?php echo COMMUNICATION_MESSAGE; ?>';
    var LicensedNameValidationMessage = '<?php echo Licensed_NAME_MESSAGE; ?>';
    var RegistraNoValidationMessage = '<?php echo REGISTRATION_Number_MESSAGE; ?>';
    var signaturearchitectureValidationMessage = '<?php echo SIGNATURE_ARCHI_MESSAGE; ?>';
    var OwnerDistrictValidationMessage = '<?php echo OWNER_DisTRICT_MESSAGE; ?>';
    ...
    var feePaidAmountValidationMessage = '<?php echo FEE_PAID_AMOUNT_MESSAGE; ?>';
    var receiptNumberValidationMessage = '<?php echo RECEIPT_NUMBER_MESSAGE; ?>';
    var receiptDateValidationMessage = '<?php echo RECEIPT_DATE_MESSAGE; ?>';

    //Application of Licence Renewal
    var expiryDateValidationMessage = '<?php echo EXPIRY_DATE_MESSAGE; ?>';
    var licenceStatusValidationMessage = '<?php echo LICENCE_STATUS_MESSAGE; ?>';

    // Survey Module / Industry Profile
    var companyNameValidationMessage = '<?php echo COMPANY_NAME_MESSAGE; ?>';
    var companyAddressValidationMessage = '<?php echo COMPANY_ADDRESS_MESSAGE; ?>';
    var entrepreneurNameValidationMessage = '<?php echo ENTREPRENEUR_NAME_MESSAGE; ?>';
    var eStateNameValidationMessage = '<?php echo ESTATE_NAME_MESSAGE; ?>';
    var udyogAadharMemorandumValidationMessage = '<?php echo UDYOG_AADHAR_MEMORANDUM_MESSAGE; ?>';
    var enterPANValidationMessage = '<?php echo ENTER_PAN_MESSAGE; ?>';
    var invalidPANValidationMessage = '<?php echo INVALID_PAN_MESSAGE; ?>';
    var officialAddressValidationMessage = '<?php echo OFFICIAL_ADDRESS_MESSAGE; ?>';
    var amountValidationMessage = '<?php echo AMOUNT_MESSAGE; ?>';
    var turnoverValidationMessage = '<?php echo TURNOVER_MESSAGE; ?>';
    var employmentValidationMessage = '<?php echo EMPLOYMENT_MESSAGE; ?>';
    var noOfEmpValidationMessage = '<?php echo NO_OF_EMP_MESSAGE; ?>';
    var rawMaterialValidationMessage = '<?php echo RAW_MATERIAL_MESSAGE; ?>';
    var majorProductValidationMessage = '<?php echo MAJOR_PRODUCT_MESSAGE; ?>';
    var industrialProductValidationMessage = '<?php echo INDUSTRIAL_PRODUCT_MESSAGE; ?>';
    var pastYearTurnOverValidationMessage = '<?php echo PAST_YEAR_TURNOVER_MESSAGE; ?>';
    var yearValidationMessage = '<?php echo YEAR_MESSAGE; ?>';
    var gstinNumberValidationMessage = '<?php echo GSTIN_NUMBER_MESSAGE; ?>';
    var fireSafteyMeasuresValidationMessage = '<?php echo FIRE_SAFTEY_MEASURES_MESSAGE; ?>';
    var firstAidAppliancesValidationMessage = '<?php echo FIRST_AID_APPLIANCES_MESSAGE; ?>';
    var safteyMeasuresValidationMessage = '<?php echo SAFTEY_MEASURES_MESSAGE; ?>';
    var pollutionControlValidationMessage = '<?php echo POLLUTION_CONTROL_MESSAGE; ?>';
    var taxDuePPYValidationMessage = '<?php echo TAX_DUE_PPY_MESSAGE; ?>';
    var otherOrgValidationMessage = '<?php echo OTHER_ORG_MESSAGE; ?>';
    var detailsValidationMessage = '<?php echo DETAILS_MESSAGE; ?>';
    var quartersNumberValidationMessage = '<?php echo QUARTERS_NUMBER_MESSAGE; ?>';
    var limitMaxTenValidationMessage = '<?php echo LIMIT_MAX_TEN_MESSAGE; ?>';
    var oneRowValidationMessage = '<?php echo ONE_ROW_MESSAGE; ?>';
    var villageNameValidationMessage = '<?php echo VILLAGE_NAME_MESSAGE; ?>';
    var selectIndustryTypeValidationMessage = '<?php echo SELECT_INDUSTRY_TYPE_MESSAGE; ?>';
    var selectStateValidationMessage = '<?php echo SELECT_STATE_MESSAGE ?>';
    var selectOneOptionValidationMessage = '<?php echo SELECT_ONE_OPTION_MESSAGE; ?>';
    ...
    var promoterNameValidationMessage = '<?php echo PROMOTER_NAME_MESSAGE; ?>';
    var promoterDesignationValidationMessage = '<?php echo PROMOTER_DESIGNATION_MESSAGE; ?>';
    var apNameValidationMessage = '<?php echo AP_NAME_MESSAGE; ?>';
    var apDesignationValidationMessage = '<?php echo AP_DESIGNATION_MESSAGE; ?>';

    // VC
    var capacityValidationMessage = '<?php echo CAPACITY_MESSAGE; ?>';
    var makeValidationMessage = '<?php echo MAKE_MESSAGE; ?>';
    var modelNoValidationMessage = '<?php echo MODEL_NO_MESSAGE; ?>';

<html>
    ...
    <body>
        ...
        <div style="font-size: 14px; text-align: right; margin-bottom: 5px;"><img src="<?php echo base_url(); ?>documents/aplicence/<?php echo $aplicence_data['signature']; ?>" height="80px" width="80px"></div>

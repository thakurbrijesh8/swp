                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <textarea id="contractor_address" name="contractor_address" class="form-control" placeholder="Enter Address!" maxlength="200" readonly="">{{contractor_address}}</textarea>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <textarea id="establi_address" name="establi_address" class="form-control" placeholder="Enter Address of Establishment !" maxlength="200" readonly="">{{establi_address}}</textarea>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <textarea id="employer_address" name="employer_address" class="form-control" placeholder="Enter Employer Address !" maxlength="200" readonly="">{{employer_address}}</textarea>
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <textarea id="address_of_agent" name="address_of_agent" class="form-control" placeholder="Enter Address of Agent !" maxlength="200" readonly="">{{address_of_agent}}</textarea>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6 m-b-5px" id="formiv_doc_container_for_aplicence_view">
                                <label>7. Upload Document of Application should be submitted in triplicate in FORM IV.</span></label><br>
                                <label class="f-w-n">Document Not Uploaded</label><br>
                            </div>
                            <div class="form-group col-sm-12" id="formiv_doc_name_container_for_aplicence_view" style="display: none;">
                                <label>7. Upload Document of Application should be submitted in triplicate in FORM IV.</label><br>
                        ...
                        <div class="row">
                            <div class="col-6 m-b-5px" id="register_certification_doc_container_for_aplicence_view">
                                <label>8. Upload Document of Copy of certification of Registration of Principal Employer.</span></label><br>
                                <label class="f-w-n">Document Not Uploaded</label><br>
                            </div>
                            <div class="form-group col-sm-12" id="register_certification_doc_name_container_for_aplicence_view" style="display: none;">
                                <label>8. Upload Document of Copy of certification of Registration of Principal Employer.</label><br>

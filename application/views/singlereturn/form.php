                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="esta_tel_no" name="esta_tel_no" class="form-control" placeholder="Enter Tele No. !"
                                       maxlength="10" onkeyup="checkNumeric($(this));" onblur="checkValidation('single-return', 'esta_tel_no', telNoValidationMessage);" value="{{singleReturn_data.esta_tel_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="esta_mob_no" name="esta_mob_no" class="form-control" placeholder="Enter Mobile No. !"
                                       maxlength="10" onkeyup="checkNumeric($(this));" onblur="checkValidationForMobileNumber('single-return', 'esta_mob_no', mobileValidationMessage);" value="{{singleReturn_data.esta_mob_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="emp_tel_no" name="emp_tel_no" class="form-control" placeholder="Enter Tele No. !"
                                       maxlength="10" onkeyup="checkNumeric($(this));" onblur="checkValidation('single-return', 'emp_tel_no', telNoValidationMessage);" value="{{singleReturn_data.emp_tel_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="emp_mob_no" name="emp_mob_no" class="form-control" placeholder="Enter Mobile No. !"
                                       maxlength="10" onkeyup="checkNumeric($(this));" onblur="checkValidationForMobileNumber('single-return', 'emp_mob_no', mobileValidationMessage);" value="{{singleReturn_data.emp_mob_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="manager_tel_no" name="manager_tel_no" class="form-control" placeholder="Enter Tele No. !"
                                       maxlength="10" onkeyup="checkNumeric($(this));" onblur="checkValidation('single-return', 'manager_tel_no', telNoValidationMessage);" value="{{singleReturn_data.manager_tel_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="manager_mob_no" name="manager_mob_no" class="form-control" placeholder="Enter Mobile No. !"
                                       maxlength="10" onkeyup="checkNumeric($(this));" onblur="checkValidationForMobileNumber('single-return', 'manager_mob_no', mobileValidationMessage);" value="{{singleReturn_data.manager_mob_no}}">
                            </div>

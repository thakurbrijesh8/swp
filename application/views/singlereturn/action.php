<div class="text-center">
    ...
    {{/if}}
    {{#if show_query_btn}}
    <button type="button" class="btn btn-sm btn-warning" id="query_btn_for_app_{{singlereturn_id}}" onclick="SingleReturn.listview.getQueryData('{{singlereturn_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-reply" style="margin-right: 5px;"></i> Respond / View Query</button>
    {{/if}}
    <!-- {{#if show_download_upload_challan_btn}}
    <button type="button" class="btn btn-sm btn-info" id="download_upload_btn_{{singlereturn_id}}"
            onclick="SingleReturn.listview.downloadUploadChallan('{{singlereturn_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-cloud-download-alt" style="margin-right: 2px;"></i> Download & Upload Challan</button>
    {{/if}} -->
    {{#if show_download_upload_challan_btn}}
    <a class="btn btn-sm btn-warning" target="_blank"
       href="{{ADMIN_SINGLERETURN_DOC_PATH}}{{challan}}" id="download_challan_btn_{{singlereturn_id}}"
       style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <button type="button" class="btn btn-sm btn-nic-blue" onclick="SingleReturn.listview.generateCertificate('{{singlereturn_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">

            ...
            <div class="row">
                ...
                <hr class="m-b-1rem"> 
                    ...
                    <div class="form-group">
                        <button type="button" id="draft_btn_for_site" class="btn btn-sm btn-nic-blue" onclick="Site.listview.submitSite({{VALUE_ONE}});" style="margin-right: 5px;">Save as a Draft</button>

    ...
    <body>
        ...
        <table class="CompanyDetails">
            ...
            <!-- <tr>
                ...
                <td class="third-column">
                    <a href ="<?php //echo base_url(); ?>documents/buildingplan/<?php //echo $building_plan_data['upload_flow_chart']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php //echo base_url(); ?>documents/buildingplan/<?php //echo $building_plan_data['upload_site_plan']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <a href ="<?php //echo base_url(); ?>documents/buildingplan/<?php //echo $building_plan_data['upload_elevation_document']; ?>" target="_blank"> View Document </a>
                </td>
            </tr> -->
    </table>
    <br />
    <table style="margin-left: 475px;">
        <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/buildingplan/<?php echo $building_plan_data['sign_of_applicant']; ?>" height="100px" width="100px"></td></tr>
    </table>

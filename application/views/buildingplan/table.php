<div class="card">
    <div class="card-header">
        ...
        <h3 class="card-title float-right">
            <button type="button" class="btn btn-sm btn-primary" onclick="BuildingPlan.listview.askForNewBuildingPlanForm($(this));">Apply for New Factory Building Plan</button>
        </h3>
    </div>

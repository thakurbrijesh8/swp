        ...
        <div class="card">
            ...
            <form role="form" id="building_plan_form" name="building_plan_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12" id="building_drawing_plans_container_for_buildingplan">
                            <label>5.  Two sets of Factory building drawings showing the plans, Elevations Cross sections, the location of site (duly signed by the Occupier and the Architect) and its surroundings along with Form no. 1.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="building_drawing_plans_name_container_for_buildingplan" style="display: none;">
                            <label>5.  Two sets of Factory building drawings showing the plans, Elevations Cross sections, the location of site (duly signed by the Occupier and the Architect) and its surroundings along with Form no. 1.</label><br>
                            <a id="building_drawing_plans_download" target="_blank"><label id="building_drawing_plans_name_image_for_buildingplan" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="provisional_registration_container_for_buildingplan">
                            <label>6.  Copy of Provisional registration –SSI / in principle clearance letter for MSI / LSI. (Not applicable for gala construction).</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="provisional_registration_name_container_for_buildingplan" style="display: none;">
                            <label>6.  Copy of Provisional registration –SSI / in principle clearance letter for MSI / LSI. (Not applicable for gala construction).</label><br>
                            <a id="provisional_registration_download" target="_blank"><label id="provisional_registration_name_image_for_buildingplan" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="project_report_container_for_buildingplan">
                            <label>7.  Project Report giving the list of machineries, flow process, manufacturing Process, raw materials, finished products and bye / intermediate products. (Not applicable for gala construction).</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="project_report_name_container_for_buildingplan" style="display: none;">
                            <label>7.  Project Report giving the list of machineries, flow process, manufacturing Process, raw materials, finished products and bye / intermediate products. (Not applicable for gala construction).</label><br>
                            <a id="project_report_download" target="_blank"><label id="project_report_name_image_for_buildingplan" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="mode_of_storage_container_for_buildingplan">
                            <label>8. Quantity and mode of storage of LPG, Petroleum fuels, hazardous substances if any / signed statement on company’s letter head that it is not applicable. (Not applicable for gala construction).</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="mode_of_storage_name_container_for_buildingplan" style="display: none;">
                            <label>8. Quantity and mode of storage of LPG, Petroleum fuels, hazardous substances if any / signed statement on company’s letter head that it is not applicable. (Not applicable for gala construction).</label><br>
                            <a id="mode_of_storage_download" target="_blank"><label id="mode_of_storage_name_image_for_buildingplan" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="drawing_of_treatment_plant_container_for_buildingplan">
                            <label>9. Position and the drawing of the Effluent Treatment Plant, if any / signed statement on company’s letter head that it is not applicable. (Not applicable for gala construction).</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="drawing_of_treatment_plant_name_container_for_buildingplan" style="display: none;">
                            <label>9. Position and the drawing of the Effluent Treatment Plant, if any / signed statement on company’s letter head that it is not applicable. (Not applicable for gala construction).</label><br>
                            <a id="drawing_of_treatment_plant_download" target="_blank"><label id="drawing_of_treatment_plant_name_image_for_buildingplan" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="machinery_layout_container_for_buildingplan">
                            <label>10. Machinery lay out in the building drawings along with their respective power Rating. (Not applicable for gala construction).</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="machinery_layout_name_container_for_buildingplan" style="display: none;">
                            <label>10. Machinery lay out in the building drawings along with their respective power Rating. (Not applicable for gala construction).</label><br>
                            <a id="machinery_layout_download" target="_blank"><label id="machinery_layout_name_image_for_buildingplan" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12" id="questionnaire_copy_container_for_buildingplan">
                            <label>11. A copy of Questionnaire.</label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>

                        <div class="form-group col-sm-12" id="questionnaire_copy_name_container_for_buildingplan" style="display: none;">
                            <label>11. A copy of Questionnaire.</label><br>
                            <a id="questionnaire_copy_download" target="_blank"><label id="questionnaire_copy_name_image_for_buildingplan" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 m-b-5px" id="sign_of_applicant_container_for_buildingplan">
                            <label>12. Signature of Applicant. </span></label><br>
                            <label class="f-w-n">Document Not Uploaded</label><br>
                        </div>
                        <div class="form-group col-sm-12" id="sign_of_applicant_name_container_for_buildingplan" style="display: none;">
                            <label>12. Signature of Applicant. </label><br>
                            <a id="sign_of_applicant_download" target="_blank"><img id="sign_of_applicant_name_image_for_buildingplan" style="width: 250px; height: 250px; border: 2px solid black;"></a>
                        </div>
                    </div>

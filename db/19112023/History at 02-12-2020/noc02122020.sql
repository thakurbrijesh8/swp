...
ALTER TABLE `noc`
ADD `to_date` date NOT NULL AFTER `loan_from_date`,
ADD `public_undertaking` tinyint(1) NOT NULL AFTER `behalf_of_lessee_doc`,
ADD `public_undertaking_doc` varchar(255) COLLATE 'utf8_unicode_ci' NOT NULL AFTER `public_undertaking`;
...
CREATE TABLE `noc` (
  ...
  `loan_from_date` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
